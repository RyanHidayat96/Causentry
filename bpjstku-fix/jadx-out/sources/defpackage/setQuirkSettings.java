...
public final class setQuirkSettings implements getSchedulerHandler<Uri, InputStream> {
    ...
    public final /* synthetic */ getSchedulerHandler.TuitionPaymentFragmentbindingInflater1<InputStream> TuitionPaymentFragmentbindingInflater1(Uri uri, int i, int i2, getTargetRotation gettargetrotation) {
        ...
        isMirroring<Long> ismirroring = VideoDecoder.TuitionPaymentFragmentspecialinlinedviewModeldefault3;
        Long l = (Long) (gettargetrotation.TuitionPaymentFragmentspecialinlinedviewModeldefault1.containsKey(ismirroring) ? gettargetrotation.TuitionPaymentFragmentspecialinlinedviewModeldefault1.get(ismirroring) : ismirroring.b);
        ...
        return new getSchedulerHandler.TuitionPaymentFragmentbindingInflater1<>(setresolutionselector, lambdacreateExecutor0.TuitionPaymentFragmentspecialinlinedviewModeldefault3(context, uri2, new lambdacreateExecutor0.TuitionPaymentFragmentspecialinlinedviewModeldefault2(context.getContentResolver())));
    }
    ...
    public setQuirkSettings(Context context) {
        this.TuitionPaymentFragmentbindingInflater1 = context.getApplicationContext();
    }

    public static class TuitionPaymentFragmentspecialinlinedviewModeldefault3 implements getDeviceSurfaceManagerProvider<Uri, InputStream> {
        private final Context TuitionPaymentFragmentbindingInflater1;
        ...
        public final getSchedulerHandler<Uri, InputStream> TuitionPaymentFragmentspecialinlinedviewModeldefault3(setCameraExecutor setcameraexecutor) {
            return new setQuirkSettings(this.TuitionPaymentFragmentbindingInflater1);
        }
    }
}
