...
public final class NegativeLatLongSavesIncorrectlyQuirk extends isVivoY91i {
    private static final /* synthetic */ AtomicIntegerFieldUpdater b = AtomicIntegerFieldUpdater.newUpdater(NegativeLatLongSavesIncorrectlyQuirk.class, "_resumed$volatile");
    private volatile /* synthetic */ int _resumed$volatile;

    public NegativeLatLongSavesIncorrectlyQuirk(Continuation<?> continuation, Throwable th, boolean z) {
        if (th == null) {
