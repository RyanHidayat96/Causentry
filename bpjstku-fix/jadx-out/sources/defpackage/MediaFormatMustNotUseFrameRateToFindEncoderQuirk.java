...
public interface MediaFormatMustNotUseFrameRateToFindEncoderQuirk<T> extends Continuation<T> {
    boolean TuitionPaymentFragmentbindingInflater1(Throwable th);

    Object TuitionPaymentFragmentspecialinlinedviewModeldefault1(Throwable th);

    void TuitionPaymentFragmentspecialinlinedviewModeldefault1(CoroutineDispatcher coroutineDispatcher, T t);

    boolean TuitionPaymentFragmentspecialinlinedviewModeldefault1();

    void TuitionPaymentFragmentspecialinlinedviewModeldefault3(Object obj);

    <R extends T> Object b(R r, Object obj, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3);
    ...
    void b(T t, Function1<? super Throwable, Unit> function1);
