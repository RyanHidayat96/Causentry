...
public final class getPlaybackState {
    private static final boolean b;

    public static final isCaptioningEnabled TuitionPaymentFragmentspecialinlinedviewModeldefault3(getVolumeAttributes getvolumeattributes) {
        if (Build.VERSION.SDK_INT < 26 || b) {
            return new next(false);
        }
        if (Build.VERSION.SDK_INT == 26 || Build.VERSION.SDK_INT == 27) {
            return new isTransportControlEnabled(getvolumeattributes);
        }
