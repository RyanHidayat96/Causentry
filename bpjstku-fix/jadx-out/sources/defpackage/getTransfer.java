...
public final class getTransfer extends CoroutineDispatcher {
    public static final getTransfer TuitionPaymentFragmentspecialinlinedviewModeldefault3 = new getTransfer();
    ...
    public final void dispatch(CoroutineContext context, Runnable block) {
        BufferCopiedEncodedData bufferCopiedEncodedData = (BufferCopiedEncodedData) context.get(BufferCopiedEncodedData.INSTANCE);
        if (bufferCopiedEncodedData != null) {
            bufferCopiedEncodedData.TuitionPaymentFragmentspecialinlinedviewModeldefault2 = true;
            return;
        }
