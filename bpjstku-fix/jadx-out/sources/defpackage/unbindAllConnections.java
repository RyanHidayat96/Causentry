...
public final class unbindAllConnections extends MediaSessionCompatMediaSessionImplApi28<CodeNamePair> {
    ...
    public /* synthetic */ unbindAllConnections(Context context, ArrayList arrayList, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i & 2) != 0 ? new ArrayList() : arrayList, (i & 4) != 0 ? null : function1);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private unbindAllConnections(Context context, List<lambdasetOnImageAvailableListener0androidxcameracoreAndroidImageReaderProxy<CodeNamePair>> list, Function1<? super CodeNamePair, Unit> function1) {
