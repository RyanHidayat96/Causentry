...
public final class getColorFormat extends AbstractCoroutineContextElement implements VideoMimeInfoBuilder {
    public static final getColorFormat TuitionPaymentFragmentbindingInflater1 = new getColorFormat();
    ...
    private getColorFormat() {
        super(VideoMimeInfoBuilder.b);
    }
