...
public class OutputConfig extends AutoValue_VideoMimeInfo1 {
    CoroutineScheduler TuitionPaymentFragmentbindingInflater1;
    ...
    public /* synthetic */ OutputConfig(int i, int i2, long j, String str, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? getSupportedHeights.TuitionPaymentFragmentspecialinlinedviewModeldefault1 : i, (i3 & 2) != 0 ? getSupportedHeights.b : i2, (i3 & 4) != 0 ? getSupportedHeights.TuitionPaymentFragmentspecialinlinedviewModeldefault2 : j, (i3 & 8) != 0 ? "CoroutineScheduler" : str);
    }

    public OutputConfig(int i, int i2, long j, String str) {
        ...
        this.f191a = str;
        this.TuitionPaymentFragmentbindingInflater1 = new CoroutineScheduler(i, i2, j, str);
    }
    ...
    public void dispatch(CoroutineContext context, Runnable block) {
        CoroutineScheduler.TuitionPaymentFragmentspecialinlinedviewModeldefault2(this.TuitionPaymentFragmentbindingInflater1, block, false, 6);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext context, Runnable block) {
        CoroutineScheduler.TuitionPaymentFragmentspecialinlinedviewModeldefault2(this.TuitionPaymentFragmentbindingInflater1, block, true, 2);
    }
