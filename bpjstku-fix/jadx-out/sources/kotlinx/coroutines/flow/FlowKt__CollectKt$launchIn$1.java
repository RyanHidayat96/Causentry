...
public final class FlowKt__CollectKt$launchIn$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ clampVideoBitrateIfNotSupported<T> $this_launchIn;
    int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            clampVideoBitrateIfNotSupported<T> clampvideobitrateifnotsupported = this.$this_launchIn;
            this.label = 1;
            Object objCollect = clampvideobitrateifnotsupported.collect(createPersistentInputSurface.INSTANCE, this);
    ...
    public FlowKt__CollectKt$launchIn$1(clampVideoBitrateIfNotSupported<? extends T> clampvideobitrateifnotsupported, Continuation<? super FlowKt__CollectKt$launchIn$1> continuation) {
        super(2, continuation);
        this.$this_launchIn = clampvideobitrateifnotsupported;
    }
