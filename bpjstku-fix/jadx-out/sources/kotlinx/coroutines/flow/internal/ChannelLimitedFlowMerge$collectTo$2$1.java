...
import defpackage.cancelInputBuffer;
...
public final class ChannelLimitedFlowMerge$collectTo$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ cancelInputBuffer<T> $collector;
    final /* synthetic */ clampVideoBitrateIfNotSupported<T> $flow;
    int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            clampVideoBitrateIfNotSupported<T> clampvideobitrateifnotsupported = this.$flow;
            addSignalEosTimeoutIfNeeded addsignaleostimeoutifneeded = this.$collector;
            this.label = 1;
    ...
    public ChannelLimitedFlowMerge$collectTo$2$1(clampVideoBitrateIfNotSupported<? extends T> clampvideobitrateifnotsupported, cancelInputBuffer<T> cancelinputbuffer, Continuation<? super ChannelLimitedFlowMerge$collectTo$2$1> continuation) {
        super(2, continuation);
        this.$flow = clampvideobitrateifnotsupported;
        this.$collector = cancelinputbuffer;
    }
