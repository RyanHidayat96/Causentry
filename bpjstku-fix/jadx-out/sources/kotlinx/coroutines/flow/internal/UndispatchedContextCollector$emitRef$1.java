...
public final class UndispatchedContextCollector$emitRef$1<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
    final /* synthetic */ addSignalEosTimeoutIfNeeded<T> $downstream;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            addSignalEosTimeoutIfNeeded<T> addsignaleostimeoutifneeded = this.$downstream;
            this.label = 1;
            if (addsignaleostimeoutifneeded.emit((T) obj2, this) == coroutine_suspended) {
    ...
    public UndispatchedContextCollector$emitRef$1(addSignalEosTimeoutIfNeeded<? super T> addsignaleostimeoutifneeded, Continuation<? super UndispatchedContextCollector$emitRef$1> continuation) {
        super(2, continuation);
        this.$downstream = addsignaleostimeoutifneeded;
    }
