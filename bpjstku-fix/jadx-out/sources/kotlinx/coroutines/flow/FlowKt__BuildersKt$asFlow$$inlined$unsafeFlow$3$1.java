...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3$1 extends ContinuationImpl {
    ...
    final /* synthetic */ signalEndOfInputStream.TuitionPaymentFragmentbindingInflater1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3$1(signalEndOfInputStream.TuitionPaymentFragmentbindingInflater1 tuitionPaymentFragmentbindingInflater1, Continuation continuation) {
        super(continuation);
