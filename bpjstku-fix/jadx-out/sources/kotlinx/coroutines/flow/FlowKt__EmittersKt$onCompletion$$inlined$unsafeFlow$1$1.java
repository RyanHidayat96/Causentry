...
public final class FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1$1 extends ContinuationImpl {
    ...
    final /* synthetic */ handleEncodeError.TuitionPaymentFragmentbindingInflater1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1$1(handleEncodeError.TuitionPaymentFragmentbindingInflater1 tuitionPaymentFragmentbindingInflater1, Continuation continuation) {
        super(continuation);
