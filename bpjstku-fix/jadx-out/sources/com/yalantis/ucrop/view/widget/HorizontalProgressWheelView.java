...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            float f3 = -(f % f2);
            float f4 = this.mCanvasClipBounds.left;
            float f5 = (this.mProgressLineWidth + this.mProgressLineMargin) * i3;
            float fCenterY = this.mCanvasClipBounds.centerY();
            float f6 = this.mProgressLineHeight / 4.0f;
            float f7 = this.mCanvasClipBounds.left;
            canvas.drawLine(f4 + f3 + f5, fCenterY - f6, f3 + f7 + ((this.mProgressLineWidth + this.mProgressLineMargin) * i3), this.mCanvasClipBounds.centerY() + (this.mProgressLineHeight / 4.0f), this.mProgressLinePaint);
        }
