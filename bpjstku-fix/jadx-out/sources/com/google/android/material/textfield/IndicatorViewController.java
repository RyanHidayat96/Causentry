...
final class IndicatorViewController {
    ...
    final void showHelper(CharSequence charSequence) {
    ...
    final void showError(CharSequence charSequence) {
        cancelCaptionAnimator();
    ...
    final CharSequence getErrorText() {
    ...
    final ColorStateList getErrorViewTextColors() {
        TextView textView = this.errorView;
        if (textView != null) {
    ...
    final void setErrorViewTextColor(ColorStateList colorStateList) {
    ...
    final void setErrorContentDescription(CharSequence charSequence) {
    ...
    final CharSequence getErrorContentDescription() {
    ...
    final void setHelperTextViewTextColor(ColorStateList colorStateList) {
