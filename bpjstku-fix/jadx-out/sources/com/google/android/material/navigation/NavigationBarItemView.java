...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    protected int getSuggestedMinimumWidth() {
        ...
        return Math.max(getSuggestedIconWidth(), i + measuredWidth + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
    }

    @Override // android.view.View
    protected int getSuggestedMinimumHeight() {
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.labelGroup.getLayoutParams();
        return getSuggestedIconHeight() + (this.labelGroup.getVisibility() == 0 ? this.activeIndicatorLabelPadding : 0) + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + this.labelGroup.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
    }
    ...
    public void updateActiveIndicatorLayoutParams(int i) {
        ...
        ((ViewGroup.LayoutParams) layoutParams).height = isActiveIndicatorResizeableAndUnlabeled() ? iMin : this.activeIndicatorDesiredHeight;
    ...
    private int getSuggestedIconWidth() {
        ...
        return Math.max(minimumWidth, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) + this.icon.getMeasuredWidth() + Math.max(minimumWidth, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
    }

    private int getSuggestedIconHeight() {
        return ((ViewGroup.MarginLayoutParams) ((FrameLayout.LayoutParams) getIconOrContainer().getLayoutParams())).topMargin + getIconOrContainer().getMeasuredHeight();
    }
