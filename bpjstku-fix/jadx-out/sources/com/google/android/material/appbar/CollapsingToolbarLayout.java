...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        collapsingTextHelper.setCollapsedBounds(i + i2, i3 + maxOffsetForPinChild + titleMarginTop, i4 - titleMarginStart, (this.tmpRect.bottom + maxOffsetForPinChild) - titleMarginBottom);
    }
    ...
    final int getMaxOffsetForPinChild(View view) {
        return ((getHeight() - getViewOffsetHelper(view).getLayoutTop()) - view.getHeight()) - ((ViewGroup.MarginLayoutParams) ((LayoutParams) view.getLayoutParams())).bottomMargin;
    }
