...
class MonthAdapter extends BaseAdapter {
    ...
    @Override // android.widget.Adapter
    public TextView getView(int i, View view, ViewGroup viewGroup) throws Throwable {
        int i2;
    ...
    public void updateSelectedStates(MaterialCalendarGridView materialCalendarGridView) throws Throwable {
    ...
    private void updateSelectedStateForDate(MaterialCalendarGridView materialCalendarGridView, long j) throws Throwable {
    ...
    private void updateSelectedState(TextView textView, long j, int i) throws Throwable {
        boolean z;
