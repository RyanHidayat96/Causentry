...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                MaterialDatePicker.m7871instrumented$0$initHeaderToggle$LandroidcontentContextV(this.f$0, view);
            }
        });
    }

    private /* synthetic */ void lambda$initHeaderToggle$0(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: instrumented$0$initHeaderToggle$-Landroid-content-Context--V, reason: not valid java name */
    public static /* synthetic */ void m7871instrumented$0$initHeaderToggle$LandroidcontentContextV(MaterialDatePicker materialDatePicker, View view) {
        ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault3(view);
        try {
    ...
    public static final class Builder<S> {
        ...
        public final Builder<S> setDayViewDecorator(DayViewDecorator dayViewDecorator) {
        ...
        public final Builder<S> setPositiveButtonText(int i) {
        ...
        public final Builder<S> setPositiveButtonContentDescription(int i) {
        ...
        public final Builder<S> setNegativeButtonText(int i) {
        ...
        public final Builder<S> setNegativeButtonContentDescription(int i) {
