...
public final class TabLayoutMediator {
    ...
    final void populateTabsFromPagerAdapter() throws Throwable {
    ...
    static class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        @Override // androidx.viewpager2.widget.ViewPager2.OnPageChangeCallback
        public void onPageSelected(int i) throws Throwable {
            TabLayout tabLayout = this.tabLayoutRef.get();
    ...
    class PagerAdapterObserver extends RecyclerView.AdapterDataObserver {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeChanged(int i, int i2) throws Throwable {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeChanged(int i, int i2, Object obj) throws Throwable {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeInserted(int i, int i2) throws Throwable {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeRemoved(int i, int i2) throws Throwable {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeMoved(int i, int i2, int i3) throws Throwable {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }
    }
}
