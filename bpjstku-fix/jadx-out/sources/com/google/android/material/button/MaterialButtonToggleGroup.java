    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
            ...
            if (getOrientation() == 0) {
                ...
                ((ViewGroup.MarginLayoutParams) layoutParamsBuildLayoutParams).topMargin = 0;
            } else {
                ((ViewGroup.MarginLayoutParams) layoutParamsBuildLayoutParams).bottomMargin = 0;
                ((ViewGroup.MarginLayoutParams) layoutParamsBuildLayoutParams).topMargin = -iMin;
