...
public final class UncontainedCarouselStrategy extends CarouselStrategy {
    ...
    @Override // com.google.android.material.carousel.CarouselStrategy
    final KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        float f;
        ...
        float extraSmallSize = CarouselStrategyHelper.getExtraSmallSize(view.getContext());
        ...
        return createLeftAlignedKeylineState(view.getContext(), f, containerWidth, f4, iMax, calculateMediumChildSize(extraSmallSize + f, f4, f5), f5 <= 0.0f ? 0 : 1, extraSmallSize2);
    }
    ...
    private KeylineState createCenterAlignedKeylineState(float f, float f2, float f3, int i, float f4, float f5, float f6) {
        ...
        float f10 = fMin / 2.0f;
        float f11 = (i * f3) + f9;
        KeylineState.Builder builderAddKeylineRange = new KeylineState.Builder(f3, f).addAnchorKeyline((f8 - f7) - f10, childMaskPercentage, fMin).addKeyline(f8, childMaskPercentage2, f4, false).addKeylineRange(f9 + (f3 / 2.0f), 0.0f, f3, i, true);
    ...
    private KeylineState createLeftAlignedKeylineState(Context context, float f, float f2, float f3, int i, float f4, int i2, float f5) {
        ...
        if (i2 > 0) {
            builderAddKeylineRange.addKeyline((f4 / 2.0f) + f6, childMaskPercentage3, f4, false);
            f6 += f4;
        }
