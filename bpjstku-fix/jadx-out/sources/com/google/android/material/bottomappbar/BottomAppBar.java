...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.bottomappbar.BottomAppBar.SavedState.1
            ...
            public SavedState createFromParcel(Parcel parcel) throws IllegalAccessException {
                ClassLoader classLoader;
                Object objTuitionPaymentFragmentspecialinlinedviewModeldefault3 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-1096626159);
                if (objTuitionPaymentFragmentspecialinlinedviewModeldefault3 == null) {
                    objTuitionPaymentFragmentspecialinlinedviewModeldefault3 = initSession.b((char) (46401 - (AudioTrack.getMaxVolume() > 0.0f ? 1 : (AudioTrack.getMaxVolume() == 0.0f ? 0 : -1))), TextUtils.getOffsetBefore("", 0) + 40, View.MeasureSpec.getSize(0) + 19, 1513912262, false, "b", null);
                }
                int i = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault3).getInt(null);
                Object objTuitionPaymentFragmentspecialinlinedviewModeldefault4 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-914723831);
                if (objTuitionPaymentFragmentspecialinlinedviewModeldefault4 == null) {
                    objTuitionPaymentFragmentspecialinlinedviewModeldefault4 = initSession.b((char) (View.MeasureSpec.getMode(0) + 37836), (ViewConfiguration.getMaximumDrawingCacheSize() >> 24) + 59, 19 - (ViewConfiguration.getGlobalActionKeyTimeout() > 0L ? 1 : (ViewConfiguration.getGlobalActionKeyTimeout() == 0L ? 0 : -1)), 769969118, false, "TuitionPaymentFragmentbindingInflater1", null);
                }
                int i2 = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault4).getInt(null);
                long j = i2;
                Object objTuitionPaymentFragmentspecialinlinedviewModeldefault5 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-639884696);
                if (objTuitionPaymentFragmentspecialinlinedviewModeldefault5 == null) {
                    objTuitionPaymentFragmentspecialinlinedviewModeldefault5 = initSession.b((char) (37836 - Color.alpha(0)), (ViewConfiguration.getScrollBarSize() >> 8) + 59, (Process.myPid() >> 22) + 18, 1027769791, false, "TuitionPaymentFragmentspecialinlinedviewModeldefault1", null);
                }
                int i3 = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault5).getInt(null);
                long j2 = 520;
                long j3 = -1;
                long j4 = j3 ^ 395895147409955730L;
                long j5 = j3 ^ 5123358349749830509L;
                long jIdentityHashCode = System.identityHashCode(this);
                long j6 = jIdentityHashCode ^ j3;
                long j7 = (jIdentityHashCode | 395895147409955730L) ^ j3;
                long j8 = (((long) (-519)) * 395895147409955730L) + (((long) 521) * 5123358349749830509L) + (((((j4 | j5) | j6) ^ j3) | ((5123358349749830509L | jIdentityHashCode) ^ j3)) * j2) + (((long) (-1040)) * (((j5 | j6) ^ j3) | j7)) + (j2 * (((j4 | j6) ^ j3) | ((j5 | 395895147409955730L) ^ j3) | j7));
                int i4 = 0;
                while (true) {
                ...
                if (i3 != i) {
                    ...
                    if (objTuitionPaymentFragmentspecialinlinedviewModeldefault6 == null) {
                        objTuitionPaymentFragmentspecialinlinedviewModeldefault6 = initSession.b((char) (KeyEvent.getDeadChar(0, 0) + 46400), 40 - (ViewConfiguration.getLongPressTimeout() >> 16), (-16777197) - Color.rgb(0, 0, 0), -1205987569, false, "TuitionPaymentFragmentspecialinlinedviewModeldefault2", null);
                    }
                    classLoader = null;
