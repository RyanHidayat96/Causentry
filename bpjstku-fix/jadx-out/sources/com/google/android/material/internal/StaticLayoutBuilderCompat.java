...
final class StaticLayoutBuilderCompat {
    ...
    public final StaticLayoutBuilderCompat setStaticLayoutBuilderConfigurer(StaticLayoutBuilderConfigurer staticLayoutBuilderConfigurer) {
    ...
    static class StaticLayoutBuilderCompatException extends Exception {
        StaticLayoutBuilderCompatException(Throwable th) {
            StringBuilder sb = new StringBuilder("Error thrown initializing StaticLayout ");
