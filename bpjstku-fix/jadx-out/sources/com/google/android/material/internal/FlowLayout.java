    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (paddingLeft2 + i4 + childAt.getMeasuredWidth() <= i5 - paddingRight || isSingleLine()) {
                    paddingLeft = i10;
                } else {
                ...
                paddingLeft2 = paddingLeft + i4 + i3 + childAt.getMeasuredWidth() + this.itemSpacing;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.singleLine && measuredWidth + marginStart + measuredWidth2 > i5) {
                    paddingTop = this.lineSpacing + i6;
                    this.rowCount++;
