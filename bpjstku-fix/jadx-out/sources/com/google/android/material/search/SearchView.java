...
public class SearchView extends FrameLayout implements CoordinatorLayout.AttachedBehavior, MaterialBackHandler {
    ...
    protected void onFinishInflate() throws IllegalAccessException {
        super.onFinishInflate();
        Object objTuitionPaymentFragmentspecialinlinedviewModeldefault3 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-1096626159);
        if (objTuitionPaymentFragmentspecialinlinedviewModeldefault3 == null) {
            objTuitionPaymentFragmentspecialinlinedviewModeldefault3 = initSession.b((char) (TextUtils.getOffsetBefore("", 0) + 46400), (SystemClock.elapsedRealtime() > 0L ? 1 : (SystemClock.elapsedRealtime() == 0L ? 0 : -1)) + 39, 18 - TextUtils.lastIndexOf("", '0'), 1513912262, false, "b", null);
        }
        int i = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault3).getInt(null);
        Object objTuitionPaymentFragmentspecialinlinedviewModeldefault4 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-914723831);
        if (objTuitionPaymentFragmentspecialinlinedviewModeldefault4 == null) {
            objTuitionPaymentFragmentspecialinlinedviewModeldefault4 = initSession.b((char) (37836 - (ViewConfiguration.getScrollDefaultDelay() >> 16)), (ViewConfiguration.getPressedStateDuration() >> 16) + 59, 18 - View.getDefaultSize(0, 0), 769969118, false, "TuitionPaymentFragmentbindingInflater1", null);
        }
        int i2 = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault4).getInt(null);
        long j = i2;
        Object objTuitionPaymentFragmentspecialinlinedviewModeldefault5 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-639884696);
        if (objTuitionPaymentFragmentspecialinlinedviewModeldefault5 == null) {
            objTuitionPaymentFragmentspecialinlinedviewModeldefault5 = initSession.b((char) (37835 - ((byte) KeyEvent.getModifierMetaStateMask())), 60 - (ViewConfiguration.getZoomControlsTimeout() > 0L ? 1 : (ViewConfiguration.getZoomControlsTimeout() == 0L ? 0 : -1)), KeyEvent.keyCodeFromString("") + 18, 1027769791, false, "TuitionPaymentFragmentspecialinlinedviewModeldefault1", null);
        }
        int i3 = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault5).getInt(null);
        long j2 = 69;
        long j3 = -1;
        long j4 = j3 ^ 640551751095384266L;
        long j5 = j3 ^ 4878701746064401973L;
        long jIdentityHashCode = System.identityHashCode(this);
        long j6 = (((long) 70) * 640551751095384266L) + (((long) (-68)) * 4878701746064401973L) + (((((j4 | j5) | jIdentityHashCode) ^ j3) | ((5474041164560563967L | jIdentityHashCode) ^ j3)) * j2) + (((long) (-69)) * (((j4 | 4878701746064401973L) ^ j3) | ((j4 | jIdentityHashCode) ^ j3) | ((jIdentityHashCode | 4878701746064401973L) ^ j3))) + (j2 * ((j5 | 640551751095384266L) ^ j3));
        int i4 = i3;
        int i5 = 0;
        while (true) {
        ...
        if (i4 != i) {
            ...
            if (objTuitionPaymentFragmentspecialinlinedviewModeldefault6 == null) {
                objTuitionPaymentFragmentspecialinlinedviewModeldefault6 = initSession.b((char) ((-16730816) - Color.rgb(0, 0, 0)), 39 - MotionEvent.axisFromString(""), 19 - View.combineMeasuredStates(0, 0), -1205987569, false, "TuitionPaymentFragmentspecialinlinedviewModeldefault2", null);
            }
    ...
    private void setUpBackButton(boolean z, boolean z2) {
        ...
        this.toolbar.setNavigationOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda9
            ...
            public final void onClick(View view) {
                SearchView.m7877instrumented$0$setUpBackButton$ZZV(this.f$0, view);
            }
        });
        if (z) {
    ...
    private void setUpClearButton() {
        this.clearButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SearchView.m7878instrumented$0$setUpClearButton$V(this.f$0, view);
            }
        });
    ...
    private void setUpContentOnTouchListener() {
        this.contentContainer.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda8
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.m7882x1cd2d198(view, motionEvent);
            }
        });
    }
    ...
    /* synthetic */ boolean m7882x1cd2d198(View view, MotionEvent motionEvent) {
    ...
    private void setUpToolbarInsetListener() {
        ViewUtils.doOnApplyWindowInsets(this.toolbar, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda3
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
                return this.f$0.m7884x7371bf54(view, windowInsetsCompat, relativePadding);
            }
        });
    }
    ...
    /* synthetic */ WindowInsetsCompat m7884x7371bf54(View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
    ...
    private void setUpStatusBarSpacerInsetListener() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this.statusBarSpacer, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda4
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return this.f$0.m7883x941b8403(view, windowInsetsCompat);
            }
        });
    }
    ...
    /* synthetic */ WindowInsetsCompat m7883x941b8403(View view, WindowInsetsCompat windowInsetsCompat) {
    ...
    public void setupWithSearchBar(SearchBar searchBar) {
        ...
        if (searchBar != null) {
            searchBar.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SearchView.m7879xb2a22967(this.f$0, view);
                }
            });
    ...
    /* JADX INFO: renamed from: instrumented$0$setUpBackButton$-ZZ-V, reason: not valid java name */
    public static /* synthetic */ void m7877instrumented$0$setUpBackButton$ZZV(SearchView searchView, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: instrumented$0$setUpClearButton$--V, reason: not valid java name */
    public static /* synthetic */ void m7878instrumented$0$setUpClearButton$V(SearchView searchView, View view) {
        ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault3(view);
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: instrumented$0$setupWithSearchBar$-Lcom-google-android-material-search-SearchBar--V, reason: not valid java name */
    public static /* synthetic */ void m7879xb2a22967(SearchView searchView, View view) {
        ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault3(view);
        try {
