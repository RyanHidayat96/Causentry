...
public final class DynamicColor {
    ...
    public final int getArgb(DynamicScheme dynamicScheme) {
        ...
        return function == null ? i : (MathUtils.clampInt(0, 255, (int) Math.round(function.apply(dynamicScheme).doubleValue() * 255.0d)) << 24) | (i & ViewCompat.MEASURED_SIZE_MASK);
    }

    public final Hct getHct(DynamicScheme dynamicScheme) {
    ...
    /* JADX WARN: Code duplicated, block: B:22:0x0043 A[RETURN] */
