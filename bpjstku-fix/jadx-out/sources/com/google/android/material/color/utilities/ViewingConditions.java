...
public final class ViewingConditions {
    ...
    public static ViewingConditions make(double[] dArr, double d, double d2, double d3, boolean z) {
        ...
        if (d12 >= 0.9d) {
            ...
            dLerp = MathUtils.lerp(0.525d, 0.59d, 10.0d * (d12 - 0.8d));
        }
        double d13 = dLerp;
        ...
        double dSqrt = Math.sqrt(dYFromLstar);
        ...
        return new ViewingConditions(dYFromLstar, ((dArr8[0] * 2.0d) + dArr8[1] + (dArr8[2] * 0.05d)) * dPow, dPow, dPow, d13, d12, dArr6, dCbrt, Math.pow(dCbrt, 0.25d), dSqrt + 1.48d);
    }
