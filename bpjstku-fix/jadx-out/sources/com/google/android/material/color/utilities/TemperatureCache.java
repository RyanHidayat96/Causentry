...
public final class TemperatureCache {
    ...
    public final Hct getComplement() {
        ...
        double dDoubleValue2 = getTempsByHct().get(getWarmest()).doubleValue();
        ...
        for (double d3 = 0.0d; d3 <= 360.0d; d3 += 1.0d) {
            double dSanitizeDegreesDouble = MathUtils.sanitizeDegreesDouble((d3 * 1.0d) + d);
            if (isBetween(dSanitizeDegreesDouble, d, hue)) {
                Hct hct3 = getHctsByHue().get((int) Math.round(dSanitizeDegreesDouble));
                double dAbs = Math.abs((1.0d - relativeTemperature) - ((getTempsByHct().get(hct3).doubleValue() - dDoubleValue) / (dDoubleValue2 - dDoubleValue)));
                if (dAbs < d2) {
                    hct2 = hct3;
                    d2 = dAbs;
                }
    ...
    public final double getRelativeTemperature(Hct hct) {
        ...
        double dDoubleValue2 = getTempsByHct().get(hct).doubleValue();
        double dDoubleValue3 = getTempsByHct().get(getColdest()).doubleValue();
        if (dDoubleValue == 0.0d) {
            return 0.5d;
        }
        return (dDoubleValue2 - dDoubleValue3) / dDoubleValue;
    }
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.TemperatureCache$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return this.f$0.m7867xb7a75f35((Hct) obj);
            }
    ...
    final /* synthetic */ Double m7867xb7a75f35(Hct hct) {
