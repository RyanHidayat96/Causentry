...
public class ColorContrast {
    ...
    public static Context wrapContextIfAvailable(Context context, ColorContrastOptions colorContrastOptions) {
        int contrastThemeOverlayResourceId;
        return (!isContrastAvailable() || (contrastThemeOverlayResourceId = getContrastThemeOverlayResourceId(context, colorContrastOptions)) == 0) ? context : new ContextThemeWrapper(context, contrastThemeOverlayResourceId);
    }
