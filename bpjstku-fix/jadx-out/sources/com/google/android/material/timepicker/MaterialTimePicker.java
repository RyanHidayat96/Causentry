...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    final /* synthetic */ void m7911xac73da03() {
        TimePickerPresenter timePickerPresenter = this.activePresenter;
    ...
    final TimePickerClockPresenter getTimePickerClockPresenter() throws IllegalAccessException {
        Object objTuitionPaymentFragmentspecialinlinedviewModeldefault3 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-1096626159);
        if (objTuitionPaymentFragmentspecialinlinedviewModeldefault3 == null) {
            objTuitionPaymentFragmentspecialinlinedviewModeldefault3 = initSession.b((char) ((Process.myTid() >> 22) + 46400), (Process.myTid() >> 22) + 40, 19 - (PointF.length(0.0f, 0.0f) > 0.0f ? 1 : (PointF.length(0.0f, 0.0f) == 0.0f ? 0 : -1)), 1513912262, false, "b", null);
        }
        int i = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault3).getInt(null);
        Object objTuitionPaymentFragmentspecialinlinedviewModeldefault4 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-914723831);
        if (objTuitionPaymentFragmentspecialinlinedviewModeldefault4 == null) {
            objTuitionPaymentFragmentspecialinlinedviewModeldefault4 = initSession.b((char) (37836 - (ViewConfiguration.getTouchSlop() >> 8)), (SystemClock.uptimeMillis() > 0L ? 1 : (SystemClock.uptimeMillis() == 0L ? 0 : -1)) + 58, 18 - (ViewConfiguration.getMinimumFlingVelocity() >> 16), 769969118, false, "TuitionPaymentFragmentbindingInflater1", null);
        }
        int i2 = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault4).getInt(null);
        long j = i2;
        Object objTuitionPaymentFragmentspecialinlinedviewModeldefault5 = initSession.TuitionPaymentFragmentspecialinlinedviewModeldefault3(-639884696);
        if (objTuitionPaymentFragmentspecialinlinedviewModeldefault5 == null) {
            objTuitionPaymentFragmentspecialinlinedviewModeldefault5 = initSession.b((char) ((KeyEvent.getMaxKeyCode() >> 16) + 37836), (TypedValue.complexToFloat(0) > 0.0f ? 1 : (TypedValue.complexToFloat(0) == 0.0f ? 0 : -1)) + 59, TextUtils.getOffsetBefore("", 0) + 18, 1027769791, false, "TuitionPaymentFragmentspecialinlinedviewModeldefault1", null);
        }
        int i3 = ((Field) objTuitionPaymentFragmentspecialinlinedviewModeldefault5).getInt(null);
        long j2 = -1;
        long j3 = j2 ^ 3124572050903148088L;
        long jIdentityHashCode = (((long) System.identityHashCode(this)) | 2394681446256638151L) ^ j2;
        long j4 = (((long) (-109)) * 3124572050903148088L) + (((long) 111) * 2394681446256638151L) + (((long) (-220)) * (j3 | jIdentityHashCode)) + (((long) 220) * (jIdentityHashCode | (3134434696951922431L ^ j2))) + (((long) 110) * ((j2 ^ ((j2 ^ 2394681446256638151L) | 3124572050903148088L)) | ((j3 | 2394681446256638151L) ^ j2)));
        int i4 = 0;
        int i5 = i3;
        long j5 = j;
        while (true) {
            for (int i6 = 0; i6 != 8; i6++) {
                i5 = (((((int) (j5 >> i6)) & 255) + (i5 << 6)) + (i5 << 16)) - i5;
            }
            if (i4 != 0) {
                break;
            }
        ...
        if (i5 != i) {
            ...
            if (objTuitionPaymentFragmentspecialinlinedviewModeldefault6 == null) {
                objTuitionPaymentFragmentspecialinlinedviewModeldefault6 = initSession.b((char) (46400 - TextUtils.indexOf("", "", 0)), Gravity.getAbsoluteGravity(0, 0) + 40, (ViewConfiguration.getScrollBarSize() >> 8) + 19, -1205987569, false, "TuitionPaymentFragmentspecialinlinedviewModeldefault2", null);
            }
    ...
    final void setActivePresenter(TimePickerPresenter timePickerPresenter) {
