...
public final class AccountPicker {
    ...
    public static class AccountChooserOptions {
        ...
        static /* synthetic */ boolean zzB(AccountChooserOptions accountChooserOptions) {
            boolean z = accountChooserOptions.zzb;
            return false;
        }

        static /* synthetic */ boolean zzC(AccountChooserOptions accountChooserOptions) {
        ...
        static /* synthetic */ int zza(AccountChooserOptions accountChooserOptions) {
            int i = accountChooserOptions.zzi;
            return 0;
        }

        static /* synthetic */ zza zzd(AccountChooserOptions accountChooserOptions) {
            zza zzaVar = accountChooserOptions.zzl;
            return null;
        }

        static /* synthetic */ String zze(AccountChooserOptions accountChooserOptions) {
            String str = accountChooserOptions.zzj;
            return null;
        }

        static /* synthetic */ String zzf(AccountChooserOptions accountChooserOptions) {
        ...
        static /* synthetic */ boolean zzz(AccountChooserOptions accountChooserOptions) {
