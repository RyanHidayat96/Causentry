...
public class GoogleApiManager implements Handler.Callback {
    ...
    /* JADX WARN: Code duplicated, block: B:65:0x0208  */
            ...
            case 5:
                ...
                for (zabq zabqVar4 : this.zan.values()) {
                    if (zabqVar4.zab() == i2) {
                        zabqVar = zabqVar4;
                        if (zabqVar != null) {
                            StringBuilder sb = new StringBuilder("Could not find API instance ");
                            sb.append(i2);
                            ...
                            StringBuilder sb2 = new StringBuilder("Error resolution was canceled by the user, original error message: ");
                            sb2.append(errorString);
                            sb2.append(": ");
                            sb2.append(errorMessage);
                            zabqVar.zaE(new Status(17, sb2.toString()));
                        } else {
                ...
                if (zabqVar != null) {
                    StringBuilder sb3 = new StringBuilder("Could not find API instance ");
                    sb3.append(i2);
                    sb3.append(" while trying to fail enqueued calls.");
                    Log.wtf("GoogleApiManager", sb3.toString(), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    String errorString2 = this.zaj.getErrorString(connectionResult.getErrorCode());
                    String errorMessage2 = connectionResult.getErrorMessage();
                    StringBuilder sb4 = new StringBuilder("Error resolution was canceled by the user, original error message: ");
                    sb4.append(errorString2);
                    sb4.append(": ");
                    sb4.append(errorMessage2);
                    zabqVar.zaE(new Status(17, sb4.toString()));
                } else {
                    zabqVar.zaE(zaF(zabqVar.zad, connectionResult));
                }
                return true;
