...
public class AuthorizationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public final Builder addResourceParameter(ResourceParameter resourceParameter, String str) {
        ...
        public final Builder setOptOutIncludingGrantedScopes(boolean z) {
            this.zbj = z;
            return this;
        }
    ...
    public int hashCode() {
        ...
        boolean z2 = this.zbh;
        boolean z3 = this.zbd;
        return Objects.hashCode(list, str, Boolean.valueOf(z), Boolean.valueOf(z2), Boolean.valueOf(z3), this.zbe, this.zbf, this.zbg, this.zbi, Boolean.valueOf(this.zbj));
    }
