...
final class zzln implements zzov {
    ...
    public final void zzp(int i, int i2) throws IOException {
        this.zza.zzc(i, (i2 + i2) ^ (i2 >> 31));
    }

    @Override // com.google.android.gms.internal.measurement.zzov
    public final void zzq(int i, long j) throws IOException {
        this.zza.zze(i, (j + j) ^ (j >> 63));
    }
    ...
    public final void zzK(int i, List list, boolean z) throws IOException {
        ...
        if (!(list instanceof zzmg)) {
            if (!z) {
                while (i2 < list.size()) {
                    ...
                    zzlmVar.zzc(i, (iIntValue + iIntValue) ^ (iIntValue >> 31));
                    i2++;
                }
                return;
            }
            ...
            for (int i3 = 0; i3 < list.size(); i3++) {
                ...
                iZzz += zzlm.zzz((iIntValue2 + iIntValue2) ^ (iIntValue2 >> 31));
            }
            zzlmVar2.zzr(iZzz);
            while (i2 < list.size()) {
                int iIntValue3 = ((Integer) list.get(i2)).intValue();
                zzlmVar2.zzr((iIntValue3 + iIntValue3) ^ (iIntValue3 >> 31));
                i2++;
            }
            return;
        }
        ...
        if (!z) {
            while (i2 < zzmgVar.size()) {
                ...
                zzlmVar3.zzc(i, (iZzf + iZzf) ^ (iZzf >> 31));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < zzmgVar.size(); i4++) {
            ...
            iZzz2 += zzlm.zzz((iZzf2 + iZzf2) ^ (iZzf2 >> 31));
        }
        zzlmVar4.zzr(iZzz2);
        while (i2 < zzmgVar.size()) {
            int iZzf3 = zzmgVar.zzf(i2);
            zzlmVar4.zzr((iZzf3 + iZzf3) ^ (iZzf3 >> 31));
            i2++;
        }
    }
    ...
    public final void zzL(int i, List list, boolean z) throws IOException {
        ...
        if (!(list instanceof zzna)) {
            if (!z) {
                while (i2 < list.size()) {
                    ...
                    zzlmVar.zze(i, (jLongValue + jLongValue) ^ (jLongValue >> 63));
                    i2++;
                }
                return;
            }
            ...
            for (int i3 = 0; i3 < list.size(); i3++) {
                ...
                iZzA += zzlm.zzA((jLongValue2 + jLongValue2) ^ (jLongValue2 >> 63));
            }
            zzlmVar2.zzr(iZzA);
            while (i2 < list.size()) {
                long jLongValue3 = ((Long) list.get(i2)).longValue();
                zzlmVar2.zzt((jLongValue3 + jLongValue3) ^ (jLongValue3 >> 63));
                i2++;
            }
            return;
        }
        ...
        if (!z) {
            while (i2 < zznaVar.size()) {
                ...
                zzlmVar3.zze(i, (jZzc + jZzc) ^ (jZzc >> 63));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < zznaVar.size(); i4++) {
            ...
            iZzA2 += zzlm.zzA((jZzc2 + jZzc2) ^ (jZzc2 >> 63));
        }
        zzlmVar4.zzr(iZzA2);
        while (i2 < zznaVar.size()) {
            long jZzc3 = zznaVar.zzc(i2);
            zzlmVar4.zzt((jZzc3 + jZzc3) ^ (jZzc3 >> 63));
            i2++;
        }
    }
