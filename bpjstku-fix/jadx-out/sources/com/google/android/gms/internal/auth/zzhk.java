...
final class zzhk {
    static /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzfb {
    ...
    static /* synthetic */ void zzc(byte b, byte b2, char[] cArr, int i) throws zzfb {
        if (b < -62 || zze(b2)) {
            throw zzfb.zzb();
        }
