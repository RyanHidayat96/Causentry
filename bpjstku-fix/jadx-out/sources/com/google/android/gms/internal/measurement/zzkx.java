...
final class zzkx {
    ...
    static int zzb(int i, byte[] bArr, int i2, zzkw zzkwVar) {
        ...
        while (true) {
            int i11 = i10 + 1;
            if (bArr[i10] >= 0) {
                zzkwVar.zza = i9 | ((b4 & ByteCompanionObject.MAX_VALUE) << 28);
                return i11;
            }
            i10 = i11;
        }
    ...
    static int zzc(byte[] bArr, int i, zzkw zzkwVar) {
        ...
        while (b < 0) {
            b = bArr[i3];
            i4 += 7;
            j2 |= ((long) (b & ByteCompanionObject.MAX_VALUE)) << i4;
            i3++;
        }
        zzkwVar.zzb = j2;
        return i3;
    ...
    static int zzf(byte[] bArr, int i, zzkw zzkwVar) throws zzmr {
        ...
        if ((((length - iZza) - i2) | iZza | i2) < 0) {
            throw new ArrayIndexOutOfBoundsException(String.format("buffer length=%d, index=%d, size=%d", Integer.valueOf(length), Integer.valueOf(iZza), Integer.valueOf(i2)));
        }
        int i4 = iZza + i2;
        ...
        while (iZza < i4) {
            ...
            if (zzoq.zza(b2)) {
                ...
                zzoq.zzc(b2, bArr[i7], bArr[iZza + 2], cArr, i6);
                i6++;
                iZza += 3;
            } else {
                if (i7 >= i4 - 2) {
                ...
                zzoq.zzd(b2, bArr[i7], bArr[iZza + 2], bArr[iZza + 3], cArr, i6);
                i6 += 2;
                iZza += 4;
            }
        }
