...
final class zzlw {
    ...
    static void zzf(zzlm zzlmVar, zzot zzotVar, int i, Object obj) throws IOException {
        ...
        switch (zzotVar) {
            ...
            case SINT32:
                ...
                zzlmVar.zzr((iIntValue + iIntValue) ^ (iIntValue >> 31));
                break;
            case SINT64:
                long jLongValue = ((Long) obj).longValue();
                zzlmVar.zzt((jLongValue + jLongValue) ^ (jLongValue >> 63));
                break;
        }
    }
    ...
    static int zzi(zzot zzotVar, Object obj) {
        ...
        switch (zzotVar) {
            ...
            case SINT32:
                int iIntValue = ((Integer) obj).intValue();
                return zzlm.zzz((iIntValue + iIntValue) ^ (iIntValue >> 31));
            case SINT64:
                long jLongValue = ((Long) obj).longValue();
                return zzlm.zzA((jLongValue + jLongValue) ^ (jLongValue >> 63));
            default:
    ...
    public final /* synthetic */ Object clone() throws IllegalAccessException, CloneNotSupportedException {
    ...
    public final void zzd(zzlv zzlvVar, Object obj) throws IllegalAccessException {
        if (!zzlvVar.zzd()) {
            zzn(zzlvVar, obj);
        } else {
