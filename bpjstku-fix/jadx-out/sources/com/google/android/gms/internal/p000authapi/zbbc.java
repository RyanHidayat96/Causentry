...
public final class zbbc {
    public static int zba(int i, int i2, String str) {
        ...
        if (i < 0) {
            strZba = zbbd.zba("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else {
            if (i2 < 0) {
            ...
            strZba = zbbd.zba("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
    ...
    public static void zbc(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                ...
                strZbd = (i2 < 0 || i2 > i3) ? zbd(i2, i3, "end index") : zbbd.zba("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            }
