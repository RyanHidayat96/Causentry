...
public final class ClientIdentity extends AbstractSafeParcelable {
    ...
    public ClientIdentity(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) String str2, @SafeParcelable.Param(id = 6) String str3, @SafeParcelable.Param(id = 8) List list, @SafeParcelable.Param(id = 7) ClientIdentity clientIdentity) {
        ...
        this.zzd = str2;
        if (str3 == null) {
            str3 = clientIdentity != null ? clientIdentity.zze : null;
        }
        this.zze = str3;
        if (list == null) {
        ...
        Intrinsics.checkNotNullExpressionValue(zzexVarZzj, "");
        this.zzf = zzexVarZzj;
    ...
    public final boolean equals(Object other) {
        ...
        return this.zzb == clientIdentity.zzb && Intrinsics.areEqual(this.zzc, clientIdentity.zzc) && Intrinsics.areEqual(this.zzd, clientIdentity.zzd) && Intrinsics.areEqual(this.zze, clientIdentity.zze) && Intrinsics.areEqual(this.zzg, clientIdentity.zzg) && Intrinsics.areEqual(this.zzf, clientIdentity.zzf);
    }

    public final int hashCode() {
        int i = this.zzb;
        return Arrays.hashCode(new Object[]{Integer.valueOf(i), this.zzc, this.zzd, this.zze, this.zzg});
    }

    public final String toString() {
        int length = this.zzc.length();
        String str = this.zzd;
        StringBuilder sb = new StringBuilder(length + 18 + (str != null ? str.length() : 0));
        sb.append(this.zzb);
        sb.append("/");
        sb.append(this.zzc);
