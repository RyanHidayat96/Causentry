    ...
    static void zzb() {
        synchronized (zzko.class) {
            ...
            for (zzko zzkoVar : map.values()) {
                zzkoVar.zzb.unregisterOnSharedPreferenceChangeListener((SharedPreferences.OnSharedPreferenceChangeListener) updateAndVerifyState.TuitionPaymentFragmentbindingInflater1(zzkoVar.zzc));
            }
            map.clear();
        }
    }
