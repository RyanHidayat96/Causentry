    ...
    static int zzq(List list) {
        ...
        if (!(list instanceof zzna)) {
            ...
            while (i < size) {
                ...
                iZzA += zzlm.zzA((jLongValue + jLongValue) ^ (jLongValue >> 63));
                i++;
            }
            return iZzA;
        }
        ...
        while (i < size) {
            ...
            iZzA2 += zzlm.zzA((jZzc + jZzc) ^ (jZzc >> 63));
            i++;
        }
        return iZzA2;
    }
    ...
    static int zzu(List list) {
        ...
        if (!(list instanceof zzmg)) {
            ...
            while (i < size) {
                ...
                iZzz += zzlm.zzz((iIntValue + iIntValue) ^ (iIntValue >> 31));
                i++;
            }
            return iZzz;
        }
        ...
        while (i < size) {
            ...
            iZzz2 += zzlm.zzz((iZzf + iZzf) ^ (iZzf >> 31));
            i++;
        }
        return iZzz2;
    }
