    ...
    public final boolean zzI() {
        ...
        if (zznlVarZzt.zzK()) {
            ...
            if (zzppVar.zzah() >= 234200) {
                ...
                boolean zEquals = Objects.equals(zzaz.zzi(bundle), true);
                sb.append("&npa=");
            ...
            boolean zEquals2 = Objects.equals(zzaz.zzi(bundle), true);
            sb.append("&npa=");
        ...
        if (urlZzat != null) {
            ...
            zzll zzllVar = new zzll() { // from class: com.google.android.gms.measurement.internal.zzib
                ...
                public final /* synthetic */ void zza(String str3, int i2, Throwable th, byte[] bArr, Map map) {
                    this.zza.zzJ(str3, i2, th, bArr, map);
                }
            };
            zzloVar2.zzw();
    ...
    final /* synthetic */ void zzJ(String str, int i, Throwable th, byte[] bArr, Map map) {
        ...
        if (th == null) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    ...
                    if (listQueryIntentActivities != null && !listQueryIntentActivities.isEmpty()) {
                        ...
                        try {
                            ...
                            zzP(zzguVar4);
                            zzguVar4.zzb().zzb("Failed to persist Deferred Deep Link. exception", e2);
                            return;
                        }
                    }
                }
                ...
                zzgu zzguVar6 = this.zzh;
                zzP(zzguVar6);
                zzguVar6.zzb().zzb("Failed to parse the Deferred Deep Link response. exception", e3);
                return;
            }
        }
        zzgu zzguVar7 = this.zzh;
