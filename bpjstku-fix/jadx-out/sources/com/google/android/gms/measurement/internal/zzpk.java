...
public final class zzpk extends zzos {
    ...
    static boolean zzn(List list, int i) {
        if (i < list.size() * 64) {
            return (((Long) list.get(i / 64)).longValue() & (1 << (i % 64))) != 0;
        }
        return false;
    }
    ...
    final zzoh zzf(String str, com.google.android.gms.internal.measurement.zzic zzicVar, com.google.android.gms.internal.measurement.zzhr zzhrVar, String str2) {
        ...
        Set setM8097m = UByte$$ExternalSyntheticBackport0.m8097m((Object[]) zzicVar2.zzc().zzk(str, zzfy.zzau).split(","));
        ...
        zzN(builder, "gmp_app_id", zzicVar.zzac(), setM8097m);
        zzicVar2.zzc().zzi();
        zzN(builder, "gmp_version", String.valueOf(133005L), setM8097m);
        ...
        zzN(builder, "app_instance_id", strZzV, setM8097m);
        zzN(builder, "rdid", zzicVar.zzP(), setM8097m);
        zzN(builder, "bundle_id", zzicVar.zzK(), setM8097m);
        String strZzk2 = zzhrVar.zzk();
        String strZza = zzjm.zza(strZzk2);
        if (true != TextUtils.isEmpty(strZza)) {
            strZzk2 = strZza;
        }
        zzN(builder, "app_event_name", strZzk2, setM8097m);
        zzN(builder, "app_version", String.valueOf(zzicVar.zzai()), setM8097m);
        ...
        zzN(builder, "os_version", strZzD, setM8097m);
        zzN(builder, "timestamp", String.valueOf(zzhrVar.zzn()), setM8097m);
        if (zzicVar.zzS()) {
            zzN(builder, "lat", "1", setM8097m);
        }
        zzN(builder, "privacy_sandbox_version", String.valueOf(zzicVar.zzaG()), setM8097m);
        zzN(builder, "trigger_uri_source", "1", setM8097m);
        zzN(builder, "trigger_uri_timestamp", String.valueOf(jCurrentTimeMillis), setM8097m);
        zzN(builder, "request_uuid", str2, setM8097m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzat).split("\\|"), bundle, setM8097m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzas).split("\\|"), bundle2, setM8097m);
        zzN(builder, "dma", true != zzicVar.zzaC() ? "0" : "1", setM8097m);
        if (!zzicVar.zzaE().isEmpty()) {
            zzN(builder, "dma_cps", zzicVar.zzaE(), setM8097m);
        }
        if (zzicVar.zzaK()) {
            com.google.android.gms.internal.measurement.zzha zzhaVarZzaL = zzicVar.zzaL();
            if (!zzhaVarZzaL.zzb().isEmpty()) {
                zzN(builder, "dl_gclid", zzhaVarZzaL.zzb(), setM8097m);
            }
            if (!zzhaVarZzaL.zzd().isEmpty()) {
                zzN(builder, "dl_gbraid", zzhaVarZzaL.zzd(), setM8097m);
            }
            if (!zzhaVarZzaL.zzf().isEmpty()) {
                zzN(builder, "dl_gs", zzhaVarZzaL.zzf(), setM8097m);
            }
            if (zzhaVarZzaL.zzh() > 0) {
                zzN(builder, "dl_ss_ts", String.valueOf(zzhaVarZzaL.zzh()), setM8097m);
            }
            if (!zzhaVarZzaL.zzj().isEmpty()) {
                zzN(builder, "mr_gclid", zzhaVarZzaL.zzj(), setM8097m);
            }
            if (!zzhaVarZzaL.zzm().isEmpty()) {
                zzN(builder, "mr_gbraid", zzhaVarZzaL.zzm(), setM8097m);
            }
            if (!zzhaVarZzaL.zzo().isEmpty()) {
                zzN(builder, "mr_gs", zzhaVarZzaL.zzo(), setM8097m);
            }
            if (zzhaVarZzaL.zzq() > 0) {
                zzN(builder, "mr_click_ts", String.valueOf(zzhaVarZzaL.zzq()), setM8097m);
            }
        }
        return new zzoh(builder.build().toString(), jCurrentTimeMillis, 1);
    }

    final com.google.android.gms.internal.measurement.zzhs zzh(zzbb zzbbVar) throws Throwable {
    ...
    final long zzu(String str) {
        ...
        return zzt(str.getBytes(Charset.forName(Hex.DEFAULT_CHARSET_NAME)));
    }
