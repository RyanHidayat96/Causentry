...
final class zzau extends com.google.android.gms.internal.measurement.zzby {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        try {
            ...
            try {
                ...
                this.zza.zzu.zzaV().zzb().zzb("Failed to open freshly created database", e2);
                throw e2;
            }
        }
    }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws Throwable {
        String[] strArrZzai = zzav.zzai();
        zzic zzicVar = this.zza.zzu;
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "events", "CREATE TABLE IF NOT EXISTS events ( app_id TEXT NOT NULL, name TEXT NOT NULL, lifetime_count INTEGER NOT NULL, current_bundle_count INTEGER NOT NULL, last_fire_timestamp INTEGER NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,lifetime_count,current_bundle_count,last_fire_timestamp", strArrZzai);
        ...
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "user_attributes", "CREATE TABLE IF NOT EXISTS user_attributes ( app_id TEXT NOT NULL, name TEXT NOT NULL, set_timestamp INTEGER NOT NULL, value BLOB NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,set_timestamp,value", zzav.zzaj());
        ...
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "queue", "CREATE TABLE IF NOT EXISTS queue ( app_id TEXT NOT NULL, bundle_end_timestamp INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,bundle_end_timestamp,data", zzav.zzam());
        ...
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "app2", "CREATE TABLE IF NOT EXISTS app2 ( app_id TEXT NOT NULL, first_open_count INTEGER NOT NULL, PRIMARY KEY (app_id));", "app_id,first_open_count", zzav.zzap());
        ...
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "consent_settings", "CREATE TABLE IF NOT EXISTS consent_settings ( app_id TEXT NOT NULL, consent_state TEXT NOT NULL, PRIMARY KEY (app_id));", "app_id,consent_state", zzav.zzaq());
        zzqp.zza();
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "trigger_uris", "CREATE TABLE IF NOT EXISTS trigger_uris ( app_id TEXT NOT NULL, trigger_uri TEXT NOT NULL, timestamp_millis INTEGER NOT NULL, source INTEGER NOT NULL);", "app_id,trigger_uri,source,timestamp_millis", zzav.zzar());
