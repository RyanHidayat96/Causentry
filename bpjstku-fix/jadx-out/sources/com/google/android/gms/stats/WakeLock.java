...
public class WakeLock {
    ...
    public WakeLock(Context context, int i, String str) {
        ScheduledExecutorService scheduledExecutorServiceUnconfigurableScheduledExecutorService;
    ...
    public void release() {
        zzc zzcVar;
        this.zzt.decrementAndGet();
        synchronized (this.zzf) {
            zzb(null);
            if (this.zzs.containsKey(null) && (zzcVar = this.zzs.get(null)) != null) {
                int i = zzcVar.zza - 1;
                zzcVar.zza = i;
                if (i == 0) {
