...
final class zzbcu {
    ...
    static /* synthetic */ void zzb(byte b, byte b2, char[] cArr, int i) throws zzbar {
        if (b < -62 || zze(b2)) {
    ...
    static /* synthetic */ void zzd(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzbar {
  ...
  0x0016: PHI (r2v3 byte) = (r2v2 byte), (r2v9 byte) binds: [B:9:0x0011, B:11:0x0015] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    static /* synthetic */ void zzc(byte b, byte b2, byte b3, char[] cArr, int i) throws zzbar {
        if (!zze(b2)) {
            if (b != -32) {
                if (b != -19) {
                    if (!zze(b3)) {
