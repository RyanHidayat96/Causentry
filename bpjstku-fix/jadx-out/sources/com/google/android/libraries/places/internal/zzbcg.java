...
class zzbcg extends AbstractMap {
    ...
    public final Object zzg(int i) {
        zzh();
        Object value = ((zzbcd) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new zzbcd(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int iCompareTo = comparable.compareTo(((zzbcd) this.zza[i2]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int iCompareTo2 = comparable.compareTo(((zzbcd) this.zza[i4]).zza());
            if (iCompareTo2 < 0) {
                i2 = i4 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzd(i2).equals(zzbcgVar.zzd(i2))) {
                return false;
            }
        }
        if (i != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i] = new zzbcd(this, comparable, obj);
        this.zzb++;
        return null;
    }
