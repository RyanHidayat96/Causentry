...
final class zzbzn {
    ...
    private zzbzn() {
        for (int i = 0; i < 256; i++) {
            ...
            while (i3 > 8) {
                ...
                if (zzbzmVar2.zza()[i4] == null) {
                    zzbzmVar2.zza()[i4] = new zzbzm();
                }
                zzbzmVar2 = zzbzmVar2.zza()[i4];
            }
            int i5 = 8 - i3;
            int i6 = (i2 << i5) & 255;
            for (int i7 = i6; i7 < (1 << i5) + i6; i7++) {
                zzbzmVar2.zza()[i7] = zzbzmVar;
            }
        }
    }
    ...
    final byte[] zzb(byte[] bArr) throws IOException {
        ...
        while (i2 < bArr.length) {
            ...
            iZzc += 8;
            while (true) {
                i = (i3 << 8) | (b & UByte.MAX_VALUE);
                if (iZzc >= 8) {
                    int i4 = iZzc - 8;
                    zzbzmVar2 = zzbzmVar2.zza()[(i >>> i4) & 255];
                    if (zzbzmVar2.zza() == null) {
        ...
        while (iZzc > 0) {
            zzbzm zzbzmVar3 = zzbzmVar2.zza()[(i3 << (8 - iZzc)) & 255];
