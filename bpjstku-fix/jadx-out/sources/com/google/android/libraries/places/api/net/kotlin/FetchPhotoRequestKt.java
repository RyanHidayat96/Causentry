...
public final class FetchPhotoRequestKt {
    public static final FetchPhotoRequest fetchPhotoRequest(PhotoMetadata photoMetadata, Function1<? super FetchPhotoRequest.Builder, Unit> function1) {
        ...
        Intrinsics.checkNotNullExpressionValue(fetchPhotoRequestBuild, "");
        return fetchPhotoRequestBuild;
    }

    public static /* synthetic */ FetchPhotoRequest fetchPhotoRequest$default(PhotoMetadata photoMetadata, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            function1 = null;
        }
