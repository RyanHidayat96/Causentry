...
final class zzbtt implements zzbjn {
    ...
    private final CameraStateRegistryCameraRegistrationExternalSyntheticLambda0 zzd;
    private static final Logger zzb = Logger.getLogger(zzbtt.class.getName());
    private static final zzbtr zze = new zzbtr();
    private static final CameraStateRegistryCameraRegistrationExternalSyntheticLambda0 zzc = new zzbts();

    public zzbtt() {
        CameraStateRegistryCameraRegistrationExternalSyntheticLambda0 cameraStateRegistryCameraRegistrationExternalSyntheticLambda0 = zzc;
        zzbtr zzbtrVar = zze;
        this.zzd = cameraStateRegistryCameraRegistrationExternalSyntheticLambda0;
    }
    ...
    private final zzbjm zzc(InetSocketAddress inetSocketAddress) throws IOException {
        try {
            ...
            PasswordAuthentication passwordAuthenticationZza = zzbtr.zza(inetSocketAddress2.getHostString(), inetSocketAddress2.getAddress(), inetSocketAddress2.getPort(), "https", "", null);
            ...
            zzbgsVarZze.zzd(passwordAuthenticationZza.getPassword() != null ? new String(passwordAuthenticationZza.getPassword()) : null);
            return zzbgsVarZze.zze();
        } catch (URISyntaxException e2) {
            zzb.logp(Level.WARNING, "io.grpc.internal.ProxyDetectorImpl", "detectProxy", "Failed to construct URI for proxy lookup, proceeding without proxy", (Throwable) e2);
            return null;
        }
    }
