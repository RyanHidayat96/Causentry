...
public final class zzaww extends zzbae implements zzbbm {
    ...
    private String zzH = "";
    private String zzI = "";
    private zzbao zzW = zzbu();
    private zzbao zzX = zzbu();
    private zzbao zzan = zzbu();
    private zzbao zzay = zzbu();
    ...
    public final zzavm zzE() {
        ...
        int i = this.zzD;
        if (i == 0) {
            zzavmVar = zzavm.BUSINESS_STATUS_UNSPECIFIED;
        } else if (i == 1) {
            zzavmVar = zzavm.OPERATIONAL;
        } else if (i == 2) {
            zzavmVar = zzavm.CLOSED_TEMPORARILY;
        } else if (i != 3) {
            zzavmVar = i != 4 ? null : zzavm.FUTURE_OPENING;
        } else {
            zzavmVar = zzavm.CLOSED_PERMANENTLY;
        }
    ...
    public final zzaxc zzF() {
        ...
        int i = this.zzE;
        if (i == 0) {
            zzaxcVar = zzaxc.PRICE_LEVEL_UNSPECIFIED;
        } else if (i == 1) {
            zzaxcVar = zzaxc.PRICE_LEVEL_FREE;
        } else if (i == 2) {
            zzaxcVar = zzaxc.PRICE_LEVEL_INEXPENSIVE;
        } else if (i == 3) {
            zzaxcVar = zzaxc.PRICE_LEVEL_MODERATE;
        } else if (i != 4) {
            zzaxcVar = i != 5 ? null : zzaxc.PRICE_LEVEL_VERY_EXPENSIVE;
        } else {
            zzaxcVar = zzaxc.PRICE_LEVEL_EXPENSIVE;
        }
    ...
    public final boolean zzat() {
        return (this.zzb & AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL) != 0;
    }
