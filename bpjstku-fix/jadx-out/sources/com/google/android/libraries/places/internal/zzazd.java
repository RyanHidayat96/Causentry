...
final class zzazd implements zzbby {
    ...
    public final void zzA(List list) throws IOException {
        ...
        if (list instanceof zzazw) {
            ...
            if (i == 2) {
                ...
                int iZzo = zzazcVar.zzo();
                zzX(iZzo);
                int iZzC = zzazcVar.zzC();
                do {
                    zzazwVar.zzf(zzazcVar.zze());
                } while (zzazcVar.zzC() < iZzC + iZzo);
                return;
            }
            if (i != 5) {
                throw new zzbaq("Protocol message tag had invalid wire type.");
            ...
            if (i2 == 2) {
                ...
                zzX(iZzo2);
                int iZzC2 = zzazcVar3.zzC();
                do {
                    list.add(Float.valueOf(zzazcVar3.zze()));
                } while (zzazcVar3.zzC() < iZzC2 + iZzo2);
                return;
            }
            if (i2 != 5) {
                throw new zzbaq("Protocol message tag had invalid wire type.");
    ...
    public final void zzH(List list, boolean z) throws IOException {
        int iZza;
        int iZza2;
        if ((this.zzb & 7) != 2) {
            throw new zzbaq("Protocol message tag had invalid wire type.");
        }
        if (!(list instanceof zzbax) || z) {
            do {
                list.add(z ? zzn() : zzm());
                zzazc zzazcVar = this.zza;
                if (zzazcVar.zzB()) {
    ...
    public final boolean zzd() throws IOException {
        int i;
        zzazc zzazcVar = this.zza;
        if (zzazcVar.zzB() || (i = this.zzb) == this.zzc) {
            return false;
        }
        return zzazcVar.zzc(i);
    }
