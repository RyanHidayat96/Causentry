...
interface zzbcz {
    ...
    void zzn(int i, zzayz zzayzVar) throws IOException;
    ...
    void zzr(int i, Object obj, zzbbz zzbbzVar) throws IOException;

    @Deprecated
    void zzs(int i, Object obj, zzbbz zzbbzVar) throws IOException;
