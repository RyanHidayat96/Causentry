    ...
    public static final FindAutocompletePredictionsResponse zza(zzkk zzkkVar) throws ApiException {
        ...
        if (zzjzVarArr != null) {
            for (zzjz zzjzVar : zzjzVarArr) {
                ...
                String strZza = zzjzVar.zza();
                if (strZza == null) {
                    strZza = "";
                }
                builder.setFullText(strZza);
                builder.zzb(zzb(zzjzVar.zzf()));
                zzjz.zza zzaVarZzd = zzjzVar.zzd();
                if (zzaVarZzd != null) {
                    String strZza2 = zzaVarZzd.zza();
                    if (strZza2 == null) {
                        strZza2 = "";
                    }
                    builder.setPrimaryText(strZza2);
                    builder.zzc(zzb(zzaVarZzd.zzc()));
                    String strZzb = zzaVarZzd.zzb();
                    builder.setSecondaryText(strZzb != null ? strZzb : "");
