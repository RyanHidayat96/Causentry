...
final class zzbct {
    ...
    static {
        ...
        if (unsafeZzq == null) {
            ...
            zzbcqVar = new zzbcr(unsafeZzq);
        } else if (zZzr2) {
            zzbcqVar = new zzbcq(unsafeZzq);
        } else {
            zzbcqVar = null;
        }
        zzf = zzbcqVar;
        if (zzbcqVar == null) {
            ...
            try {
                Class<?> cls = zzbcqVar.zza.getClass();
        ...
        if (zzbcsVar2 == null) {
            ...
            try {
                Class<?> cls2 = zzbcsVar2.zza.getClass();
        ...
        zzA(Object[].class);
        Field fieldZzB = zzB();
        if (fieldZzB != null && (zzbcsVar = zzf) != null) {
            zzbcsVar.zza.objectFieldOffset(fieldZzB);
        }
    ...
    public static void zzD(Object obj, long j, byte b) {
        ...
        int i2 = ((~((int) j)) & 3) << 3;
        unsafe.putInt(obj, j2, ((~(255 << i2)) & i) | ((b & UByte.MAX_VALUE) << i2));
    }
    ...
    static /* synthetic */ void zzy(Throwable th) {
        Logger.getLogger(zzbct.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
