...
public final class DoubleCheck<T> implements Provider<T>, Lazy<T> {
    ...
    @Deprecated
    public static <P extends ExtraSupportedResolutionQuirk<T>, T> ExtraSupportedResolutionQuirk<T> provider(P p) {
    ...
    public static <P extends ExtraSupportedResolutionQuirk<T>, T> Lazy<T> lazy(P p) {
