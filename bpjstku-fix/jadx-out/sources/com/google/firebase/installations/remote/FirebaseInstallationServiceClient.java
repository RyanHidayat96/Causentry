...
public class FirebaseInstallationServiceClient {
        ...
        for (int i = 0; i <= 1; i++) {
            ...
            try {
                try {
                    ...
                    int iTuitionPaymentFragmentspecialinlinedviewModeldefault2 = ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault2(httpURLConnectionOpenHttpURLConnection);
                    this.requestLimiter.setNextRequestTime(iTuitionPaymentFragmentspecialinlinedviewModeldefault2);
                    if (isSuccessfulResponseCode(iTuitionPaymentFragmentspecialinlinedviewModeldefault2)) {
                        ...
                        if (iTuitionPaymentFragmentspecialinlinedviewModeldefault2 == 429) {
                            throw new FirebaseInstallationsException("Firebase servers have received too many requests from this client in a short period of time. Please try again later.", FirebaseInstallationsException.Status.TOO_MANY_REQUESTS);
                        }
                        if (iTuitionPaymentFragmentspecialinlinedviewModeldefault2 < 500 || iTuitionPaymentFragmentspecialinlinedviewModeldefault2 >= 600) {
                            logBadConfigError();
    ...
    private static byte[] getJsonBytes(JSONObject jSONObject) throws IOException {
        return jSONObject.toString().getBytes(Hex.DEFAULT_CHARSET_NAME);
    }

    private static void writeRequestBodyToOutputStream(URLConnection uRLConnection, byte[] bArr) throws Exception {
        OutputStream outputStreamTuitionPaymentFragmentbindingInflater1 = ViewPortBuilder.TuitionPaymentFragmentbindingInflater1(uRLConnection);
    ...
    public void deleteFirebaseInstallation(String str, String str2, String str3, String str4) throws FirebaseInstallationsException {
        ...
        while (i <= 1) {
            ...
            try {
                ...
                sb.append("FIS_v2 ");
                sb.append(str4);
                httpURLConnectionOpenHttpURLConnection.addRequestProperty("Authorization", sb.toString());
                int iTuitionPaymentFragmentspecialinlinedviewModeldefault2 = ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault2(httpURLConnectionOpenHttpURLConnection);
                if (iTuitionPaymentFragmentspecialinlinedviewModeldefault2 != 200 && iTuitionPaymentFragmentspecialinlinedviewModeldefault2 != 401 && iTuitionPaymentFragmentspecialinlinedviewModeldefault2 != 404) {
                    logFisCommunicationError(httpURLConnectionOpenHttpURLConnection, null, str, str3);
                    if (iTuitionPaymentFragmentspecialinlinedviewModeldefault2 != 429 && (iTuitionPaymentFragmentspecialinlinedviewModeldefault2 < 500 || iTuitionPaymentFragmentspecialinlinedviewModeldefault2 >= 600)) {
                        logBadConfigError();
        ...
        for (int i = 0; i <= 1; i++) {
            ...
            try {
                ...
                if (isSuccessfulResponseCode(iTuitionPaymentFragmentspecialinlinedviewModeldefault2)) {
                    ...
                    logFisCommunicationError(httpURLConnectionOpenHttpURLConnection, null, str, str3);
                    if (iTuitionPaymentFragmentspecialinlinedviewModeldefault2 == 401 || iTuitionPaymentFragmentspecialinlinedviewModeldefault2 == 404) {
    ...
    private InstallationResponse readCreateResponse(HttpURLConnection httpURLConnection) throws Exception {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStreamTuitionPaymentFragmentspecialinlinedviewModeldefault3, UTF_8));
    ...
    private static String readErrorResponse(HttpURLConnection httpURLConnection) {
        ...
        try {
            try {
                ...
                String str = String.format("Error when communicating with the Firebase Installations server API. HTTP response: [%d %s: %s]", Integer.valueOf(ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault2(httpURLConnection)), httpURLConnection.getResponseMessage(), sb);
                try {
