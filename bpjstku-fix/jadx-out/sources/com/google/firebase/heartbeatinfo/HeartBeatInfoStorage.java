...
class HeartBeatInfoStorage {
    ...
    public HeartBeatInfoStorage(Context context, String str) {
        this.firebaseDataStore = new JavaDataStorage(context, HEARTBEAT_PREFERENCES_NAME.concat(String.valueOf(str)));
    }
        ...
        synchronized (this) {
            this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda2
                ...
                public final Object invoke(Object obj) {
                    return this.f$0.m7959xe97e9b5a((MutablePreferences) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ Unit m7959xe97e9b5a(MutablePreferences mutablePreferences) {
        long j = 0;
        for (Map.Entry<Preferences.Key<?>, Object> entry : mutablePreferences.asMap().entrySet()) {
            if (entry.getValue() instanceof Set) {
                ...
                if (set.contains(formattedDate)) {
                    mutablePreferences.set(key, UByte$$ExternalSyntheticBackport0.m8097m(new Object[]{formattedDate}));
                    j++;
                } else {
    ...
    private Preferences.Key<Set<String>> getStoredUserAgentString(MutablePreferences mutablePreferences, String str) {
        synchronized (this) {
            for (Map.Entry<Preferences.Key<?>, Object> entry : mutablePreferences.asMap().entrySet()) {
                if (entry.getValue() instanceof Set) {
    ...
    private void updateStoredUserAgent(MutablePreferences mutablePreferences, Preferences.Key<Set<String>> key, String str) {
        synchronized (this) {
    ...
    private void removeStoredDate(MutablePreferences mutablePreferences, String str) {
        synchronized (this) {
    ...
    void postHeartBeatCleanUp() {
        synchronized (this) {
            ...
            this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda3
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return this.f$0.m7960x44e9f764(formattedDate, (MutablePreferences) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ Unit m7960x44e9f764(String str, MutablePreferences mutablePreferences) {
    ...
    void storeHeartBeat(long j, final String str) {
        synchronized (this) {
            ...
            this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return this.f$0.m7961x76ccc570(formattedDate, str, keyStringSetKey, (MutablePreferences) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ Unit m7961x76ccc570(String str, String str2, Preferences.Key key, MutablePreferences mutablePreferences) {
    ...
    private long cleanUpStoredHeartBeats(MutablePreferences mutablePreferences) {
        long j;
        synchronized (this) {
    ...
    long getLastGlobalHeartBeat() {
        long jLongValue;
        synchronized (this) {
            jLongValue = ((Long) this.firebaseDataStore.getSync(GLOBAL, -1L)).longValue();
        }
        return jLongValue;
    }
    ...
    boolean isSameDateUtc(long j, long j2) {
        boolean zEquals;
        synchronized (this) {
            zEquals = getFormattedDate(j).equals(getFormattedDate(j2));
        }
        return zEquals;
    }

    boolean shouldSendSdkHeartBeat(Preferences.Key<Long> key, long j) {
        synchronized (this) {
