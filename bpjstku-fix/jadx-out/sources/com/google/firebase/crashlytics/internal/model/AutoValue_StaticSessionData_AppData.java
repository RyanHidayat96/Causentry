...
final class AutoValue_StaticSessionData_AppData extends StaticSessionData.AppData {
    ...
    public final int hashCode() {
        int iHashCode = this.appIdentifier.hashCode();
        int iHashCode2 = this.versionCode.hashCode();
        int iHashCode3 = this.versionName.hashCode();
        return ((((((((((iHashCode ^ 1000003) * 1000003) ^ iHashCode2) * 1000003) ^ iHashCode3) * 1000003) ^ this.installUuid.hashCode()) * 1000003) ^ this.deliveryMechanism) * 1000003) ^ this.developmentPlatformProvider.hashCode();
    }
}
