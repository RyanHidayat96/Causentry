...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution extends CrashlyticsReport.Session.Event.Application.Execution {
    ...
    public final boolean equals(Object obj) {
        ...
        if (list == null) {
            if (execution.getThreads() != null) {
                return false;
            }
        } else if (!list.equals(execution.getThreads())) {
            return false;
        }
        ...
        } else if (!exception.equals(execution.getException())) {
            return false;
        }
        CrashlyticsReport.ApplicationExitInfo applicationExitInfo = this.appExitInfo;
        if (applicationExitInfo == null) {
            if (execution.getAppExitInfo() != null) {
                return false;
            }
        } else if (!applicationExitInfo.equals(execution.getAppExitInfo())) {
            return false;
        }
        return this.signal.equals(execution.getSignal()) && this.binaries.equals(execution.getBinaries());
    }
    ...
    public final int hashCode() {
        ...
        CrashlyticsReport.Session.Event.Application.Execution.Exception exception = this.exception;
        int iHashCode2 = exception == null ? 0 : exception.hashCode();
        CrashlyticsReport.ApplicationExitInfo applicationExitInfo = this.appExitInfo;
        return ((((((((iHashCode ^ 1000003) * 1000003) ^ iHashCode2) * 1000003) ^ (applicationExitInfo != null ? applicationExitInfo.hashCode() : 0)) * 1000003) ^ this.signal.hashCode()) * 1000003) ^ this.binaries.hashCode();
    }
