...
final class AutoValue_StaticSessionData_DeviceData extends StaticSessionData.DeviceData {
    ...
    public final int hashCode() {
        ...
        int i4 = (int) ((j2 >>> 32) ^ j2);
        return ((((((((((((((((i ^ 1000003) * 1000003) ^ iHashCode) * 1000003) ^ i2) * 1000003) ^ i3) * 1000003) ^ i4) * 1000003) ^ (this.isEmulator ? 1231 : 1237)) * 1000003) ^ this.state) * 1000003) ^ this.manufacturer.hashCode()) * 1000003) ^ this.modelClass.hashCode();
    }
}
