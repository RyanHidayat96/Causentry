...
public class DataCollectionConfigStorage {
    ...
    public DataCollectionConfigStorage(Context context, String str, Publisher publisher) {
        ...
        this.sharedPreferences = contextDirectBootSafe.getSharedPreferences(FIREBASE_APP_PREFS.concat(String.valueOf(str)), 0);
    ...
    private boolean readManifestDataCollectionEnabled() {
        ...
        try {
            ...
            if (packageManager == null || (applicationInfo = packageManager.getApplicationInfo(this.deviceProtectedContext.getPackageName(), 128)) == null || ((PackageItemInfo) applicationInfo).metaData == null || !((PackageItemInfo) applicationInfo).metaData.containsKey(DATA_COLLECTION_DEFAULT_ENABLED)) {
                return true;
            }
