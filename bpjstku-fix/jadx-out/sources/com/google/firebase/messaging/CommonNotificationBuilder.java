...
public final class CommonNotificationBuilder {
    ...
    public static String getOrCreateChannel(Context context, String str, Bundle bundle) {
        ...
        try {
            ...
            if (notificationManager.getNotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL) == null) {
                notificationManager.createNotificationChannel(new NotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL, context.getString(com.bpjstku.R.string.fcm_fallback_notification_channel_label), 3));
            }
    ...
    private static PendingIntent createMessagingPendingIntent(Context context, Context context2, Intent intent) {
        return PendingIntent.getBroadcast(context, generatePendingIntentRequestCode(), new Intent(ACTION_RECEIVER).setPackage(context2.getPackageName()).putExtra(CloudMessagingReceiver.IntentKeys.WRAPPED_INTENT, intent), getPendingIntentFlags(BasicMeasure.EXACTLY));
    }
