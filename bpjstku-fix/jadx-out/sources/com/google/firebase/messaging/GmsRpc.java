...
class GmsRpc {
    ...
    Task<?> subscribeToTopic(String str, String str2) {
        Bundle bundle = new Bundle();
        bundle.putString(EXTRA_TOPIC, TOPIC_PREFIX.concat(String.valueOf(str2)));
        return extractResponseWhenComplete(startRpc(str, TOPIC_PREFIX.concat(String.valueOf(str2)), bundle));
    }
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        bundle.putString(PARAM_CLIENT_VER, "fcm-25.0.0");
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task2) {
                return this.f$0.m7980xb80eb67f(task2);
            }
        });
    }
    ...
    /* synthetic */ String m7980xb80eb67f(Task task) throws Exception {
