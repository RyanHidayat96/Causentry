        ...
        return new BoundField(str, field, z, z2) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.1
                ...
                if (this.serialized) {
                    ...
                    if (method3 != null) {
                        try {
                            ...
                            throw new JsonIOException(sb.toString(), e2.getCause());
                        }
                    } else {
            ...
            void readIntoField(JsonReader jsonReader, Object obj) throws IllegalAccessException, IOException {
                ...
                if (z3) {
                    ...
                    throw new JsonIOException("Cannot set value of 'static final' ".concat(String.valueOf(ReflectionHelper.getAccessibleObjectDescription(this.field, false))));
                }
        ...
        if (!cls.isInterface()) {
            ...
            while (rawType != Object.class) {
                ...
                while (i3 < length) {
                    ...
                    boolean zIncludeField = this.includeField(field, z7);
                    boolean zIncludeField2 = this.includeField(field, z8);
                    if (zIncludeField || zIncludeField2) {
                        ...
                        if (!z2) {
                            ...
                            if (accessor.getAnnotation(SerializedName.class) != null && field.getAnnotation(SerializedName.class) == null) {
                                String accessibleObjectDescription = ReflectionHelper.getAccessibleObjectDescription(accessor, z8);
                                StringBuilder sb2 = new StringBuilder("@SerializedName on ");
                        ...
                        while (r1 < size) {
                            ...
                            boolean z9 = r1 != 0 ? z8 : zIncludeField;
                            ?? r22 = r1;
                            ...
                            int i6 = length;
                            boolean z10 = z8;
                            boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, method, str, TypeToken.get(typeResolve), z9, z4, z3)) : boundField2;
                            zIncludeField = z9;
                            i3 = i5;
                            size = i4;
                            fieldNames = list;
