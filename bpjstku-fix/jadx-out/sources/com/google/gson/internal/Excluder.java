...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public final Excluder m8009clone() {
        try {
    ...
    public final Excluder withVersion(double d) {
        Excluder excluderM8009clone = m8009clone();
        excluderM8009clone.version = d;
        return excluderM8009clone;
    }

    public final Excluder withModifiers(int... iArr) {
        Excluder excluderM8009clone = m8009clone();
        excluderM8009clone.modifiers = 0;
        for (int i : iArr) {
            excluderM8009clone.modifiers = i | excluderM8009clone.modifiers;
        }
        return excluderM8009clone;
    }
    ...
    public final Excluder disableInnerClassSerialization() {
        Excluder excluderM8009clone = m8009clone();
        excluderM8009clone.serializeInnerClasses = false;
        return excluderM8009clone;
    }

    public final Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM8009clone = m8009clone();
        excluderM8009clone.requireExpose = true;
        return excluderM8009clone;
    }
    ...
    public final Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM8009clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM8009clone.deserializationStrategies = arrayList2;
