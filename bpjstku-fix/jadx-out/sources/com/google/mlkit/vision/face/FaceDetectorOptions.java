...
public class FaceDetectorOptions {
    ...
    public int hashCode() {
        int iFloatToIntBits = Float.floatToIntBits(this.zzf);
        int i = this.zza;
        int i2 = this.zzb;
        int i3 = this.zzd;
        boolean z = this.zze;
        int i4 = this.zzc;
        return Objects.hashCode(Integer.valueOf(iFloatToIntBits), Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Boolean.valueOf(z), Integer.valueOf(i4), this.zzg);
    }
