    ...
    public ByteBuffer convertToNv21Buffer(InputImage inputImage, boolean z) throws MlKitException {
        ...
        for (int i4 = 0; i4 < height; i4++) {
            ...
            while (i5 < width) {
                ...
                int i8 = (i6 >> 8) & 255;
                int i9 = i6 & 255;
                byteBufferAllocate.put(i2, (byte) Math.min(255, (((((i7 * 66) + (i8 * 129)) + (i9 * 25)) + 128) >> 8) + 16));
                if (i4 % 2 == 0 && i3 % 2 == 0) {
                    byteBufferAllocate.put(i, (byte) Math.min(255, (((((i7 * 112) - (i8 * 94)) - (i9 * 18)) + 128) >> 8) + 128));
                    byteBufferAllocate.put(i + 1, (byte) Math.min(255, (((((i7 * (-38)) - (i8 * 74)) + (i9 * 112)) + 128) >> 8) + 128));
                    i += 2;
                }
                i3++;
                i5++;
