...
public final class zzg implements RemoteModelManagerInterface {
    ...
    public zzg(MlKitContext mlKitContext) {
        zzmq zzmqVarZzb = zznb.zzb("common");
    ...
    public final /* synthetic */ Task deleteDownloadedModel(RemoteModel remoteModel) {
    ...
    @Override // com.google.mlkit.common.sdkinternal.model.RemoteModelManagerInterface
    public final /* synthetic */ Task download(RemoteModel remoteModel, DownloadConditions downloadConditions) {
    ...
    @Override // com.google.mlkit.common.sdkinternal.model.RemoteModelManagerInterface
    public final /* synthetic */ Task isModelDownloaded(RemoteModel remoteModel) {
        final CustomRemoteModel customRemoteModel = (CustomRemoteModel) remoteModel;
    ...
    final /* synthetic */ void zzc(Task task) {
        ...
        zzifVar.zza(Boolean.valueOf(zIsSuccessful));
    ...
    final /* synthetic */ void zzd(Task task) {
        ...
        zzipVar.zza(Boolean.valueOf(zBooleanValue));
