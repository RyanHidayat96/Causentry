...
public class CommonComponentRegistrar implements ComponentRegistrar {
    ...
    public final List getComponents() {
        ...
        }).build(), Component.builder(Cleaner.class).factory(zze.zza).build(), Component.builder(CloseGuard.Factory.class).add(Dependency.required((Class<?>) Cleaner.class)).factory(new ComponentFactory() { // from class: com.google.mlkit.common.internal.zzf
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
