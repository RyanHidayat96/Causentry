...
public abstract class ModelResource {
    ...
    public <T> Task<T> callAfterLoad(Executor executor, final Callable<T> callable, final CancellationToken cancellationToken) {
        ...
        this.taskQueue.submit(new zzm(executor, cancellationToken, cancellationTokenSource, taskCompletionSource), new Runnable() { // from class: com.google.mlkit.common.sdkinternal.zzn
