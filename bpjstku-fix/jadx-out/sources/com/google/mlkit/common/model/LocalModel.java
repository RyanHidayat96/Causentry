...
public class LocalModel {
    ...
    public String toString() {
        zzw zzwVarZza = zzx.zza(this);
        zzwVarZza.zza("absoluteFilePath", this.zza);
        zzwVarZza.zza("assetFilePath", this.zzb);
        zzwVarZza.zza("uri", this.zzc);
        zzwVarZza.zzb("isManifestFile", this.zzd);
        return zzwVarZza.toString();
    }
