...
final class DexterInstance {
    ...
    final void checkPermission(PermissionListener permissionListener, String str, Thread thread) {
        checkSinglePermission(permissionListener, str, thread);
    }

    final void checkPermissions(MultiplePermissionsListener multiplePermissionsListener, Collection<String> collection, Thread thread) {
    ...
    final void onActivityReady(Activity activity) {
    ...
    final void onPermissionRequestDenied(Collection<String> collection) {
        updatePermissionsAsDenied(collection);
    }

    final void onPermissionRequestGranted(Collection<String> collection) {
