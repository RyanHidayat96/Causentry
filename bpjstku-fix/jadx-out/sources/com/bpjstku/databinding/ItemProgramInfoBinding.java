...
public final class ItemProgramInfoBinding implements ViewBinding {
    ...
    private ItemProgramInfoBinding(CardView cardView, ImageView imageView, ImageView imageView2, TextView textView) {
    ...
    public static ItemProgramInfoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.item_program_info, viewGroup, false);
        if (z) {
    ...
    public static ItemProgramInfoBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (imageView2 != null) {
                ...
                if (textView != null) {
                    return new ItemProgramInfoBinding((CardView) view, imageView, imageView2, textView);
                }
            }
        }
