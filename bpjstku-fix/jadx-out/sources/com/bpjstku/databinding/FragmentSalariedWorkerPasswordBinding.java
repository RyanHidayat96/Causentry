...
public final class FragmentSalariedWorkerPasswordBinding implements ViewBinding {
    ...
    public static FragmentSalariedWorkerPasswordBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentSalariedWorkerPasswordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_salaried_worker_password, viewGroup, false);
        if (z) {
    ...
    public static FragmentSalariedWorkerPasswordBinding bind(View view) {
                                            ...
                                            if (textView3 != null) {
                                                ...
                                                if (textView4 != null) {
                                                    ...
                                                    if (textView5 != null) {
                                                        ...
                                                        if (textView6 != null) {
                                                            return new FragmentSalariedWorkerPasswordBinding((ScrollView) view, materialButton, materialCardView, imageView, gridLayout, constraintLayout, textInputLayout, textInputLayout2, textView, textView2, textView3, textView4, textView5, textView6);
                                                        }
                                                    }
                                                }
                                            }
