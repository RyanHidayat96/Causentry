...
public final class FragmentChangePhotoAndFileDialogBinding implements ViewBinding {
    ...
    private FragmentChangePhotoAndFileDialogBinding(FrameLayout frameLayout, MaterialButton materialButton, ImageButton imageButton, ImageButton imageButton2, TextView textView, TextView textView2, TextView textView3) {
    ...
    public static FragmentChangePhotoAndFileDialogBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentChangePhotoAndFileDialogBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_change_photo_and_file_dialog, viewGroup, false);
        if (z) {
    ...
    public static FragmentChangePhotoAndFileDialogBinding bind(View view) {
                ...
                if (imageButton2 != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                return new FragmentChangePhotoAndFileDialogBinding((FrameLayout) view, materialButton, imageButton, imageButton2, textView, textView2, textView3);
                            }
                        }
                    }
                }
