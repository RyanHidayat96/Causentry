...
public final class ActivityIndonesianMigrantWorkerActivationBinding implements ViewBinding {
    ...
    public static ActivityIndonesianMigrantWorkerActivationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityIndonesianMigrantWorkerActivationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_indonesian_migrant_worker_activation, viewGroup, false);
        if (z) {
    ...
    public static ActivityIndonesianMigrantWorkerActivationBinding bind(View view) {
        int i = R.id.btnNext;
                                        ...
                                        if (textInputLayout3 != null) {
                                            ...
                                            if (textInputLayout4 != null) {
                                                ...
                                                if (textView != null) {
                                                    ...
                                                    if (textView2 != null) {
                                                        return new ActivityIndonesianMigrantWorkerActivationBinding((ConstraintLayout) view, materialButton, textInputEditText, layoutToolbarBindingBind, radioButton, radioButton2, radioGroup, textInputLayout, textInputLayout2, textInputLayout3, textInputLayout4, textView, textView2);
                                                    }
                                                }
                                            }
                                        }
