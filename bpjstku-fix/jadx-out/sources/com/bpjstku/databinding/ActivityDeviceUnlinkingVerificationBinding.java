...
public final class ActivityDeviceUnlinkingVerificationBinding implements ViewBinding {
    ...
    public static ActivityDeviceUnlinkingVerificationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityDeviceUnlinkingVerificationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_device_unlinking_verification, viewGroup, false);
        if (z) {
    ...
    public static ActivityDeviceUnlinkingVerificationBinding bind(View view) {
                                    ...
                                    if (textInputLayout2 != null) {
                                        ...
                                        if (textInputLayout3 != null) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    return new ActivityDeviceUnlinkingVerificationBinding((ConstraintLayout) view, materialButton, textInputEditText, textInputEditText2, textInputEditText3, imageView, layoutToolbarBindingBind, textInputLayout, textInputLayout2, textInputLayout3, textView, textView2);
                                                }
                                            }
                                        }
                                    }
