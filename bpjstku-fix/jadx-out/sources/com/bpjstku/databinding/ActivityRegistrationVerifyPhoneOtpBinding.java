...
public final class ActivityRegistrationVerifyPhoneOtpBinding implements ViewBinding {
    ...
    public static ActivityRegistrationVerifyPhoneOtpBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityRegistrationVerifyPhoneOtpBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_registration_verify_phone_otp, viewGroup, false);
        if (z) {
    ...
    public static ActivityRegistrationVerifyPhoneOtpBinding bind(View view) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            return new ActivityRegistrationVerifyPhoneOtpBinding((ConstraintLayout) view, materialButton, materialButton2, imageView, layoutToolbarCenterBindingBind, otpView, textView, textView2, textView3, textView4);
                                        }
                                    }
                                }
                            }
