...
public final class ActivityRegistrationActivationVerifyEmailOtpBinding implements ViewBinding {
    ...
    public static ActivityRegistrationActivationVerifyEmailOtpBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityRegistrationActivationVerifyEmailOtpBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_registration_activation_verify_email_otp, viewGroup, false);
        if (z) {
    ...
    public static ActivityRegistrationActivationVerifyEmailOtpBinding bind(View view) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            return new ActivityRegistrationActivationVerifyEmailOtpBinding((ConstraintLayout) view, materialButton, materialButton2, imageView, layoutToolbarCenterBindingBind, otpView, textView, textView2, textView3, textView4);
                                        }
                                    }
                                }
                            }
