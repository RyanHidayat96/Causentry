...
public final class ActivityResetPasswordByPhoneBinding implements ViewBinding {
    ...
    private ActivityResetPasswordByPhoneBinding(ConstraintLayout constraintLayout, Button button, MaterialCardView materialCardView, TextInputEditText textInputEditText, TextInputEditText textInputEditText2, ImageView imageView, ImageView imageView2, TextInputLayout textInputLayout, TextInputLayout textInputLayout2, TextView textView, TextView textView2) {
    ...
    public static ActivityResetPasswordByPhoneBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityResetPasswordByPhoneBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_reset_password_by_phone, viewGroup, false);
        if (z) {
    ...
    public static ActivityResetPasswordByPhoneBinding bind(View view) {
                                ...
                                if (textInputLayout != null) {
                                    ...
                                    if (textInputLayout2 != null) {
                                        ...
                                        if (textView != null) {
                                            ...
                                            if (textView2 != null) {
                                                return new ActivityResetPasswordByPhoneBinding((ConstraintLayout) view, button, materialCardView, textInputEditText, textInputEditText2, imageView, imageView2, textInputLayout, textInputLayout2, textView, textView2);
                                            }
                                        }
                                    }
                                }
