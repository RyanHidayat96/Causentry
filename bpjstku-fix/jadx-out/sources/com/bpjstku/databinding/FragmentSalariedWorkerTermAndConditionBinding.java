...
public final class FragmentSalariedWorkerTermAndConditionBinding implements ViewBinding {
    ...
    public static FragmentSalariedWorkerTermAndConditionBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentSalariedWorkerTermAndConditionBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_salaried_worker_term_and_condition, viewGroup, false);
        if (z) {
    ...
    public static FragmentSalariedWorkerTermAndConditionBinding bind(View view) {
        int i = R.id.btnAgree;
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (textView4 != null) {
                                        ...
                                        if (textView5 != null) {
                                            ...
                                            if (textView6 != null) {
                                                return new FragmentSalariedWorkerTermAndConditionBinding((ScrollView) view, materialButton, materialButton2, linearLayout, constraintLayout, textView, textView2, textView3, textView4, textView5, textView6);
                                            }
                                        }
                                    }
                                }
