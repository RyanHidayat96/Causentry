...
public final class ActivityPaymentFailedBinding implements ViewBinding {
    ...
    private ActivityPaymentFailedBinding(ConstraintLayout constraintLayout, Button button, ImageView imageView, MultiStateView multiStateView, TextView textView, TextView textView2, TextView textView3, TextView textView4) {
    ...
    public static ActivityPaymentFailedBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_payment_failed, viewGroup, false);
        if (z) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                ...
                                if (textView4 != null) {
                                    return new ActivityPaymentFailedBinding((ConstraintLayout) view, button, imageView, multiStateView, textView, textView2, textView3, textView4);
                                }
                            }
                        }
                    }
