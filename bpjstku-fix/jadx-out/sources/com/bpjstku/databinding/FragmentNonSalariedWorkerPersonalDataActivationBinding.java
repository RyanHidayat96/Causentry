...
public final class FragmentNonSalariedWorkerPersonalDataActivationBinding implements ViewBinding {
    ...
    public static FragmentNonSalariedWorkerPersonalDataActivationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentNonSalariedWorkerPersonalDataActivationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_non_salaried_worker_personal_data_activation, viewGroup, false);
        if (z) {
    ...
    public static FragmentNonSalariedWorkerPersonalDataActivationBinding bind(View view) {
        int i = R.id.btnNext;
                                            ...
                                            if (textInputLayout3 != null) {
                                                ...
                                                if (textView != null) {
                                                    ...
                                                    if (textView2 != null) {
                                                        ...
                                                        if (textView3 != null) {
                                                            return new FragmentNonSalariedWorkerPersonalDataActivationBinding((ScrollView) view, materialButton, constraintLayout, cardView, textInputEditText, imageView, imageView2, constraintLayout2, textInputLayout, textInputLayout2, textInputLayout3, textView, textView2, textView3);
                                                        }
                                                    }
                                                }
                                            }
