...
public final class FragmentAsikResignNonSalariedVerificationRegistrationBinding implements ViewBinding {
    ...
    public static FragmentAsikResignNonSalariedVerificationRegistrationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentAsikResignNonSalariedVerificationRegistrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_asik_resign_non_salaried_verification_registration, viewGroup, false);
        if (z) {
    ...
    public static FragmentAsikResignNonSalariedVerificationRegistrationBinding bind(View view) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (textView4 != null) {
                                                ...
                                                if (textView5 != null) {
                                                    return new FragmentAsikResignNonSalariedVerificationRegistrationBinding((ScrollView) view, materialButton, appCompatCheckBox, cardView, cardView2, imageView, imageView2, textView, textView2, textView3, textView4, textView5);
                                                }
                                            }
                                        }
                                    }
