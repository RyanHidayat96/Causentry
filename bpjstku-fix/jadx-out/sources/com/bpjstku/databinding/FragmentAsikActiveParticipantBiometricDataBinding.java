...
public final class FragmentAsikActiveParticipantBiometricDataBinding implements ViewBinding {
    ...
    public static FragmentAsikActiveParticipantBiometricDataBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentAsikActiveParticipantBiometricDataBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_asik_active_participant_biometric_data, viewGroup, false);
        if (z) {
    ...
    public static FragmentAsikActiveParticipantBiometricDataBinding bind(View view) {
        int i = R.id.btnNext;
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (appCompatTextView != null) {
                                                    ...
                                                    if (appCompatTextView2 != null) {
                                                        return new FragmentAsikActiveParticipantBiometricDataBinding((ScrollView) view, materialButton, cardView, materialCardView, imageView, appCompatImageView, appCompatImageView2, imageView2, appCompatImageView3, textView, textView2, appCompatTextView, appCompatTextView2);
                                                    }
                                                }
                                            }
                                        }
