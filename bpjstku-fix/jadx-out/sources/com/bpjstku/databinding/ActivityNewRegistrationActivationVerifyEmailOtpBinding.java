...
public final class ActivityNewRegistrationActivationVerifyEmailOtpBinding implements ViewBinding {
    ...
    public static ActivityNewRegistrationActivationVerifyEmailOtpBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityNewRegistrationActivationVerifyEmailOtpBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_new_registration_activation_verify_email_otp, viewGroup, false);
        if (z) {
    ...
    public static ActivityNewRegistrationActivationVerifyEmailOtpBinding bind(View view) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (textView4 != null) {
                                        return new ActivityNewRegistrationActivationVerifyEmailOtpBinding((ConstraintLayout) view, materialButton, materialButton2, layoutToolbarCenterBindingBind, otpView, textView, textView2, textView3, textView4);
                                    }
                                }
                            }
                        }
