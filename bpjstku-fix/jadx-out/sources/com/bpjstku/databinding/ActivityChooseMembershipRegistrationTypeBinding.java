...
public final class ActivityChooseMembershipRegistrationTypeBinding implements ViewBinding {
    ...
    private ActivityChooseMembershipRegistrationTypeBinding(LinearLayout linearLayout, Group group, Group group2, Group group3, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, ImageView imageView6, LayoutToolbarBinding layoutToolbarBinding, TextView textView, TextView textView2, TextView textView3, TextView textView4) {
    ...
    public static ActivityChooseMembershipRegistrationTypeBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityChooseMembershipRegistrationTypeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_choose_membership_registration_type, viewGroup, false);
        if (z) {
    ...
    public static ActivityChooseMembershipRegistrationTypeBinding bind(View view) {
                                                ...
                                                if (textView != null) {
                                                    ...
                                                    if (textView2 != null) {
                                                        ...
                                                        if (textView3 != null) {
                                                            ...
                                                            if (textView4 != null) {
                                                                return new ActivityChooseMembershipRegistrationTypeBinding((LinearLayout) view, group, group2, group3, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, layoutToolbarBindingBind, textView, textView2, textView3, textView4);
                                                            }
                                                        }
                                                    }
                                                }
