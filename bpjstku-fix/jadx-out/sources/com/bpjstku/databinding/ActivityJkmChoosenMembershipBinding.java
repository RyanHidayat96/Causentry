...
public final class ActivityJkmChoosenMembershipBinding implements ViewBinding {
    ...
    private ActivityJkmChoosenMembershipBinding(LinearLayout linearLayout, Group group, Group group2, Group group3, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, ImageView imageView6, ImageView imageView7, ImageView imageView8, ImageView imageView9, LayoutToolbarBinding layoutToolbarBinding, TextView textView, TextView textView2, TextView textView3, TextView textView4) {
    ...
    public static ActivityJkmChoosenMembershipBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityJkmChoosenMembershipBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_jkm_choosen_membership, viewGroup, false);
        if (z) {
    ...
    public static ActivityJkmChoosenMembershipBinding bind(View view) {
                                                            ...
                                                            if (textView != null) {
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (textView3 != null) {
                                                                        ...
                                                                        if (textView4 != null) {
                                                                            return new ActivityJkmChoosenMembershipBinding((LinearLayout) view, group, group2, group3, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, imageView9, layoutToolbarBindingBind, textView, textView2, textView3, textView4);
                                                                        }
                                                                    }
                                                                }
                                                            }
