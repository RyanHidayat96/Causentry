...
public final class ActivityResetAccountBinding implements ViewBinding {
    ...
    private ActivityResetAccountBinding(ConstraintLayout constraintLayout, LayoutToolbarBinding layoutToolbarBinding, LinearLayout linearLayout, ConstraintLayout constraintLayout2, FrameLayout frameLayout) {
    ...
    public static ActivityResetAccountBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_reset_account, viewGroup, false);
        if (z) {
    ...
    public static ActivityResetAccountBinding bind(View view) {
        ...
        if (viewFindChildViewById != null) {
            ...
            if (linearLayout != null) {
                ...
                if (frameLayout != null) {
                    return new ActivityResetAccountBinding(constraintLayout, layoutToolbarBindingBind, linearLayout, constraintLayout, frameLayout);
                }
            }
        }
