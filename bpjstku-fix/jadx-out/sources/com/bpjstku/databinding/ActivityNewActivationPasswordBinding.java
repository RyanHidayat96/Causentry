...
public final class ActivityNewActivationPasswordBinding implements ViewBinding {
    ...
    public static ActivityNewActivationPasswordBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityNewActivationPasswordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_new_activation_password, viewGroup, false);
        if (z) {
    ...
    public static ActivityNewActivationPasswordBinding bind(View view) {
        int i = R.id.btnNext;
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            ...
                                                            if (textView6 != null) {
                                                                return new ActivityNewActivationPasswordBinding((ScrollView) view, materialButton, materialCardView, imageView, imageView2, linearLayout, constraintLayout, textInputLayout, textInputLayout2, textView, textView2, textView3, textView4, textView5, textView6);
                                                            }
                                                        }
                                                    }
                                                }
