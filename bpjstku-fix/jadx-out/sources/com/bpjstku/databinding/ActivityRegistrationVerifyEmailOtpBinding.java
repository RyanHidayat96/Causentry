...
public final class ActivityRegistrationVerifyEmailOtpBinding implements ViewBinding {
    ...
    public static ActivityRegistrationVerifyEmailOtpBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityRegistrationVerifyEmailOtpBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_registration_verify_email_otp, viewGroup, false);
        if (z) {
    ...
    public static ActivityRegistrationVerifyEmailOtpBinding bind(View view) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            return new ActivityRegistrationVerifyEmailOtpBinding((ConstraintLayout) view, materialButton, materialButton2, imageView, layoutToolbarCenterBindingBind, otpView, textView, textView2, textView3, textView4);
                                        }
                                    }
                                }
                            }
