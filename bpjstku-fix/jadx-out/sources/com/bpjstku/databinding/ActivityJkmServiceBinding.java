...
import defpackage.setAttributeInternal;
...
public final class ActivityJkmServiceBinding implements ViewBinding {
    ...
    public static ActivityJkmServiceBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_jkm_service, viewGroup, false);
        if (z) {
        ...
        if (imageView != null) {
            ...
            if (viewFindChildViewById != null) {
                ...
                if (recyclerView != null) {
                    return new ActivityJkmServiceBinding((ScrollView) view, imageView, layoutToolbarCenterBindingBind, recyclerView);
                }
                i = R.id.rvJkmService;
            }
        }
    ...
    public static /* synthetic */ void TuitionPaymentFragmentspecialinlinedviewModeldefault3() {
        setFocalLength.TuitionPaymentFragmentspecialinlinedviewModeldefault3[0] = setAttributeInternal.TuitionPaymentFragmentspecialinlinedviewModeldefault2[0];
    }
}
