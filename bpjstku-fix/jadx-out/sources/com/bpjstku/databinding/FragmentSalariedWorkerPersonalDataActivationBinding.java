...
public final class FragmentSalariedWorkerPersonalDataActivationBinding implements ViewBinding {
    ...
    public static FragmentSalariedWorkerPersonalDataActivationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentSalariedWorkerPersonalDataActivationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_salaried_worker_personal_data_activation, viewGroup, false);
        if (z) {
    ...
    public static FragmentSalariedWorkerPersonalDataActivationBinding bind(View view) {
        int i = R.id.btnNext;
