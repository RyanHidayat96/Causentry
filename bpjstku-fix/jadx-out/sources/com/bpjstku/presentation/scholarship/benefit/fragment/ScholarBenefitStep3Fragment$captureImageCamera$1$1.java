...
@DebugMetadata(c = "com.bpjstku.presentation.scholarship.benefit.fragment.ScholarBenefitStep3Fragment$captureImageCamera$1$1", f = "ScholarBenefitStep3Fragment.kt", i = {}, l = {76}, m = "invokeSuspend", n = {}, s = {})
public final class ScholarBenefitStep3Fragment$captureImageCamera$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            File file = this.this$0.asInterface;
            ...
            this.label = 1;
            if (Camera2CameraControlExternalSyntheticLambda5.TuitionPaymentFragmentspecialinlinedviewModeldefault1(contextRequireContext, file, new Function1() { // from class: isCameraCaptureSessionOpen
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
                    return ScholarBenefitStep3Fragment$captureImageCamera$1$1.TuitionPaymentFragmentspecialinlinedviewModeldefault3(generateultrahdrsupportedcombinationlist, getopeningblocker, (File) obj2);
                }
    ...
    public static /* synthetic */ Unit TuitionPaymentFragmentspecialinlinedviewModeldefault3(generateUltraHdrSupportedCombinationList generateultrahdrsupportedcombinationlist, getOpeningBlocker getopeningblocker, File file) throws IOException {
    ...
    public final /* synthetic */ Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ScholarBenefitStep3Fragment$captureImageCamera$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScholarBenefitStep3Fragment$captureImageCamera$1$1(getOpeningBlocker getopeningblocker, generateUltraHdrSupportedCombinationList generateultrahdrsupportedcombinationlist, Continuation<? super ScholarBenefitStep3Fragment$captureImageCamera$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ScholarBenefitStep3Fragment$captureImageCamera$1$1(this.this$0, this.$viewModel, continuation);
    }
}
