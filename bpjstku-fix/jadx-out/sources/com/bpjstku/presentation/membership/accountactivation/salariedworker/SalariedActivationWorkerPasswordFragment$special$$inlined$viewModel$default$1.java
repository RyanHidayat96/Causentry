...
import defpackage.ByteBufferOutputStream;
...
public final class SalariedActivationWorkerPasswordFragment$special$$inlined$viewModel$default$1 extends Lambda implements Function0<setSplitTrack> {
    ...
    public SalariedActivationWorkerPasswordFragment$special$$inlined$viewModel$default$1(LifecycleOwner lifecycleOwner) {
        super(0);
        this.$this_viewModel = lifecycleOwner;
    }

    public static /* synthetic */ void b() {
        ByteBufferOutputStream.TuitionPaymentFragmentbindingInflater1[0] = Class.forName("getPreviewCapabilities$disconnect").getDeclaredField("g");
    }
}
