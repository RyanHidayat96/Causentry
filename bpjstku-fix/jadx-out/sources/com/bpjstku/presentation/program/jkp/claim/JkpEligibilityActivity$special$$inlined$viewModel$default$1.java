...
import defpackage.getUseCaseConfigs;
import defpackage.isQuickZoomEnabled;
import defpackage.lambdagetAttachedUseCaseConfigs0;
...
public final class JkpEligibilityActivity$special$$inlined$viewModel$default$1 extends Lambda implements Function0<ActivityResultContractsPickVisualMediaMediaCapabilities> {
    ...
    public JkpEligibilityActivity$special$$inlined$viewModel$default$1(LifecycleOwner lifecycleOwner) {
        super(0);
        this.$this_viewModel = lifecycleOwner;
    }

    public static /* synthetic */ void TuitionPaymentFragmentspecialinlinedviewModeldefault2() {
        getUseCaseConfigs.TuitionPaymentFragmentspecialinlinedviewModeldefault3[0] = lambdagetAttachedUseCaseConfigs0.b[0];
    }
}
