...
public final class ClaimOldDaySecurityBalanceFragment$special$$inlined$sharedViewModel$default$2 extends Lambda implements Function0<getExtendedConfig> {
    ...
    public final /* synthetic */ getExtendedConfig invoke() {
        return getFocusY.b(this.$this_sharedViewModel, Reflection.getOrCreateKotlinClass(getExtendedConfig.class), this.$qualifier, this.$from, this.$parameters);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ClaimOldDaySecurityBalanceFragment$special$$inlined$sharedViewModel$default$2(Fragment fragment, Function0 function0) {
        super(0);
