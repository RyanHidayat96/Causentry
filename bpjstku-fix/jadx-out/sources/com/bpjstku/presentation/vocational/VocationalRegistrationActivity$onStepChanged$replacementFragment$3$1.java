...
final /* synthetic */ class VocationalRegistrationActivity$onStepChanged$replacementFragment$3$1 extends FunctionReferenceImpl implements Function2<VocationRegistrationStep, VocationalRegistration, Unit> {
    public final void b(VocationRegistrationStep vocationRegistrationStep, VocationalRegistration vocationalRegistration) {
    ...
    public final /* synthetic */ Unit invoke(VocationRegistrationStep vocationRegistrationStep, VocationalRegistration vocationalRegistration) {
        b(vocationRegistrationStep, vocationalRegistration);
        return Unit.INSTANCE;
    }

    VocationalRegistrationActivity$onStepChanged$replacementFragment$3$1(Object obj) {
