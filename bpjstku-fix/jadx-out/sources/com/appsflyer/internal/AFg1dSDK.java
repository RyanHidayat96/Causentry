...
public final class AFg1dSDK {
    ...
    private AFg1dSDK(Object obj) throws Throwable {
        try {
            Object declaredMethod = AFa1kSDK.i.get(-865524410);
            if (declaredMethod == null) {
                ...
                AFa1kSDK.i.put(-865524410, declaredMethod);
            }
            ...
            Object declaredMethod2 = AFa1kSDK.i.get(464586448);
            if (declaredMethod2 == null) {
                ...
                AFa1kSDK.i.put(464586448, declaredMethod2);
            }
    ...
    private AFg1dSDK(String str) throws Throwable {
        try {
            Object[] objArr = {str};
            Object declaredConstructor = AFa1kSDK.i.get(1502086856);
            if (declaredConstructor == null) {
                ...
                AFa1kSDK.i.put(1502086856, declaredConstructor);
            }
    ...
    static String getMediationNetwork(Number number) throws Throwable {
        ...
        try {
            ...
            Object declaredMethod = AFa1kSDK.i.get(1011674371);
            if (declaredMethod == null) {
                ...
                AFa1kSDK.i.put(1011674371, declaredMethod);
            }
        ...
        try {
            if (obj instanceof JSONArray) {
                try {
                    ...
                    Object declaredConstructor = AFa1kSDK.i.get(-22273894);
                    if (declaredConstructor == null) {
                        ...
                        AFa1kSDK.i.put(-22273894, declaredConstructor);
                    }
            ...
            try {
                if (obj instanceof Collection) {
                    try {
                        ...
                        Object declaredConstructor2 = AFa1kSDK.i.get(1460610771);
                        if (declaredConstructor2 == null) {
                            ...
                            AFa1kSDK.i.put(1460610771, declaredConstructor2);
                        }
                ...
                if (obj.getClass().isArray()) {
                    try {
                        Object[] objArr3 = {obj};
                        Object declaredConstructor3 = AFa1kSDK.i.get(-1726787512);
                        if (declaredConstructor3 == null) {
                            ...
                            AFa1kSDK.i.put(-1726787512, declaredConstructor3);
                        }
    ...
    public final AFg1dSDK getCurrencyIso4217Code(String str, Object obj) throws Throwable {
        ...
        if (obj instanceof Number) {
            try {
                ...
                Object method = AFa1kSDK.i.get(1011674371);
                if (method == null) {
                    method = ((Class) AFa1kSDK.getCurrencyIso4217Code(284 - (AudioTrack.getMinVolume() > 0.0f ? 1 : (AudioTrack.getMinVolume() == 0.0f ? 0 : -1)), (char) (ViewConfiguration.getLongPressTimeout() >> 16), 37 - TextUtils.getTrimmedLength(""))).getMethod("getMonetizationNetwork", Double.TYPE);
                    AFa1kSDK.i.put(1011674371, method);
                }
            } catch (Throwable th) {
                Throwable cause = th.getCause();
                if (cause != null) {
    ...
    final void AFAdRevenueData(AFg1eSDK aFg1eSDK) throws AFg1mSDK {
