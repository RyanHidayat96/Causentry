...
public final class AFk1vSDK extends FilterInputStream {
    ...
    private void getCurrencyIso4217Code() {
        ...
        byte[] bArr2 = this.component4;
        AFk1tSDK.AFAdRevenueData(((bArr2[0] << 24) & ViewCompat.MEASURED_STATE_MASK) + ((bArr2[1] << 16) & 16711680) + ((bArr2[2] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) + (bArr2[3] & UByte.MAX_VALUE), ((bArr2[4] << 24) & ViewCompat.MEASURED_STATE_MASK) + ((bArr2[5] << 16) & 16711680) + ((bArr2[6] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) + (bArr2[7] & UByte.MAX_VALUE), false, this.getCurrencyIso4217Code, this.getMonetizationNetwork.getCurrencyIso4217Code, this.getMonetizationNetwork.getRevenue, this.component2);
        ...
        if (this.copydefault == 2) {
            for (int i3 = 0; i3 < 8; i3++) {
                ...
                bArr4[i3] = (byte) (bArr4[i3] ^ this.component1[i3]);
            }
    ...
    private int AFAdRevenueData() throws IOException {
        ...
        if (this.areAllFieldsValid == 8) {
            ...
            this.toString = i6 < 0 ? 8 - (this.component4[7] & UByte.MAX_VALUE) : 8;
        }
