    ...
    public static final Pair<Integer, Integer> getRevenue(String str) {
        ...
        if (matchResultMatchEntire != null) {
            ...
            if (getRevenue(intOrNull, intOrNull2, intOrNull3, intOrNull4, intOrNull5, intOrNull6)) {
                ...
                return TuplesKt.to(Integer.valueOf((iIntValue * 1000000) + (iIntValue2 * 1000) + iIntValue3), Integer.valueOf((iIntValue4 * 1000000) + (iIntValue5 * 1000) + intOrNull6.intValue()));
            }
        }
        return null;
    }
