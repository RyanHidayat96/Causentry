...
public final class AFc1oSDK extends ThreadPoolExecutor {
    ...
    private AFc1oSDK(int i, int i2, long j, TimeUnit timeUnit, BlockingQueue<Runnable> blockingQueue, final Queue<Runnable> queue) {
        super(i, i2, j, timeUnit, blockingQueue, new RejectedExecutionHandler() { // from class: com.appsflyer.internal.AFc1oSDK$$ExternalSyntheticLambda0
    ...
    protected final void afterExecute(Runnable p0, Throwable p1) {
        ...
        AFg1gSDK.e$default(AFLogger.INSTANCE, AFg1cSDK.AF_EXECUTOR, "Error while executing task: ".concat(String.valueOf(p0)), p1, true, true, true, false, 64, null);
    }
}
