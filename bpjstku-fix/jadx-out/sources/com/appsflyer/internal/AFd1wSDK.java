...
public final class AFd1wSDK extends AFd1zSDK {
    ...
    private final AFd1gSDK getMonetizationNetwork;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AFd1wSDK(byte[] bArr, Map<String, String> map, int i) {
        super(bArr, map, i);
        Intrinsics.checkNotNullParameter(bArr, "");
        this.getMonetizationNetwork = AFd1gSDK.JSON;
    }

    @Override // com.appsflyer.internal.AFd1zSDK
    public final String getCurrencyIso4217Code() {
        String str = String.format(getRevenue, AppsFlyerLib.getInstance().getHostPrefix(), ((AFa1tSDK) AFa1tSDK.getMonetizationNetwork(new Object[0], -631580017, 631580017, (int) System.currentTimeMillis())).getHostName());
    ...
    public final AFd1gSDK getGetMonetizationNetwork() {
