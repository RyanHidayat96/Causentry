...
public class AFa1kSDK {
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 74421. Try increasing type updates limit count.
    ...
    static {
        /*
            Method dump skipped, instruction units count: 7442
    ...
    public static Object getCurrencyIso4217Code(int i2, char c, int i3) throws Throwable {
        ...
        try {
            ...
            byte b = bArr[85];
            Object objInvoke = cls.getMethod($$c(b, bArr[564], b), Integer.TYPE, Character.TYPE, Integer.TYPE).invoke(obj, objArr);
            int i7 = $10;
            $11 = ((i7 & 25) + (i7 | 25)) % 128;
            return objInvoke;
        } catch (Throwable th) {
