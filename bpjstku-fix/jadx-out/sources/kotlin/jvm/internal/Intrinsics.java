...
public class Intrinsics {
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        ...
        StringBuilder sb = new StringBuilder("Method specified as non-null returned null: ");
        sb.append(str);
        sb.append(".");
        sb.append(str2);
        throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(sb.toString())));
    ...
    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        ...
        StringBuilder sb = new StringBuilder("Field specified as non-null is null: ");
        sb.append(str);
        sb.append(".");
        sb.append(str2);
        throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(sb.toString())));
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(sb.toString(), e2)));
        }
    }
