...
final class RequestFactory {
    ...
    final Request create(Object[] objArr) throws IOException {
    ...
    static final class Builder {
        ...
        private Headers parseHeaders(String[] strArr) {
            ...
            for (String str : strArr) {
                ...
                if (HttpHeaderParser.HEADER_CONTENT_TYPE.equalsIgnoreCase(strSubstring)) {
                    try {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                sb6.append(strValue5);
                sb6.append("\"");
                Headers headersOf = Headers.of("Content-Disposition", sb6.toString(), "Content-Transfer-Encoding", part.encoding());
                if (Iterable.class.isAssignableFrom(rawType8)) {
                    if (!(type instanceof ParameterizedType)) {
