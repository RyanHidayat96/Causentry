        ...
        for (String str : this.mFragments) {
            ...
            if (fragment != null) {
                ...
                if (savedState != null) {
                    ...
                    Fragment fragmentInstantiate = ((FragmentState) savedState.getParcelable(RemoteConfigConstants.ResponseFieldKey.STATE)).instantiate(fragmentManager.getFragmentFactory(), classLoader);
