...
class FragmentStateManager {
    ...
    void attach() {
        ...
        if (this.mFragment.mTarget != null) {
            ...
            if (fragmentStateManager2 == null) {
                ...
                sb.append(this.mFragment.mTarget);
            ...
            sb2.append(this.mFragment.mTargetWho);
    ...
    Bundle saveState() {
        ...
        if (this.mFragment.mState >= 0) {
            ...
            Bundle bundleM7246lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m7246lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!bundleM7246lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, bundleM7246lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
