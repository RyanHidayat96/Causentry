...
final class BackStackRecordState implements Parcelable {
    ...
    public final BackStackRecord instantiate(FragmentManager fragmentManager) {
    ...
    public final BackStackRecord instantiate(FragmentManager fragmentManager, Map<String, Fragment> map) {
        BackStackRecord backStackRecord = new BackStackRecord(fragmentManager);
        fillInBackStackRecord(backStackRecord);
        for (int i = 0; i < this.mFragmentWhos.size(); i++) {
            String str = this.mFragmentWhos.get(i);
            if (str != null) {
                ...
                if (fragment != null) {
                    ...
                    StringBuilder sb = new StringBuilder("Restoring FragmentTransaction ");
