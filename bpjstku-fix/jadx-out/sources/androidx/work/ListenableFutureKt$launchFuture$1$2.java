...
final class ListenableFutureKt$launchFuture$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r4) {
        /*
            ...
            if (r1 == 0) goto L17
            if (r1 != r2) goto Lf
            kotlin.ResultKt.throwOnFailure(r4)     // Catch: java.lang.Throwable -> L2f java.util.concurrent.CancellationException -> L36
            goto L29
        Lf:
        ...
        L17:
            ...
            kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super T>, java.lang.Object> r1 = r3.$block     // Catch: java.lang.Throwable -> L2f java.util.concurrent.CancellationException -> L36
            r3.label = r2     // Catch: java.lang.Throwable -> L2f java.util.concurrent.CancellationException -> L36
            java.lang.Object r4 = r1.invoke(r4, r3)     // Catch: java.lang.Throwable -> L2f java.util.concurrent.CancellationException -> L36
            if (r4 != r0) goto L29
            return r0
        L29:
            androidx.concurrent.futures.CallbackToFutureAdapter$Completer<T> r0 = r3.$completer     // Catch: java.lang.Throwable -> L2f java.util.concurrent.CancellationException -> L36
            r0.set(r4)     // Catch: java.lang.Throwable -> L2f java.util.concurrent.CancellationException -> L36
            goto L3b
        L2f:
            r4 = move-exception
