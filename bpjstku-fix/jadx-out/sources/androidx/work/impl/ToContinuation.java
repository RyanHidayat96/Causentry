...
final class ToContinuation<T> implements Runnable {
    ...
    public ToContinuation(ListenableFuture<T> listenableFuture, MediaFormatMustNotUseFrameRateToFindEncoderQuirk<? super T> mediaFormatMustNotUseFrameRateToFindEncoderQuirk) {
        ...
        Intrinsics.checkNotNullParameter(mediaFormatMustNotUseFrameRateToFindEncoderQuirk, "");
    ...
    public final void run() {
        if (!this.futureToObserve.isCancelled()) {
            try {
                ...
                mediaFormatMustNotUseFrameRateToFindEncoderQuirk.resumeWith(Result.m8024constructorimpl(WorkerWrapperKt.getUninterruptibly(this.futureToObserve)));
                return;
                ...
                mediaFormatMustNotUseFrameRateToFindEncoderQuirk2.resumeWith(Result.m8024constructorimpl(ResultKt.createFailure(WorkerWrapperKt.nonNullCause(e2))));
                return;
            }
        }
