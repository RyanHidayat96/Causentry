...
public class ForceStopRunnable implements Runnable {
                ...
                while (true) {
                    try {
                        ...
                        try {
                            ...
                            sb.append(((long) i) * 300);
                            logger2.debug(str3, sb.toString(), e2);
                        ...
                        sb2.append(((long) i) * 300);
                        logger3.debug(str4, sb2.toString(), e2);
                        sleep(((long) this.mRetryCount) * 300);
    ...
    public boolean multiProcessChecks() {
        ...
        Logger.get().debug(TAG, "Is default app process = ".concat(String.valueOf(zIsDefaultProcess)));
