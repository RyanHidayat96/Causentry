...
public class SystemJobService extends JobService implements ExecutionListener {
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        ...
        if (this.mJobParameters.containsKey(workGenerationalIdWorkGenerationalIdFromJobParameters)) {
            Logger.get().debug(TAG, "Job is already being executed by SystemJobService: ".concat(String.valueOf(workGenerationalIdWorkGenerationalIdFromJobParameters)));
            return false;
        }
        Logger.get().debug(TAG, "onStartJob for ".concat(String.valueOf(workGenerationalIdWorkGenerationalIdFromJobParameters)));
    ...
    public boolean onStopJob(JobParameters jobParameters) {
        ...
        Logger.get().debug(TAG, "onStopJob for ".concat(String.valueOf(workGenerationalIdWorkGenerationalIdFromJobParameters)));
