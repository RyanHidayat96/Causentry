    ...
    public final SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(23) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                map2.put(RemoteConfigConstants.ResponseFieldKey.STATE, new TableInfo.Column(RemoteConfigConstants.ResponseFieldKey.STATE, "INTEGER", true, 0, null, 1));
                ...
                if (!tableInfo5.equals(tableInfo6)) {
                    ...
                    sb3.append(tableInfo5);
                    sb3.append("\n Found:\n");
                    sb3.append(tableInfo6);
                ...
                if (!tableInfo7.equals(tableInfo8)) {
                    ...
                    sb4.append(tableInfo7);
                    sb4.append("\n Found:\n");
                    sb4.append(tableInfo8);
                ...
                if (!tableInfo9.equals(tableInfo10)) {
                    ...
                    sb5.append(tableInfo9);
                    sb5.append("\n Found:\n");
                    sb5.append(tableInfo10);
                ...
                if (!tableInfo13.equals(tableInfo14)) {
                    ...
                    sb7.append(tableInfo13);
                    sb7.append("\n Found:\n");
                    sb7.append(tableInfo14);
