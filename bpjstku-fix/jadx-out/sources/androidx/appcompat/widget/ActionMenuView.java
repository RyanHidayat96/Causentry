    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i10 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int iMeasureChildForCells = measureChildForCells(childAt, i8, layoutParams.isOverflowButton ? 1 : i7, childMeasureSpec, paddingTop);
            ...
            while (i25 < childCount) {
                ...
                if ((j2 & j3) == 0) {
                    ...
                    if (z4 && layoutParams3.preventEdgeOffset && i7 == 1) {
                        ...
                        childAt2.setPadding(i29 + i8, 0, i29, 0);
                    }
        ...
        if (i7 <= 0 || j == 0 || (i7 >= i11 - 1 && !z6 && i31 <= 1)) {
            ...
            if (z6) {
                ...
                int i32 = i30 - 1;
                if ((((long) (1 << i32)) & j) != 0 && !((LayoutParams) getChildAt(i32).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i33 = fBitCount > 0.0f ? (int) ((i7 * i8) / fBitCount) : i4;
            boolean z7 = z5;
            for (int i34 = i4; i34 < i30; i34++) {
                if ((((long) (1 << i34)) & j) != 0) {
        ...
        setMeasuredDimension(i16, mode == 1073741824 ? i17 : i3);
    }
