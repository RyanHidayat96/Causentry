...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private void measureChildConstrained(View view, int i, int i2, int i3, int i4, int i5) {
        ...
        int childMeasureSpec = getChildMeasureSpec(i, paddingLeft + paddingRight + i6 + marginLayoutParams.rightMargin + i2, ((ViewGroup.LayoutParams) marginLayoutParams).width);
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int i7 = marginLayoutParams.topMargin;
        int childMeasureSpec2 = getChildMeasureSpec(i3, paddingTop + paddingBottom + i7 + marginLayoutParams.bottomMargin + i4, ((ViewGroup.LayoutParams) marginLayoutParams).height);
    ...
    public void onMeasure(int i, int i2) {
        ...
        iArr[!zIsLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetEnd - measuredWidth2);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            iMax2 = measuredWidth3 + horizontalMargins;
        } else {
            measuredHeight = 0;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            iMax2 = Math.max(iMax2, measureChildCollapseMargins(this.mSubtitleTextView, i, iMax4 + i5, i2, i4 + measuredHeight, iArr));
    ...
    /* JADX WARN: Code duplicated, block: B:106:0x02bd A[LOOP:1: B:105:0x02bb->B:106:0x02bd, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:109:0x02e6 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:110:0x02e8  */
    /* JADX WARN: Code duplicated, block: B:111:0x02ec  */
    /* JADX WARN: Code duplicated, block: B:114:0x02f5 A[LOOP:2: B:113:0x02f3->B:114:0x02f5, LOOP_END] */
    ...
    /* JADX WARN: Code duplicated, block: B:47:0x0127 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:57:0x014b A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Code duplicated, block: B:76:0x01b2 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:89:0x0221 A[DONT_INVERT] */
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (!zShouldLayout || zShouldLayout2) {
                ...
                if (i5 == 48) {
                    ...
                    if (iMax2 < ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + this.mTitleMarginTop) {
                        iMax2 = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + this.mTitleMarginTop;
                    } else {
                        i14 = (((height - paddingBottom) - measuredHeight) - iMax2) - paddingTop2;
                        if (i14 < ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + this.mTitleMarginBottom) {
                            iMax2 = Math.max(0, iMax2 - ((((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin + this.mTitleMarginBottom) - i14));
                        }
                    }
                ...
                if (z3) {
                    ...
                    if (zShouldLayout2) {
                        ...
                        int i22 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams6).topMargin;
                    ...
                    if (zShouldLayout2) {
                        ...
                        int i25 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams8).topMargin;
                        ...
                        int i26 = ((ViewGroup.MarginLayoutParams) layoutParams8).bottomMargin;
                    } else {
                        i10 = iMax;
                    }
                    if (z2) {
        ...
        if (zShouldLayout) {
            ...
            measuredHeight = ((ViewGroup.MarginLayoutParams) layoutParams9).topMargin + this.mTitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams9).bottomMargin;
        } else {
            measuredHeight = 0;
        }
        if (zShouldLayout2) {
            LayoutParams layoutParams10 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
            measuredHeight += ((ViewGroup.MarginLayoutParams) layoutParams10).topMargin + this.mSubtitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams10).bottomMargin;
        }
        if (zShouldLayout) {
            if (zShouldLayout) {
                textView = this.mTitleTextView;
            ...
            if (z3) {
                ...
                if (zShouldLayout) {
                    ...
                    paddingTop = measuredHeight4 + ((ViewGroup.MarginLayoutParams) layoutParams11).bottomMargin;
                } else {
                    i12 = iMin;
                }
                if (zShouldLayout2) {
                    LayoutParams layoutParams12 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i28 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams12).topMargin;
                    ...
                    i13 = iMin - this.mTitleMarginEnd;
                    int i29 = ((ViewGroup.MarginLayoutParams) layoutParams12).bottomMargin;
                } else {
                    i13 = iMin;
                }
                if (z2) {
                ...
                if (zShouldLayout) {
                    ...
                    paddingTop = measuredHeight5 + ((ViewGroup.MarginLayoutParams) layoutParams13).bottomMargin;
                } else {
                    i9 = iMax;
                }
                if (zShouldLayout2) {
                    LayoutParams layoutParams14 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i211 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams14).topMargin;
                    ...
                    int i212 = ((ViewGroup.MarginLayoutParams) layoutParams14).bottomMargin;
                } else {
                    i10 = iMax;
                }
                if (z2) {
            ...
            if (z3) {
                ...
                if (zShouldLayout) {
                    ...
                    paddingTop = measuredHeight6 + ((ViewGroup.MarginLayoutParams) layoutParams15).bottomMargin;
                } else {
                    i12 = iMin;
                }
                if (zShouldLayout2) {
                    LayoutParams layoutParams16 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i214 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams16).topMargin;
                    ...
                    i13 = iMin - this.mTitleMarginEnd;
                    int i215 = ((ViewGroup.MarginLayoutParams) layoutParams16).bottomMargin;
                } else {
                    i13 = iMin;
                }
                if (z2) {
                ...
                if (zShouldLayout) {
                    ...
                    paddingTop = measuredHeight7 + ((ViewGroup.MarginLayoutParams) layoutParams17).bottomMargin;
                } else {
                    i9 = iMax;
                }
                if (zShouldLayout2) {
                    LayoutParams layoutParams18 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i217 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams18).topMargin;
                    ...
                    int i218 = ((ViewGroup.MarginLayoutParams) layoutParams18).bottomMargin;
                } else {
                    i10 = iMax;
                }
                if (z2) {
