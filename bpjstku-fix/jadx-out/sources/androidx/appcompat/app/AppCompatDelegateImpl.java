...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0035 A[RETURN] */
    @Override // androidx.appcompat.app.AppCompatDelegate
    public boolean hasWindowFeature(int i) {
        ...
        if (iSanitizeWindowFeatureId == 1) {
            ...
            if (iSanitizeWindowFeatureId != 108) {
                ...
                } else if (!this.mWindow.hasFeature(i)) {
                    return false;
                }
                return true;
            }
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & DerHeader.TAG_CLASS_PRIVATE) != (configuration2.screenLayout & DerHeader.TAG_CLASS_PRIVATE)) {
                configuration3.screenLayout |= configuration2.screenLayout & DerHeader.TAG_CLASS_PRIVATE;
            }
