...
public abstract class AppCompatDelegate {
    ...
    static class SerialExecutor implements Executor {
        ...
        /* synthetic */ void m26x45c145d(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
        ...
        if (sIsAutoStoreLocalesOptedIn == null) {
            try {
                ...
                if (((PackageItemInfo) serviceInfo).metaData != null) {
                    sIsAutoStoreLocalesOptedIn = Boolean.valueOf(((PackageItemInfo) serviceInfo).metaData.getBoolean("autoStoreLocales"));
                }
