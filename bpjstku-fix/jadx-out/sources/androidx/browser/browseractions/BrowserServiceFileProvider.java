...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    static class FileCleanupTask extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            ...
            sb.append(BrowserServiceFileProvider.AUTHORITY_SUFFIX);
            ...
            synchronized (BrowserServiceFileProvider.sFileCleanupLock) {
                ...
                long j = IMAGE_RETENTION_DURATION;
                boolean z = true;
                for (File file2 : fileArrListFiles) {
                    if (isImageFile(file2) && file2.lastModified() < jCurrentTimeMillis2 - j && !file2.delete()) {
    ...
    private static Uri generateUri(Context context, String str) {
        StringBuilder sb = new StringBuilder(FILE_SUB_DIR_NAME);
        sb.append(str);
        ...
        sb2.append(AUTHORITY_SUFFIX);
        return builderScheme.authority(sb2.toString()).path(string).build();
    }
        ...
        AsyncTask.THREAD_POOL_EXECUTOR.execute(new Runnable() { // from class: androidx.browser.browseractions.BrowserServiceFileProvider.1
            ...
            public void run() {
                try {
                    ...
                    resolvableFutureCreate.setException(e2);
                }
            }
        });
        return resolvableFutureCreate;
