...
public abstract class PostMessageServiceConnection implements PostMessageBackend, ServiceConnection {
    ...
    private MediaBrowserCompatConnectionCallbackStubApi21 mService;
    private final onConnected mSessionBinder;
    ...
    public PostMessageServiceConnection(CustomTabsSessionToken customTabsSessionToken) {
        ...
        this.mSessionBinder = onConnected.TuitionPaymentFragmentspecialinlinedviewModeldefault2.asInterface(callbackBinder);
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        this.mService = MediaBrowserCompatConnectionCallbackStubApi21.b.asInterface(iBinder);
