...
final class TokenContents {
    ...
    public final String getPackageName() throws IOException {
        parseIfNeeded();
    ...
    public final int getFingerprintCount() throws IOException {
        parseIfNeeded();
    ...
    public final byte[] getFingerprint(int i) throws IOException {
        parseIfNeeded();
        List<byte[]> list = this.mFingerprints;
        if (list == null) {
            throw new IllegalStateException();
