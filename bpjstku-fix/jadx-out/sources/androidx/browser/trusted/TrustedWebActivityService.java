...
public abstract class TrustedWebActivityService extends Service {
    ...
    int mVerifiedUid = -1;
    private final onError.TuitionPaymentFragmentspecialinlinedviewModeldefault1 mBinder = new onError.TuitionPaymentFragmentspecialinlinedviewModeldefault1() { // from class: androidx.browser.trusted.TrustedWebActivityService.1
    ...
    public int onGetSmallIconId() {
        try {
            ...
            return ((PackageItemInfo) serviceInfo).metaData.getInt(META_DATA_NAME_SMALL_ICON, -1);
