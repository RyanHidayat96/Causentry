...
public final class TrustedWebActivityServiceConnection {
    ...
    private final onError mService;

    TrustedWebActivityServiceConnection(onError onerror, ComponentName componentName) {
    ...
    public final Bundle sendExtraCommand(String str, Bundle bundle, TrustedWebActivityCallback trustedWebActivityCallback) throws RemoteException {
        MediaBrowserCompatCustomActionCallback mediaBrowserCompatCustomActionCallbackWrapCallback = wrapCallback(trustedWebActivityCallback);
        return this.mService.extraCommand(str, bundle, mediaBrowserCompatCustomActionCallbackWrapCallback == null ? null : mediaBrowserCompatCustomActionCallbackWrapCallback.asBinder());
    }
    ...
    private static MediaBrowserCompatCustomActionCallback wrapCallback(final TrustedWebActivityCallback trustedWebActivityCallback) {
        if (trustedWebActivityCallback == null) {
            return null;
        }
        return new MediaBrowserCompatCustomActionCallback.TuitionPaymentFragmentspecialinlinedviewModeldefault3() { // from class: androidx.browser.trusted.TrustedWebActivityServiceConnection.1
