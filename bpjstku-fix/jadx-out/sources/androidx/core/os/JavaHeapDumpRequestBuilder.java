...
public final class JavaHeapDumpRequestBuilder extends ProfilingRequestBuilder<JavaHeapDumpRequestBuilder> {
    ...
    @Override // androidx.core.os.ProfilingRequestBuilder
    public final JavaHeapDumpRequestBuilder getThis() {
        return this;
    }
    ...
    public final JavaHeapDumpRequestBuilder setBufferSizeKb(int p0) {
