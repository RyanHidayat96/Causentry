...
public class FileProvider extends ContentProvider {
    ...
    static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, ProviderInfo providerInfo, int i) {
        ...
        if (((PackageItemInfo) providerInfo).metaData == null && i != 0) {
            ...
            ((PackageItemInfo) providerInfo).metaData.putInt(META_DATA_FILE_PROVIDER_PATHS, i);
        }
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(this.mAuthority).encodedPath(sb.toString()).build();
