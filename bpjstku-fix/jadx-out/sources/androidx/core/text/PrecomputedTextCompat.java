...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public final int hashCode() {
            ...
            boolean zIsElegantTextHeight = this.mPaint.isElegantTextHeight();
            return ObjectsCompat.hash(Float.valueOf(textSize), Float.valueOf(textScaleX), Float.valueOf(textSkewX), Float.valueOf(letterSpacing), Integer.valueOf(flags), textLocales, typeface, Boolean.valueOf(zIsElegantTextHeight), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency));
        }
