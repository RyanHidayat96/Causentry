...
public final class NotificationManagerCompat {
    ...
    public final void notify(List<NotificationWithIdAndTag> list) {
        int size = list.size();
    ...
    public final void createNotificationChannel(NotificationChannelCompat notificationChannelCompat) {
    ...
    public final void createNotificationChannelGroup(NotificationChannelGroupCompat notificationChannelGroupCompat) {
    ...
    public final void createNotificationChannelsCompat(List<NotificationChannelCompat> list) {
    ...
    public final void createNotificationChannelGroupsCompat(List<NotificationChannelGroupCompat> list) {
        if (Build.VERSION.SDK_INT < 26 || list.isEmpty()) {
            return;
        }
        ArrayList arrayList = new ArrayList(list.size());
    ...
    public final NotificationChannelCompat getNotificationChannelCompat(String str) {
    ...
    public final NotificationChannelCompat getNotificationChannelCompat(String str, String str2) {
        NotificationChannel notificationChannel;
    ...
    public final NotificationChannelGroupCompat getNotificationChannelGroupCompat(String str) {
    ...
    public final List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public final List<NotificationChannelGroupCompat> getNotificationChannelGroupsCompat() {
    ...
    static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f320id, this.tag, this.notif);
        }
