...
public class AppComponentFactory extends android.app.AppComponentFactory {
    ...
    public final Application instantiateApplication(ClassLoader classLoader, String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        return computeCropRectFromAspectRatio.TuitionPaymentFragmentspecialinlinedviewModeldefault3() ? super.instantiateApplication(classLoader, str) : (Application) CoreComponentFactory.checkCompatWrapper(instantiateApplicationCompat(classLoader, str));
    }
    ...
    public final Service instantiateService(ClassLoader classLoader, String str, Intent intent) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        return computeCropRectFromAspectRatio.TuitionPaymentFragmentspecialinlinedviewModeldefault3() ? super.instantiateService(classLoader, str, intent) : (Service) CoreComponentFactory.checkCompatWrapper(instantiateServiceCompat(classLoader, str, intent));
    }
