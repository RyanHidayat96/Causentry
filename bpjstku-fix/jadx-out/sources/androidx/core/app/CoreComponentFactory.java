...
public class CoreComponentFactory extends android.app.AppComponentFactory {
    ...
    public Application instantiateApplication(ClassLoader classLoader, String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        return computeCropRectFromAspectRatio.TuitionPaymentFragmentspecialinlinedviewModeldefault3() ? super.instantiateApplication(classLoader, str) : (Application) checkCompatWrapper(super.instantiateApplication(classLoader, str));
    }
    ...
    public Service instantiateService(ClassLoader classLoader, String str, Intent intent) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        return computeCropRectFromAspectRatio.TuitionPaymentFragmentspecialinlinedviewModeldefault3() ? super.instantiateService(classLoader, str, intent) : (Service) checkCompatWrapper(super.instantiateService(classLoader, str, intent));
    }
