...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (measuredHeight < measuredHeight2) {
            ...
            childAt.measure(getChildMeasureSpec(i, paddingLeft + paddingRight + i3 + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, ((ViewGroup.LayoutParams) layoutParams).width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, BasicMeasure.EXACTLY));
        }
    }
    ...
    int scrollBy(int i, int i2, MotionEvent motionEvent, int i3, int i4, boolean z) {
        ...
        boolean z3 = overScrollByCompat(0, i5, 0, scrollY, 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(i4);
        int scrollY2 = getScrollY() - scrollY;
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (((double) (this.mPhysicalCoeff * SCROLL_FRICTION)) * Math.exp((d / (d - 1.0d)) * dLog));
    }
    ...
    public boolean fullScroll(int i) {
        ...
        if (z && (childCount = getChildCount()) > 0) {
            View childAt = getChildAt(childCount - 1);
            this.mTempRect.bottom = childAt.getBottom() + ((ViewGroup.MarginLayoutParams) ((FrameLayout.LayoutParams) childAt.getLayoutParams())).bottomMargin + getPaddingBottom();
            Rect rect = this.mTempRect;
    ...
    public boolean arrowScroll(int i) {
        ...
        if (viewFindNextFocus != null && isWithinDeltaOfScreen(viewFindNextFocus, maxScrollAmount, getHeight())) {
            ...
            if (i == 33 && getScrollY() < maxScrollAmount) {
                ...
                View childAt = getChildAt(0);
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
                maxScrollAmount = Math.min((childAt.getBottom() + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin) - ((getScrollY() + getHeight()) - getPaddingBottom()), maxScrollAmount);
            }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            int iMin = Math.min(nestedScrollView.getScrollY() + ((height - paddingBottom2) - paddingTop), nestedScrollView.getScrollRange());
