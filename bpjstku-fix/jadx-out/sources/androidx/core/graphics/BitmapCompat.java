...
public final class BitmapCompat {
    ...
    public static Bitmap createScaledBitmap(Bitmap bitmap, int i, int i2, Rect rect, boolean z) {
        ...
        if (!z || Build.VERSION.SDK_INT < 27 || Api27Impl.isAlreadyF16AndLinear(bitmap)) {
            ...
            bitmapCopyBitmapIfHardware = null;
        } else {
            bitmapCreateBitmapWithSourceColorspace = Api27Impl.createBitmapWithSourceColorspace(i7 > 0 ? sizeAtStep(iWidth, i, 1, i7) : iWidth, i8 > 0 ? sizeAtStep(iHeight, i2, 1, i8) : iHeight, bitmap, true);
        ...
        while (true) {
            ...
            boolean z3 = bitmapCopyBitmapIfHardware != null && bitmapCopyBitmapIfHardware.getWidth() == i && bitmapCopyBitmapIfHardware.getHeight() == i2;
            if (bitmapCopyBitmapIfHardware == null || bitmapCopyBitmapIfHardware == bitmap) {
                rect2 = rect4;
            } else {
                if (z) {
                    rect2 = rect4;
                    if (Build.VERSION.SDK_INT < 27 || Api27Impl.isAlreadyF16AndLinear(bitmapCopyBitmapIfHardware)) {
                    }
                    Rect rect6 = rect2;
                    new Canvas(bitmapCopyBitmapIfHardware).drawBitmap(bitmapCreateBitmapWithSourceColorspace, rect5, rect6, paint2);
                    rect5.set(rect6);
                    i10 = i11;
                    rect4 = rect6;
                    rect3 = rect5;
                ...
                Rect rect7 = rect2;
                new Canvas(bitmapCopyBitmapIfHardware).drawBitmap(bitmapCreateBitmapWithSourceColorspace, rect5, rect7, paint2);
                rect5.set(rect7);
                i10 = i11;
                rect4 = rect7;
                rect3 = rect5;
                paint = paint2;
                Bitmap bitmap3 = bitmapCreateBitmapWithSourceColorspace;
                bitmapCreateBitmapWithSourceColorspace = bitmapCopyBitmapIfHardware;
                bitmapCopyBitmapIfHardware = bitmap3;
            }
            if (bitmapCopyBitmapIfHardware != bitmap && bitmapCopyBitmapIfHardware != null) {
                bitmapCopyBitmapIfHardware.recycle();
            }
            int iSizeAtStep = sizeAtStep(iWidth, i, i9 > 0 ? i4 : i9, i7);
            int iSizeAtStep2 = sizeAtStep(iHeight, i2, i11 > 0 ? i4 : i11, i8);
            if (Build.VERSION.SDK_INT >= 27) {
                bitmapCopyBitmapIfHardware = Api27Impl.createBitmapWithSourceColorspace(iSizeAtStep, iSizeAtStep2, bitmap, z && !z2);
            } else {
                bitmapCopyBitmapIfHardware = Bitmap.createBitmap(iSizeAtStep, iSizeAtStep2, bitmapCreateBitmapWithSourceColorspace.getConfig());
            }
            Rect rect8 = rect2;
            new Canvas(bitmapCopyBitmapIfHardware).drawBitmap(bitmapCreateBitmapWithSourceColorspace, rect5, rect8, paint2);
            rect5.set(rect8);
            i10 = i11;
            rect4 = rect8;
            rect3 = rect5;
            paint = paint2;
            Bitmap bitmap4 = bitmapCreateBitmapWithSourceColorspace;
            bitmapCreateBitmapWithSourceColorspace = bitmapCopyBitmapIfHardware;
            bitmapCopyBitmapIfHardware = bitmap4;
        }
        if (bitmapCopyBitmapIfHardware != bitmap && bitmapCopyBitmapIfHardware != null) {
            bitmapCopyBitmapIfHardware.recycle();
        }
