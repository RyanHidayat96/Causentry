    ...
    static ProviderInfo getProvider(PackageManager packageManager, FontRequest fontRequest, Resources resources) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            if (providerInfo == null) {
                ...
                if (!((PackageItemInfo) providerInfoResolveContentProvider).packageName.equals(fontRequest.getProviderPackage())) {
                ...
                List<byte[]> listConvertToByteArrayList = convertToByteArrayList(packageManager.getPackageInfo(((PackageItemInfo) providerInfoResolveContentProvider).packageName, 64).signatures);
                    ...
                    try {
                        ...
                        if (cursorQuery == null || cursorQuery.getCount() <= 0) {
                            ...
                            while (cursorQuery.moveToNext()) {
                                ...
                                arrayList3.add(new FontsContractCompat.FontInfo(uriWithAppendedId, i2, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : 400, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, fontRequest.getVariationSettings(), i));
                            }
