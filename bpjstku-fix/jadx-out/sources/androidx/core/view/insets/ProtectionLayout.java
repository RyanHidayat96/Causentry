    ...
    private void addProtectionView(Context context, int i, Protection protection) {
        ...
        if (side == 1) {
            ...
            if (side == 2) {
                ...
                StringBuilder sb = new StringBuilder("Unexpected side: ");
            ...
            ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin = margin.left;
            ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = margin.top;
            ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin = margin.right;
            ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin = margin.bottom;
            ...
            attributes.setCallback(new Protection.Attributes.Callback() { // from class: androidx.core.view.insets.ProtectionLayout.1
                ...
                public void onMarginChanged(Insets insets) {
                    ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin = insets.left;
                    ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = insets.top;
                    ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin = insets.right;
        ...
        ((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin = margin2.left;
        ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = margin2.top;
        ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin = margin2.right;
        ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin = margin2.bottom;
