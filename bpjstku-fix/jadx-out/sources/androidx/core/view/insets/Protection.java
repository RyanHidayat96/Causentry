...
public abstract class Protection {
    ...
    public Protection(int i) {
        if (i != 1 && i != 2 && i != 4 && i != 8) {
            throw new IllegalArgumentException("Unexpected side: ".concat(String.valueOf(i)));
        }
        this.mSide = i;
    }
    ...
    public void setAlpha(float f) {
        if (f < 0.0f || f > 1.0f) {
            throw new IllegalArgumentException("Alpha must in a range of [0, 1]. Got: ".concat(String.valueOf(f)));
        }
    ...
    public void animateAlpha(float f) {
        ...
        this.mUserAlphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.insets.Protection$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7227lambda$animateAlpha$0$androidxcoreviewinsetsProtection(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m7227lambda$animateAlpha$0$androidxcoreviewinsetsProtection(ValueAnimator valueAnimator) {
    ...
    public void setInsetAmount(float f) {
        if (f < 0.0f || f > 1.0f) {
            throw new IllegalArgumentException("Inset amount must in a range of [0, 1]. Got: ".concat(String.valueOf(f)));
        }
    ...
    public void animateInsetsAmount(float f) {
        ...
        this.mUserInsetAmountAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.insets.Protection$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7228x124db077(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m7228x124db077(ValueAnimator valueAnimator) {
        setAlphaInternal(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
