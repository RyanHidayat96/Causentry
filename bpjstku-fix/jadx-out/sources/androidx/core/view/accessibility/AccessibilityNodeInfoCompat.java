...
public class AccessibilityNodeInfoCompat {
    ...
    public static class CollectionInfoCompat {
        ...
        public static final class Builder {
            ...
            public final Builder setHierarchical(boolean z) {
                this.mHierarchical = z;
                return this;
            }

            public final Builder setSelectionMode(int i) {
                this.mSelectionMode = i;
                return this;
            }

            public final Builder setItemCount(int i) {
                this.mItemCount = i;
                return this;
            }

            public final Builder setImportantForAccessibilityItemCount(int i) {
                this.mImportantForAccessibilityItemCount = i;
                return this;
            }

            public final CollectionInfoCompat build() {
                if (Build.VERSION.SDK_INT >= 35) {
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static final class Builder {
            ...
            public final Builder setHeading(boolean z) {
                this.mHeading = z;
                return this;
            }

            public final Builder setColumnIndex(int i) {
                this.mColumnIndex = i;
                return this;
            }

            public final Builder setRowIndex(int i) {
                this.mRowIndex = i;
                return this;
            }

            public final Builder setColumnSpan(int i) {
                this.mColumnSpan = i;
                return this;
            }

            public final Builder setRowSpan(int i) {
                this.mRowSpan = i;
                return this;
            }
            ...
            public final Builder setRowTitle(String str) {
                this.mRowTitle = str;
                return this;
            }

            public final Builder setColumnTitle(String str) {
                this.mColumnTitle = str;
                return this;
            }

            public final Builder setSortDirection(int i) {
                this.mSortDirection = i;
                return this;
            }

            public final CollectionItemInfoCompat build() {
                if (BuildCompat.isAtLeastB_1()) {
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public final AccessibilityNodeInfoCompat getTargetForRegion(Region region) {
    ...
    public static final class SelectionCompat {
        ...
        public final SelectionPositionCompat getStart() {
            if (BuildCompat.isAtLeastB_1()) {
        ...
        public final SelectionPositionCompat getEnd() {
            if (BuildCompat.isAtLeastB_1()) {
    ...
    public void setChecked(int i) {
        ...
        throw new IllegalArgumentException("Unknown checked argument: ".concat(String.valueOf(i)));
    }
