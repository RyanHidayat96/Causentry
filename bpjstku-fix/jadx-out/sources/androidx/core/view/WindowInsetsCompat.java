...
public class WindowInsetsCompat {
    ...
    static class Impl {
        ...
        public int hashCode() {
            ...
            return ObjectsCompat.hash(Boolean.valueOf(zIsRound), Boolean.valueOf(zIsConsumed), getSystemWindowInsets(), getStableInsets(), getDisplayCutout());
        }
    }
    ...
    static class Impl34 extends Impl31 {
        static final WindowInsetsCompat CONSUMED = WindowInsetsCompat.toWindowInsetsCompat(WindowInsets.CONSUMED);
    ...
    static class Impl35 extends Impl34 {
        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        void initTypeBoundingRectsMaps() {
        }
    ...
    public static final class Builder {
        ...
        public final Builder setRoundedCorner(int i, RoundedCornerCompat roundedCornerCompat) {
            this.mImpl.setRoundedCorner(i, roundedCornerCompat);
            return this;
        }

        public final Builder setPrivacyIndicatorBounds(Rect rect) {
            this.mImpl.setPrivacyIndicatorBounds(rect);
            return this;
        }

        public final Builder setBoundingRects(int i, List<Rect> list) {
            this.mImpl.setBoundingRects(i, list);
            return this;
        }

        public final Builder setBoundingRectsIgnoringVisibility(int i, List<Rect> list) {
            this.mImpl.setBoundingRectsIgnoringVisibility(i, list);
            return this;
        }

        public final Builder setDisplayShape(DisplayShapeCompat displayShapeCompat) {
    ...
    static class BuilderImpl31 extends BuilderImpl30 {
        BuilderImpl31() {
        }
    ...
    static class BuilderImpl34 extends BuilderImpl31 {
        BuilderImpl34() {
        }
    ...
    static class BuilderImpl35 extends BuilderImpl34 {
    ...
    static class BuilderImpl36 extends BuilderImpl35 {
        BuilderImpl36() {
        }
