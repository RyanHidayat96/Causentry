...
public final class LongObjectMapKt {
    ...
    public static final <V> LongObjectMap<V> emptyLongObjectMap() {
        ...
        Intrinsics.checkNotNull(mutableLongObjectMap, "");
