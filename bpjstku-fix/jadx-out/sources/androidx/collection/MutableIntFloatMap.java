...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final float getOrPut(int p0, Function0<Float> p1) {
    ...
    public final void set(int p0, float p1) {
    ...
    public final void put(int p0, float p1) {
        set(p0, p1);
    }

    public final float put(int p0, float p1, float p2) {
        int iFindInsertIndex = findInsertIndex(p0);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final void plusAssign(IntFloatMap p0) {
    ...
    public final boolean remove(int p0, float p1) {
        int iFindKeyIndex = findKeyIndex(p0);
    ...
    public final void removeIf(Function2<? super Integer, ? super Float, Boolean> p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (p0.invoke(Integer.valueOf(this.keys[i4]), Float.valueOf(this.values[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void putAll(IntFloatMap p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        int[] iArr = p0.keys;
