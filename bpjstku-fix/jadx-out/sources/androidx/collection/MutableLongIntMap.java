...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final int getOrPut(long p0, Function0<Integer> p1) {
    ...
    public final void set(long p0, int p1) {
    ...
    public final void put(long p0, int p1) {
        set(p0, p1);
    }

    public final int put(long p0, int p1, int p2) {
        int iFindInsertIndex = findInsertIndex(p0);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final void plusAssign(LongIntMap p0) {
    ...
    public final boolean remove(long p0, int p1) {
        int iFindKeyIndex = findKeyIndex(p0);
    ...
    public final void removeIf(Function2<? super Long, ? super Integer, Boolean> p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (p0.invoke(Long.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void putAll(LongIntMap p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        long[] jArr = p0.keys;
        int[] iArr = p0.values;
