...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public final float getOrPut(float p0, Function0<Float> p1) {
    ...
    public final void put(float p0, float p1) {
        set(p0, p1);
    }

    public final float put(float p0, float p1, float p2) {
        int iFindInsertIndex = findInsertIndex(p0);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final void plusAssign(FloatFloatMap p0) {
    ...
    public final boolean remove(float p0, float p1) {
        int iFindKeyIndex = findKeyIndex(p0);
    ...
    public final void removeIf(Function2<? super Float, ? super Float, Boolean> p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (p0.invoke(Float.valueOf(this.keys[i4]), Float.valueOf(this.values[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
            ...
            if (j3 != 128 && j3 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i10) & i2) / 8 == ((i5 - i10) & i2) / 8) {
                    ...
                    if (((j4 >> i12) & 255) == 128) {
                        ...
                        fArr[i13] = 0.0f;
                        fArr2[iFindFirstAvailableSlot] = fArr2[i13];
                        fArr2[i13] = 0.0f;
                        i = i13;
                    } else {
                        int i14 = i5;
                        ...
                        fArr2[iFindFirstAvailableSlot] = fArr2[i14];
                        fArr2[i14] = f2;
                        i = i14 - 1;
                    }
                    c = 0;
    ...
    public final void putAll(FloatFloatMap p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        float[] fArr = p0.keys;
        float[] fArr2 = p0.values;
