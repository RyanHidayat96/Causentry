...
public final class FlowExtKt {
    public static final <T> State<T> collectAsStateWithLifecycle(stopMediaCodec<? extends T> stopmediacodec, LifecycleOwner lifecycleOwner, Lifecycle.State state, CoroutineContext coroutineContext, Composer composer, int i, int i2) {
        if ((i2 & 1) != 0) {
        ...
        int i3 = i << 3;
        State<T> stateCollectAsStateWithLifecycle = collectAsStateWithLifecycle(stopmediacodec, stopmediacodec.TuitionPaymentFragmentspecialinlinedviewModeldefault1(), lifecycleOwner.getLifecycle(), state2, coroutineContext2, composer, (i & 14) | (i3 & 7168) | (i3 & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final <T> State<T> collectAsStateWithLifecycle(stopMediaCodec<? extends T> stopmediacodec, Lifecycle lifecycle, Lifecycle.State state, CoroutineContext coroutineContext, Composer composer, int i, int i2) {
        if ((i2 & 2) != 0) {
            state = Lifecycle.State.STARTED;
        }
        Lifecycle.State state2 = state;
        ...
        stopMediaCodec<? extends T> stopmediacodec2 = stopmediacodec;
        T tTuitionPaymentFragmentspecialinlinedviewModeldefault1 = stopmediacodec.TuitionPaymentFragmentspecialinlinedviewModeldefault1();
        int i3 = i << 3;
        State<T> stateCollectAsStateWithLifecycle = collectAsStateWithLifecycle(stopmediacodec2, tTuitionPaymentFragmentspecialinlinedviewModeldefault1, lifecycle, state2, coroutineContext2, composer, (i & 14) | (i3 & 896) | (i3 & 7168) | (i3 & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return stateCollectAsStateWithLifecycle;
    ...
    public static final <T> State<T> collectAsStateWithLifecycle(clampVideoBitrateIfNotSupported<? extends T> clampvideobitrateifnotsupported, T t, LifecycleOwner lifecycleOwner, Lifecycle.State state, CoroutineContext coroutineContext, Composer composer, int i, int i2) {
        if ((i2 & 2) != 0) {
            lifecycleOwner = (LifecycleOwner) composer.consume(LocalLifecycleOwnerKt.getLocalLifecycleOwner());
        }
        if ((i2 & 4) != 0) {
        ...
        State<T> stateCollectAsStateWithLifecycle = collectAsStateWithLifecycle(clampvideobitrateifnotsupported, t, lifecycleOwner.getLifecycle(), state2, coroutineContext2, composer, (i & 14) | (((i >> 3) & 8) << 3) | (i & 112) | (i & 7168) | (57344 & i), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return stateCollectAsStateWithLifecycle;
    ...
    public static final <T> State<T> collectAsStateWithLifecycle(clampVideoBitrateIfNotSupported<? extends T> clampvideobitrateifnotsupported, T t, Lifecycle lifecycle, Lifecycle.State state, CoroutineContext coroutineContext, Composer composer, int i, int i2) {
        if ((i2 & 4) != 0) {
            state = Lifecycle.State.STARTED;
        }
        Lifecycle.State state2 = state;
        ...
        Object[] objArr = {clampvideobitrateifnotsupported, lifecycle, state2, coroutineContext2};
        ...
        boolean zChangedInstance3 = composer.changedInstance(clampvideobitrateifnotsupported);
        ...
        if ((zChangedInstance | z | zChangedInstance2 | zChangedInstance3) || flowExtKt$collectAsStateWithLifecycle$1$1RememberedValue == Composer.INSTANCE.getEmpty()) {
            flowExtKt$collectAsStateWithLifecycle$1$1RememberedValue = new FlowExtKt$collectAsStateWithLifecycle$1$1(lifecycle, state2, coroutineContext2, clampvideobitrateifnotsupported, null);
