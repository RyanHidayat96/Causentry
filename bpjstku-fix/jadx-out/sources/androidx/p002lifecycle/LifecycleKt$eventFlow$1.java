...
final class LifecycleKt$eventFlow$1 extends SuspendLambda implements Function2<onEncodePaused<? super Lifecycle.Event>, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            final LifecycleEventObserver lifecycleEventObserver = new LifecycleEventObserver() { // from class: androidx.lifecycle.LifecycleKt$eventFlow$1$$ExternalSyntheticLambda0
                ...
                public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                    LifecycleKt$eventFlow$1.invokeSuspend$lambda$0(onencodepaused, lifecycleOwner, event);
                }
            };
            this.$this_eventFlow.addObserver(lifecycleEventObserver);
            final Lifecycle lifecycle = this.$this_eventFlow;
            this.label = 1;
            if (setEncoderCallback.TuitionPaymentFragmentspecialinlinedviewModeldefault2(onencodepaused, new Function0() { // from class: androidx.lifecycle.LifecycleKt$eventFlow$1$$ExternalSyntheticLambda1
    ...
    public static final void invokeSuspend$lambda$0(onEncodePaused onencodepaused, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        onencodepaused.TuitionPaymentFragmentspecialinlinedviewModeldefault3(event);
    ...
    public final Object invoke(onEncodePaused<? super Lifecycle.Event> onencodepaused, Continuation<? super Unit> continuation) {
        return ((LifecycleKt$eventFlow$1) create(onencodepaused, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
