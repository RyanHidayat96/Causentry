...
public final class DefaultLifecycleObserverAdapter implements LifecycleEventObserver {
    ...
    public DefaultLifecycleObserverAdapter(DefaultLifecycleObserver defaultLifecycleObserver, LifecycleEventObserver lifecycleEventObserver) {
        Intrinsics.checkNotNullParameter(defaultLifecycleObserver, "");
    ...
    public final void onStateChanged(LifecycleOwner p0, Lifecycle.Event p1) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[p1.ordinal()]) {
            case 1:
                this.defaultLifecycleObserver.onCreate(p0);
                break;
            case 2:
                this.defaultLifecycleObserver.onStart(p0);
                break;
            case 3:
                this.defaultLifecycleObserver.onResume(p0);
                break;
            case 4:
                this.defaultLifecycleObserver.onPause(p0);
                break;
            case 5:
                this.defaultLifecycleObserver.onStop(p0);
                break;
            case 6:
                this.defaultLifecycleObserver.onDestroy(p0);
                break;
            case 7:
