...
public final class PausingDispatcherKt {
    ...
    static final class AnonymousClass2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            ResultKt.throwOnFailure(obj);
            VideoMimeInfoBuilder videoMimeInfoBuilder = (VideoMimeInfoBuilder) ((CoroutineScope) this.L$0).getCoroutineContext().get(VideoMimeInfoBuilder.b);
            if (videoMimeInfoBuilder == null) {
                throw new IllegalStateException("when[State] methods should have a parent job".toString());
            }
            PausingDispatcher pausingDispatcher = new PausingDispatcher();
            LifecycleController lifecycleController2 = new LifecycleController(this.$this_whenStateAtLeast, this.$minState, pausingDispatcher.dispatchQueue, videoMimeInfoBuilder);
            try {
                this.L$0 = lifecycleController2;
                this.label = 1;
                obj = BuildersKt.TuitionPaymentFragmentbindingInflater1(pausingDispatcher, this.$block, this);
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.TuitionPaymentFragmentbindingInflater1(Dispatchers.TuitionPaymentFragmentbindingInflater1().TuitionPaymentFragmentspecialinlinedviewModeldefault2(), new AnonymousClass2(lifecycle, state, function2, null), continuation);
    }
}
