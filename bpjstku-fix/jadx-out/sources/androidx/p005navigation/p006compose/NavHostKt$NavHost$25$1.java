...
final class NavHostKt$NavHost$25$1 extends SuspendLambda implements Function2<clampVideoBitrateIfNotSupported<? extends BackEventCompat>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                clampVideoBitrateIfNotSupported clampvideobitrateifnotsupported = (clampVideoBitrateIfNotSupported) this.L$0;
                ...
                this.label = 1;
                if (clampvideobitrateifnotsupported.collect(new addSignalEosTimeoutIfNeeded() { // from class: androidx.navigation.compose.NavHostKt$NavHost$25$1.1
    ...
    public final /* bridge */ /* synthetic */ Object invoke(clampVideoBitrateIfNotSupported<? extends BackEventCompat> clampvideobitrateifnotsupported, Continuation<? super Unit> continuation) {
        return invoke2((clampVideoBitrateIfNotSupported<BackEventCompat>) clampvideobitrateifnotsupported, continuation);
    }

    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
    public final Object invoke2(clampVideoBitrateIfNotSupported<BackEventCompat> clampvideobitrateifnotsupported, Continuation<? super Unit> continuation) {
        return ((NavHostKt$NavHost$25$1) create(clampvideobitrateifnotsupported, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
