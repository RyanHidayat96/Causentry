    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            for (NavBackStackEntry navBackStackEntry : setDialogHost$lambda$1) {
                if (!dialogNavigator.getBackStack$navigation_compose_release().TuitionPaymentFragmentspecialinlinedviewModeldefault1().contains(navBackStackEntry) && !snapshotStateList.contains(navBackStackEntry)) {
