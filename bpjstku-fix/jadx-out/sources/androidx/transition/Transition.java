...
public abstract class Transition implements Cloneable {
    ...
    /* JADX WARN: Code duplicated, block: B:72:0x013a A[SYNTHETIC] */
    void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
            ...
            if (!(transitionValues2 == null && transitionValues3 == null) && ((transitionValues2 == null || transitionValues3 == null || isTransitionRequired(transitionValues2, transitionValues3)) && (animatorCreateAnimator = createAnimator(viewGroup, transitionValues2, transitionValues3)) != null)) {
                if (transitionValues3 != null) {
                    ...
                    if (animator2 == null) {
                        ...
                        long j = jMin;
                        AnimationInfo animationInfo2 = new AnimationInfo(view, getName(), this, viewGroup.getWindowId(), transitionValues, animator2);
                        animator3 = animator2;
                        if (z) {
                ...
                if (animator2 == null) {
                    transitionPropagation = this.mPropagation;
                    if (transitionPropagation != null) {
                        long startDelay2 = transitionPropagation.getStartDelay(viewGroup, this, transitionValues2, transitionValues3);
                        sparseIntArray.put(this.mAnimators.size(), (int) startDelay2);
                        jMin = Math.min(startDelay2, jMin);
                    }
                    long j2 = jMin;
                    AnimationInfo animationInfo3 = new AnimationInfo(view, getName(), this, viewGroup.getWindowId(), transitionValues, animator2);
                    animator3 = animator2;
                    if (z) {
                    ...
                    runningAnimators.put(animator3, animationInfo3);
                    this.mAnimators.add(animator3);
                    jMin = j2;
                }
            } else {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i4 = 0; i4 < sparseIntArray.size(); i4++) {
                AnimationInfo animationInfo4 = runningAnimators.get(this.mAnimators.get(sparseIntArray.keyAt(i4)));
                animationInfo4.mAnimator.setStartDelay((((long) sparseIntArray.valueAt(i4)) - jMin) + animationInfo4.mAnimator.getStartDelay());
            }
        }
    }
        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.Transition$SeekController$$ExternalSyntheticLambda0
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    this.f$0.m7500x76b2d240(dynamicAnimation, z, f, f2);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$ensureAnimation$0$androidx-transition-Transition$SeekController, reason: not valid java name */
        /* synthetic */ void m7500x76b2d240(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
            if (z) {
                return;
            }
            if (f < 1.0f) {
