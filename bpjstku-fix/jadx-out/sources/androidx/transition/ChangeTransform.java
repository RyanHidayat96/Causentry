...
public class ChangeTransform extends Transition {
    ...
    static class Transforms {
        ...
        public int hashCode() {
            ...
            return (((((((((((((iFloatToIntBits * 31) + iFloatToIntBits2) * 31) + iFloatToIntBits3) * 31) + iFloatToIntBits4) * 31) + iFloatToIntBits5) * 31) + iFloatToIntBits6) * 31) + iFloatToIntBits7) * 31) + (f8 != 0.0f ? Float.floatToIntBits(f8) : 0);
        }
    }
