...
public class TransitionSet extends Transition {
    ...
    public /* bridge */ /* synthetic */ Object mo7499clone() throws CloneNotSupportedException {
        return mo7499clone();
    }
    ...
    public Transition mo7499clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo7499clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo7499clone());
        }
