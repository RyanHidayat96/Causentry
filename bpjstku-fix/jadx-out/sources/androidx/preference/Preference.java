...
public class Preference implements Comparable<Preference> {
    ...
    public final boolean isShown() {
        PreferenceScreen parent = this;
        while (parent.isVisible() && parent.getPreferenceManager() != null) {
            if (parent == parent.getPreferenceManager().getPreferenceScreen()) {
                return true;
            }
    ...
    static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault2(menuItem);
            try {
                ...
                ViewPortBuilder.TuitionPaymentFragmentspecialinlinedviewModeldefault2();
            }
        }
    }
}
