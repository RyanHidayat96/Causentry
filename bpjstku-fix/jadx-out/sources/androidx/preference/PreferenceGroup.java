...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            ...
            setInitialExpandedChildrenCount(TypedArrayUtils.getInt(typedArrayObtainStyledAttributes, i3, i3, Integer.MAX_VALUE));
        }
    ...
    public boolean addPreference(Preference preference) {
        ...
        if (preference.getKey() != null) {
            ...
            parent.findPreference(preference.getKey());
        }
