    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null) {
            ...
            if (ACTION_INSTALL_PROFILE.equals(action)) {
                ProfileInstaller.writeProfile(context, new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), new ResultDiagnostics(), true);
                return;
            }
            if (ACTION_SKIP_FILE.equals(action)) {
                ...
                if (extras2 != null) {
                    ...
                    if (EXTRA_SKIP_FILE_OPERATION_WRITE.equals(string)) {
                        ProfileInstaller.writeSkipFile(context, new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), new ResultDiagnostics());
                        return;
                    } else {
                        if (EXTRA_SKIP_FILE_OPERATION_DELETE.equals(string)) {
                            ProfileInstaller.deleteSkipFile(context, new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), new ResultDiagnostics());
                            return;
                        }
                        return;
                    }
