...
public final class MetadataList extends Table {
    ...
    public final MetadataList __assign(int i, ByteBuffer byteBuffer) {
        __init(i, byteBuffer);
        return this;
    }
    ...
    public final MetadataItem list(int i) {
        return list(new MetadataItem(), i);
    }

    public final MetadataItem list(MetadataItem metadataItem, int i) {
    ...
    public final MetadataItem.Vector listVector() {
        return listVector(new MetadataItem.Vector());
    }

    public final MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
    ...
    public static final class Vector extends BaseVector {
        ...
        public final MetadataList get(int i) {
            return get(new MetadataList(), i);
        }

        public final MetadataList get(MetadataList metadataList, int i) {
