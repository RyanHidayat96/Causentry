...
public class EmojiCompat {
    ...
    static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        final boolean hasEmojiGlyph(CharSequence charSequence) {
            return this.mProcessor.getEmojiMatch(charSequence) == 1;
        }

        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        final boolean hasEmojiGlyph(CharSequence charSequence, int i) {
            return this.mProcessor.getEmojiMatch(charSequence, i) == 1;
        }

        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public final int getEmojiMatch(CharSequence charSequence, int i) {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        final CharSequence process(CharSequence charSequence, int i, int i2, int i3, boolean z) {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        final String getAssetSignature() {
