        ...
        ThreadUtil.MainThreadCallback<T> mainThreadCallback = new ThreadUtil.MainThreadCallback<T>() { // from class: androidx.recyclerview.widget.AsyncListUtil.1
            ...
            public void addTile(int i2, TileList.Tile<T> tile) {
                ...
                if (tileAddOrReplace != null) {
                    int i3 = tileAddOrReplace.mStartPosition;
                ...
                while (i6 < AsyncListUtil.this.mMissingPositions.size()) {
                    int iKeyAt = AsyncListUtil.this.mMissingPositions.keyAt(i6);
                    if (tile.mStartPosition > iKeyAt || iKeyAt >= i4 + i5) {
                        i6++;
                    } else {
            ...
            public void removeTile(int i2, int i3) {
                ...
                if (isRequestedGeneration(i2) && (tileRemoveAtPos = AsyncListUtil.this.mTileList.removeAtPos(i3)) != null) {
