...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i, int i2, boolean z) {
        ...
        int iUpdateSpecWithExtra = updateSpecWithExtra(i, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + this.mTmpRect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + this.mTmpRect.right);
        int iUpdateSpecWithExtra2 = updateSpecWithExtra(i2, ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + this.mTmpRect.top, ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + this.mTmpRect.bottom);
        if (z) {
