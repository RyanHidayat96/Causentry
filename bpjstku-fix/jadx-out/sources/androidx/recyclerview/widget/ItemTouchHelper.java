    ...
    void select(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder2 != null) {
            if (viewHolder2.itemView.getParent() != null) {
                ...
                float f = fArr[0];
                float f2 = fArr[1];
                final int i4 = iSwipeIfNecessary;
    ...
    boolean scrollIfNecessary() {
        ...
        if (layoutManager.canScrollVertically()) {
            ...
            if (f2 < 0.0f && paddingTop < 0) {
                ...
                iInterpolateOutOfBoundsScroll2 = ((i3 + this.mSelected.itemView.getHeight()) + this.mTmpRect.bottom) - (this.mRecyclerView.getHeight() - this.mRecyclerView.getPaddingBottom());
    ...
    public static abstract class Callback {
        ...
        public RecyclerView.ViewHolder chooseDropTarget(RecyclerView.ViewHolder viewHolder, List<RecyclerView.ViewHolder> list, int i, int i2) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (left2 > 0 && (right = viewHolder3.itemView.getRight() - (width + i)) < 0 && viewHolder3.itemView.getRight() > viewHolder.itemView.getRight() && (iAbs4 = Math.abs(right)) > i3) {
                ...
                if (top2 > 0 && (bottom = viewHolder3.itemView.getBottom() - (i2 + height)) < 0 && viewHolder3.itemView.getBottom() > viewHolder.itemView.getBottom() && (iAbs = Math.abs(bottom)) > i3) {
                    viewHolder2 = viewHolder3;
                    i3 = iAbs;
                }
            }
