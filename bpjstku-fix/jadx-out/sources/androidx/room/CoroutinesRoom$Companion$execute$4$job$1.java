...
final class CoroutinesRoom$Companion$execute$4$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            continuation.resumeWith(Result.m8024constructorimpl(objCall));
        } catch (Throwable th) {
            Continuation continuation2 = this.$continuation;
            Result.Companion companion2 = Result.INSTANCE;
            continuation2.resumeWith(Result.m8024constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    CoroutinesRoom$Companion$execute$4$job$1(Callable<R> callable, MediaFormatMustNotUseFrameRateToFindEncoderQuirk<? super R> mediaFormatMustNotUseFrameRateToFindEncoderQuirk, Continuation<? super CoroutinesRoom$Companion$execute$4$job$1> continuation) {
