...
final class RxRoom$Companion$createMaybe$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        this.label = 1;
        Object objPerformSuspending = DBUtil.performSuspending(this.$db, this.$isReadOnly, this.$inTransaction, this.$block, this);
        return objPerformSuspending == coroutine_suspended ? coroutine_suspended : objPerformSuspending;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    RxRoom$Companion$createMaybe$1(RoomDatabase roomDatabase, boolean z, boolean z2, Function1<? super SQLiteConnection, ? extends T> function1, Continuation<? super RxRoom$Companion$createMaybe$1> continuation) {
