...
final class RxRoom$Companion$createSingle$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    RxRoom$Companion$createSingle$1(RoomDatabase roomDatabase, boolean z, boolean z2, Function1<? super SQLiteConnection, ? extends T> function1, Continuation<? super RxRoom$Companion$createSingle$1> continuation) {
