...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        int iAbs2 = Math.abs(i2);
        if (iAbs2 > 0) {
            iAbs = Math.round(Math.abs((f + (fDistanceInfluenceForSnapDuration * f)) / iAbs2) * 1000.0f) * 4;
        } else {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            int i = this.mInitialEdgesTouched[pointerId] & this.mTrackingEdges;
            if (i != 0) {
                this.mCallback.onEdgeTouched(i, pointerId);
            }
            ...
            if (actionMasked == 3) {
                ...
                if (i2 == 0) {
                    int i3 = this.mInitialEdgesTouched[pointerId2] & this.mTrackingEdges;
                    if (i3 != 0) {
                        this.mCallback.onEdgeTouched(i3, pointerId2);
                    }
            ...
            for (int i4 = 0; i4 < pointerCount; i4++) {
                ...
                if (isValidPointerForActionMove(pointerId3)) {
                    ...
                    if (z) {
                        ...
                        int i5 = (int) f;
                        int iClampViewPositionHorizontal = this.mCallback.clampViewPositionHorizontal(viewFindTopChildUnder3, left + i5, i5);
                        int top = viewFindTopChildUnder3.getTop();
                        int i6 = (int) f2;
                        int iClampViewPositionVertical = this.mCallback.clampViewPositionVertical(viewFindTopChildUnder3, top + i6, i6);
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            int i2 = this.mInitialEdgesTouched[pointerId] & this.mTrackingEdges;
            if (i2 != 0) {
                this.mCallback.onEdgeTouched(i2, pointerId);
                return;
            }
            return;
        }
        ...
        if (actionMasked == 5) {
            ...
            if (this.mDragState == 0) {
                ...
                int i6 = this.mInitialEdgesTouched[pointerId3] & this.mTrackingEdges;
                if (i6 != 0) {
                    this.mCallback.onEdgeTouched(i6, pointerId3);
                    return;
                }
                return;
            }
