...
public class ViewPager extends ViewGroup {
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        float f = clientWidth;
        float f2 = i7;
        float fDistanceInfluenceForSnapDuration = distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i5) * 1.0f) / f));
        int iAbs2 = Math.abs(i3);
        if (iAbs2 > 0) {
            iAbs = Math.round(Math.abs((f2 + (fDistanceInfluenceForSnapDuration * f2)) / iAbs2) * 1000.0f) * 4;
        } else {
    ...
    /* JADX WARN: Code duplicated, block: B:63:0x00f9 A[PHI: r7 r10 r15
  ...
  0x00f9: PHI (r15v7 float) = (r15v5 float), (r15v6 float), (r15v4 float) binds: [B:61:0x00ee, B:58:0x00d8, B:52:0x00c2] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        if (i2 > 0 && !this.mItems.isEmpty()) {
            ...
            scrollTo((int) ((getScrollX() / (((i2 - getPaddingLeft()) - getPaddingRight()) + i4)) * (((i - paddingLeft) - getPaddingRight()) + i3)), getScrollY());
            return;
        }
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (itemInfoInfoForChild = infoForChild(childAt2)) != null) {
                    ...
                    int i19 = ((int) (itemInfoInfoForChild.offset * f)) + paddingLeft;
