...
public class PagerTitleStrip extends ViewGroup {
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        int iMax2 = Math.max(Math.max(this.mPrevText.getMeasuredHeight() + i6, this.mCurrText.getMeasuredHeight() + i7), this.mNextText.getMeasuredHeight() + i8);
        ...
        int iMin = Math.min(paddingLeft, (i4 - this.mScaledTextSpacing) - measuredWidth);
        TextView textView2 = this.mPrevText;
        textView2.layout(iMin, i10, measuredWidth + iMin, textView2.getMeasuredHeight() + i10);
        int iMax3 = Math.max((width - paddingRight) - measuredWidth3, i5 + this.mScaledTextSpacing);
