...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f11 = (motionPaths2.mY + (f6 / 2.0f)) - ((f7 / 2.0f) + f9);
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
    ...
    void initAxis(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f13 = motionPaths2.mY + (f6 / 2.0f);
        if (f9 > f12) {
            f9 = f12;
            f12 = f9;
        }
        ...
        float f16 = (f4 - f5) * f2;
        float f17 = f16 / 2.0f;
        this.mX = (int) ((f8 + (f14 * f)) - f17);
        float f18 = (f6 - f7) * f3;
        float f19 = f18 / 2.0f;
        this.mY = (int) ((f10 + (f15 * f)) - f19);
        this.mWidth = (int) (f5 + f16);
        this.mHeight = (int) (f7 + f18);
        ...
        this.mMode = 0;
        this.mX = (int) (((motionPaths.mX + (f20 * f14)) + (f22 * f15)) - f17);
        this.mY = (int) (((motionPaths.mY + (f14 * f21)) + (f15 * f)) - f19);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f13 = f6 / 2.0f;
        float f14 = (f4 - f5) * f2;
        this.mX = (int) ((f8 + (((f10 + f11) - ((f5 / 2.0f) + f8)) * f)) - (f14 / 2.0f));
        float f15 = (f6 - f7) * f3;
        this.mY = (int) ((f9 + (((f12 + f13) - ((f7 / 2.0f) + f9)) * f)) - (f15 / 2.0f));
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f15 = (f4 - f5) * f2;
        float f16 = f15 / 2.0f;
        this.mX = (int) ((f8 + f14) - f16);
        float f17 = f * f13;
        float f18 = (f6 - f7) * f3;
        float f19 = f18 / 2.0f;
        this.mY = (int) ((f10 + f17) - f19);
        this.mWidth = (int) (f9 + f15);
        this.mHeight = (int) (f11 + f18);
        float f20 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f21 = (int) ((motionPaths.mX + f14) - f16);
        this.mX = f21;
        float f22 = (int) ((motionPaths.mY + f17) - f19);
        this.mX = f21 + ((-f13) * f20);
        this.mY = f22 + (f12 * f20);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        float fSin = (f6 / 2.0f) + f7;
        float fCos = (f8 / 2.0f) + f9;
        MotionController motionController = this.mRelativeToController;
        if (motionController != null) {
            ...
            double d2 = f2;
            double d3 = f3;
            float fSin2 = (float) ((((double) f12) + (Math.sin(d3) * d2)) - ((double) (f4 / 2.0f)));
            float fCos2 = (float) ((((double) f13) - (Math.cos(d3) * d2)) - ((double) (f5 / 2.0f)));
            double d4 = f7;
            double d5 = f9;
            fSin = (float) (((double) f14) + (Math.sin(d3) * d4) + (Math.cos(d3) * d5));
            fCos = (float) ((((double) f15) - (d4 * Math.cos(d3))) + (Math.sin(d3) * d5));
            f = 2.0f;
            f3 = fCos2;
            f2 = fSin2;
        } else {
    ...
    void setView(float f, View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3, boolean z) {
        ...
        if (motionController != null) {
            ...
            float fCos2 = (float) ((((double) f19) - (d4 * Math.cos(d3))) + (Math.sin(d3) * d2 * d5));
            if (dArr2.length >= 2) {
                dArr2[0] = fSin2;
                dArr2[1] = fCos2;
            }
        ...
        if (view instanceof FloatLayout) {
            ((FloatLayout) view).layout(f4, f5, f6 + f4, f2 + f5);
            return;
        }
        float f20 = f4 + 0.5f;
        int i5 = (int) f20;
