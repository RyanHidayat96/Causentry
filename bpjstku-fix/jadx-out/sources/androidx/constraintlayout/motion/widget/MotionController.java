...
public class MotionController {
    ...
    private float getPreCycleDistance() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (easing != null) {
                ...
                float f4 = f2 - f3;
                d3 = (((float) easing.get((f - f3) / f4)) * f4) + f3;
            }
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        ...
        float f5 = this.mStartMotionPath.mX;
        float f6 = this.mStartMotionPath.mWidth / 2.0f;
        float f7 = this.mStartMotionPath.mY;
        float f8 = this.mStartMotionPath.mHeight / 2.0f;
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        for (String str7 : this.mEndMotionPath.mAttributes.keySet()) {
            if (this.mStartMotionPath.mAttributes.containsKey(str7) && !hashSet2.contains("CUSTOM,".concat(String.valueOf(str7)))) {
                hashSet4.add(str7);
            }
        }
        ...
        while (true) {
            ...
            if (iArr2[i13] < MotionPaths.sNames.length) {
                ...
                sb.append(MotionPaths.sNames[this.mInterpolateVariables[i13]]);
                sb.append(" [");
                String string = sb.toString();
                for (int i14 = 0; i14 < i3; i14++) {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append(string);
                    sb2.append(dArr[i14][i13]);
                    string = sb2.toString();
                }
            }
            i13++;
        ...
        while (true) {
            ...
            double[][] dArr4 = null;
            while (i16 < i3) {
                if (motionPathsArr[i16].hasCustomData(str9)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i3];
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i3, motionPathsArr[i16].getCustomDataCount(str9));
                    }
                    dArr3[i17] = motionPathsArr[i16].mTime;
                    motionPathsArr[i16].getCustomData(str9, dArr4[i17], 0);
                    i17++;
                }
                i16++;
                dArr = dArr;
    ...
    public String toString() {
        ...
        sb.append(this.mStartMotionPath.mX);
        sb.append(" y: ");
        sb.append(this.mStartMotionPath.mY);
        sb.append(" end: x: ");
        sb.append(this.mEndMotionPath.mX);
        sb.append(" y: ");
        sb.append(this.mEndMotionPath.mY);
        return sb.toString();
    }
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (this.mQuantizeMotionSteps != Key.UNSET) {
            ...
            adjustedPosition = (interpolation * f2) + (fFloor * f2);
        }
        ...
        if (curveFitArr != null) {
            ...
            if (pathRotate != null) {
                ...
                pathRotate2 = pathRotate.setPathRotate(view, keyCache, f4, j, dArr3[0], dArr3[1]) | pathRotate2;
            }
            int i2 = i;
            while (true) {
            ...
            int i5 = (int) f6;
            int i6 = (int) (f5 + this.mStartMotionPath.mWidth + ((this.mEndMotionPath.mWidth - this.mStartMotionPath.mWidth) * f4));
            int i7 = (int) (f6 + this.mStartMotionPath.mHeight + ((this.mEndMotionPath.mHeight - this.mStartMotionPath.mHeight) * f4));
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f7 = this.mEndMotionPath.mWidth;
        float f8 = this.mStartMotionPath.mWidth;
        float f9 = this.mEndMotionPath.mHeight;
        float f10 = this.mStartMotionPath.mHeight;
