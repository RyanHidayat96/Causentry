    ...
    */
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            sb4.toString();
            Objects.toString(constraintWidget);
        }
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            String string = sb.toString();
            Objects.toString(constraintWidgetContainer);
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str2 = constraintWidget.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : "_";
                StringBuilder sb3 = new StringBuilder();
                sb3.append(str2);
                ...
                if (view2 instanceof TextView) {
                    ...
                    sb6.append(name);
                    sb6.append("(");
                    sb6.append((Object) ((TextView) view2).getText());
                    sb6.append(")");
                    sb6.toString();
                }
                Objects.toString(constraintWidget);
    ...
    class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                ...
                String string = sb.toString();
                canvas.drawText(string, 10.0f, MotionLayout.this.getHeight() - 30, this.mTextPaint);
                canvas.drawText(string, 11.0f, MotionLayout.this.getHeight() - 29, this.mPaint);
            }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.mScene != null) {
            if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
                ...
                sb2.append(" ) state=");
                int i = this.mCurrentState;
                sb2.append(i == -1 ? "undefined" : Debug.getState(this, i));
                String string2 = sb2.toString();
    ...
    /* JADX WARN: Code duplicated, block: B:178:0x0191 A[SYNTHETIC] */
    ...
    void evaluate(boolean z) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (z || this.mTransitionGoalPosition != f))) {
            ...
            if (interpolator3 != null && !z2) {
                if (this.mTemporalInterpolator) {
                    interpolation = interpolator3.getInterpolation((nanoTime2 - this.mAnimationStartTime) * 1.0E-9f);
                ...
                boolean z5 = (fSignum <= 0.0f && interpolation >= this.mTransitionGoalPosition) || (fSignum <= 0.0f && interpolation <= this.mTransitionGoalPosition);
