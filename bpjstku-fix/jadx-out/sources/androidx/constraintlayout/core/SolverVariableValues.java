...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                if (this.mPrevious[iIndexOf] != -1) {
                    ...
                    sb4.append(string5);
                    sb4.append(this.mCache.mIndexedVariables[this.mVariables[this.mPrevious[iIndexOf]]]);
                    string = sb4.toString();
                } else {
                ...
                if (this.mNext[iIndexOf] != -1) {
                    ...
                    sb7.append(string6);
                    sb7.append(this.mCache.mIndexedVariables[this.mVariables[this.mNext[iIndexOf]]]);
    ...
    private void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f319id % this.mHashSize;
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f) {
        this.mVariables[i] = solverVariable.f319id;
        this.mValues[i] = f;
        this.mPrevious[i] = -1;
        this.mNext[i] = -1;
    ...
    public void put(SolverVariable solverVariable, float f) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            if (this.mVariables[i2] == solverVariable.f319id) {
                this.mValues[i2] = f;
                return;
            }
            if (this.mVariables[i2] < solverVariable.f319id) {
