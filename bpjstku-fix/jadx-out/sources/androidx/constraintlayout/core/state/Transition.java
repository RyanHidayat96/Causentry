...
public class Transition implements TypedValues {
    ...
    static class OnSwipe {
        ...
        public static final String[] DIRECTIONS = {EnabledPayment.STATUS_UP, EnabledPayment.STATUS_DOWN, "left", "right", "start", "end", "clockwise", "anticlockwise"};
        ...
        /* JADX WARN: Code duplicated, block: B:29:0x004a A[RETURN] */
        ...
        public void printInfo() {
            if (this.mAutoCompleteMode == 0) {
                ...
                sb.append(this.mEngine.getVelocity());
                printStream.println(sb.toString());
                PrintStream printStream2 = System.out;
                StringBuilder sb2 = new StringBuilder("mMaxAcceleration = ");
                sb2.append(this.mMaxAcceleration);
                printStream2.println(sb2.toString());
                PrintStream printStream3 = System.out;
                StringBuilder sb3 = new StringBuilder("mMaxVelocity = ");
                sb3.append(this.mMaxVelocity);
                printStream3.println(sb3.toString());
                return;
            }
            PrintStream printStream4 = System.out;
            StringBuilder sb4 = new StringBuilder("mSpringMass          = ");
            sb4.append(this.mSpringMass);
            printStream4.println(sb4.toString());
            PrintStream printStream5 = System.out;
            StringBuilder sb5 = new StringBuilder("mSpringStiffness     = ");
            sb5.append(this.mSpringStiffness);
            printStream5.println(sb5.toString());
            PrintStream printStream6 = System.out;
            StringBuilder sb6 = new StringBuilder("mSpringDamping       = ");
            sb6.append(this.mSpringDamping);
            printStream6.println(sb6.toString());
            PrintStream printStream7 = System.out;
            StringBuilder sb7 = new StringBuilder("mSpringStopThreshold = ");
            sb7.append(this.mSpringStopThreshold);
            printStream7.println(sb7.toString());
            PrintStream printStream8 = System.out;
            StringBuilder sb8 = new StringBuilder("mSpringBoundary      = ");
            sb8.append(this.mSpringBoundary);
