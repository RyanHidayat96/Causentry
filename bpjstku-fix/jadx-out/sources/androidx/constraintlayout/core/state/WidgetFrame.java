...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i16 = widgetFrame2.right;
        int i17 = widgetFrame2.bottom;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            int i20 = i12;
            Transition.KeyPosition keyPositionFindPreviousPosition = transition.findPreviousPosition(widgetFrame.widget.stringId, i11);
            Transition.KeyPosition keyPositionFindNextPosition = transition.findNextPosition(widgetFrame.widget.stringId, i11);
            ...
            if (keyPositionFindPreviousPosition != null) {
                i7 = i;
                i20 = (int) (keyPositionFindPreviousPosition.mX * i7);
                i8 = i2;
                i13 = (int) (keyPositionFindPreviousPosition.mY * i8);
            ...
            if (keyPositionFindNextPosition != null) {
                i6 = (int) (keyPositionFindNextPosition.mX * i7);
                i15 = (int) (keyPositionFindNextPosition.mY * i8);
        ...
        int i21 = (int) (i5 + ((i6 - i5) * f2));
        widgetFrame.left = i21;
        int i22 = (int) (i13 + (f2 * (i15 - i13)));
        widgetFrame.top = i22;
        float f6 = 1.0f - f;
        widgetFrame.right = i21 + ((int) ((i4 * f6) + (i18 * f)));
        widgetFrame.bottom = i22 + ((int) ((f6 * i3) + (i19 * f)));
        ...
        for (String str : setKeySet) {
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    ...
                    for (int i23 = 0; i23 < iNumberOfInterpolatedValues; i23++) {
                        fArr[i23] = interpolate(fArr[i23], fArr2[i23], 0.0f, f);
    ...
    void printCustomAttributes() {
        ...
        if (map != null) {
            for (String str : map.keySet()) {
                ...
                sb5.append(string);
                sb5.append(this.mCustom.get(str).toString());
