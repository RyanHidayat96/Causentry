...
public class CustomVariable {
    ...
    public String toString() {
        ...
        switch (this.mType) {
            ...
            case TypedValues.Custom.TYPE_COLOR /* 902 */:
                ...
                sb4.append(string);
                sb4.append(colorString(this.mIntegerValue));
                return sb4.toString();
            ...
            case TypedValues.Custom.TYPE_BOOLEAN /* 904 */:
                ...
                sb6.append(string);
                sb6.append(Boolean.valueOf(this.mBooleanValue));
                return sb6.toString();
    ...
    public void setInterpolatedValue(MotionWidget motionWidget, float[] fArr) {
        ...
        switch (i) {
            ...
            case TypedValues.Custom.TYPE_STRING /* 903 */:
            case TypedValues.Custom.TYPE_REFERENCE /* 906 */:
                StringBuilder sb = new StringBuilder("unable to interpolate ");
                sb.append(this.mName);
