...
public class Motion implements TypedValues {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        for (String str7 : this.mEndMotionPath.mCustomAttributes.keySet()) {
            if (this.mStartMotionPath.mCustomAttributes.containsKey(str7) && !hashSet2.contains("CUSTOM,".concat(String.valueOf(str7)))) {
                hashSet4.add(str7);
            }
        }
        ...
        while (true) {
            ...
            for (int i17 = 0; i17 < i3; i17++) {
                if (motionPathsArr[i17].hasCustomData(str9)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i3];
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i3, motionPathsArr[i17].getCustomDataCount(str9));
                    }
                    dArr3[i16] = motionPathsArr[i17].mTime;
                    motionPathsArr[i17].getCustomData(str9, dArr4[i16], 0);
                    i16++;
                }
            }
            i15++;
