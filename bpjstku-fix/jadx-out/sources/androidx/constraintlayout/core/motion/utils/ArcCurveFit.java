    ...
    static class Arc {
        ...
        private void buildTable(double d, double d2, double d3, double d4) {
            ...
            while (true) {
                ...
                double length = ((double) i) / ((double) (dArr3.length - 1));
                int iBinarySearch = Arrays.binarySearch(sOurPercent, length);
                if (iBinarySearch >= 0) {
                    this.mLut[i] = ((double) iBinarySearch) / ((double) (sOurPercent.length - 1));
                    ...
                    double d7 = dArr4[i5];
                    this.mLut[i] = (((double) i5) + ((length - d7) / (dArr4[i4 - 1] - d7))) / ((double) (dArr4.length - 1));
                }
                i++;
            }
        }
