...
public interface TypedValues {
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case 803192288:
                    ...
                    break;
                case 1167159411:
                    b = !str.equals(S_PIVOT_TARGET) ? (byte) -1 : (byte) 18;
                    break;
                case 1941332754:
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case 1639368448:
                    ...
                    break;
                case 1900899336:
                    b = !str.equals(S_ANIMATE_RELATIVE_TO) ? (byte) -1 : (byte) 11;
                    break;
                case 2109694967:
                    b = !str.equals(S_PATHMOTION_ARC) ? (byte) -1 : (byte) 12;
                    break;
                default:
                    b = -1;
                    break;
    ...
    public interface Custom {
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                case -1095013018:
                    b = !str.equals(S_DIMENSION) ? (byte) -1 : (byte) 0;
                    break;
                case -925155509:
                    b = !str.equals(S_REFERENCE) ? (byte) -1 : (byte) 1;
                    break;
                case -891985903:
                    b = !str.equals(S_STRING) ? (byte) -1 : (byte) 2;
                    break;
                case 64711720:
                    b = !str.equals(S_BOOLEAN) ? (byte) -1 : (byte) 3;
                    break;
                case 94842723:
                    b = !str.equals(S_COLOR) ? (byte) -1 : (byte) 4;
                    break;
                case 97526364:
                    b = !str.equals(S_FLOAT) ? (byte) -1 : (byte) 5;
                    break;
                case 1958052158:
                    b = !str.equals(S_INT) ? (byte) -1 : (byte) 6;
                    break;
                default:
                    b = -1;
                    break;
    ...
    public interface TransitionType {
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                case -1996906958:
                    b = !str.equals(S_TRANSITION_FLAGS) ? (byte) -1 : (byte) 0;
                    break;
                case -1992012396:
                    b = !str.equals(S_DURATION) ? (byte) -1 : (byte) 1;
                    break;
                case -1357874275:
                    b = !str.equals(S_INTERPOLATOR) ? (byte) -1 : (byte) 2;
                    break;
                case -1298065308:
                    b = !str.equals(S_AUTO_TRANSITION) ? (byte) -1 : (byte) 3;
                    break;
                case 3707:
                    b = !str.equals(S_TO) ? (byte) -1 : (byte) 4;
                    break;
                case 3151786:
                    b = !str.equals("from") ? (byte) -1 : (byte) 5;
                    break;
                case 1310733335:
                    b = !str.equals(S_PATH_MOTION_ARC) ? (byte) -1 : (byte) 6;
                    break;
                case 1839260940:
                    b = !str.equals(S_STAGGERED) ? (byte) -1 : (byte) 7;
                    break;
                default:
                    b = -1;
                    break;
