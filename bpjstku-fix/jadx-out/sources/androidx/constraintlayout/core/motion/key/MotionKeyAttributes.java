...
public class MotionKeyAttributes extends MotionKey {
    ...
    @Override // androidx.constraintlayout.core.motion.key.MotionKey
    /* JADX INFO: renamed from: clone */
    public /* bridge */ /* synthetic */ Object mo7194clone() throws CloneNotSupportedException {
        return mo7194clone();
    }
                ...
                if (str.startsWith("CUSTOM")) {
                    ...
                    switch (b) {
                        ...
                        case 13:
                            ...
                            break;
                        default:
                            System.err.println("not supported by KeyAttributes ".concat(String.valueOf(str)));
                            break;
                    }
                }
            }
    ...
    public void setInterpolation(HashMap<String, Integer> map) {
        ...
        if (this.mCustom.size() > 0) {
            Iterator<String> it = this.mCustom.keySet().iterator();
            while (it.hasNext()) {
                map.put("CUSTOM,".concat(String.valueOf(it.next())), Integer.valueOf(this.mCurveFit));
            }
        }
    }
    ...
    public void printAttributes() {
        ...
        for (int i = 0; i < strArr.length; i++) {
            int id2 = TypedValues.AttributesType.getId(strArr[i]);
            PrintStream printStream2 = System.out;
            StringBuilder sb2 = new StringBuilder();
            sb2.append(strArr[i]);
            sb2.append(":");
            sb2.append(getFloatValue(id2));
