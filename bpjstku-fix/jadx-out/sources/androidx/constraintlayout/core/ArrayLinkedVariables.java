...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public final void put(SolverVariable solverVariable, float f) {
        ...
        if (i == -1) {
            ...
            this.mArrayIndices[0] = solverVariable.f319id;
        ...
        for (int i4 = 0; i != -1 && i4 < this.mCurrentSize; i4++) {
            if (this.mArrayIndices[i] == solverVariable.f319id) {
        ...
        this.mArrayIndices[length] = solverVariable.f319id;
        ...
        solverVariable.usageInRowCount++;
        solverVariable.addToRow(this.mRow);
        int i7 = this.mCurrentSize + 1;
        this.mCurrentSize = i7;
        if (!this.mDidFillOnce) {
            this.mLast++;
        }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i != -1 && i2 < this.mCurrentSize; i2++) {
            ...
            sb2.append(string2);
            sb2.append(this.mArrayValues[i]);
            sb2.append(" : ");
            String string3 = sb2.toString();
            StringBuilder sb3 = new StringBuilder();
            sb3.append(string3);
            sb3.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
            string = sb3.toString();
            i = this.mArrayNextIndices[i];
        }
        return string;
