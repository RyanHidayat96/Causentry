...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    /* JADX WARN: Code duplicated, block: B:156:0x031f A[PHI: r13 r16
  0x031f: PHI (r13v8 ??) = (r13v7 ??), (r13v10 ??), (r13v10 ??), (r13v10 ??) binds: [B:143:0x02de, B:151:0x0305, B:152:0x0307, B:154:0x030d] A[DONT_GENERATE, DONT_INLINE]
  0x031f: PHI (r16v4 boolean) = (r16v3 boolean), (r16v5 boolean), (r16v5 boolean), (r16v5 boolean) binds: [B:143:0x02de, B:151:0x0305, B:152:0x0307, B:154:0x030d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public void layout() {
        ...
        while (zAddChildrenToSolver) {
            ...
            try {
                ...
                e2.printStackTrace();
                System.out.println("EXCEPTION : ".concat(String.valueOf(e2)));
            }
            if (zAddChildrenToSolver) {
