...
public class Direct {
    ...
    /* JADX WARN: Code duplicated, block: B:108:0x01e8 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:109:0x01ea A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:110:0x01ec  */
    /* JADX WARN: Code duplicated, block: B:111:0x020d  */
    /* JADX WARN: Code duplicated, block: B:113:0x022e A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:115:0x0230 A[ORIG_RETURN, RETURN] */
    /* JADX WARN: Code duplicated, block: B:73:0x0123 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:82:0x0152 A[DONT_INVERT] */
    ...
    public static boolean solveChain(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead, boolean z, boolean z2, boolean z3) {
        ...
        while (true) {
            ...
            int margin4 = constraintWidget3.mListAnchors[i2].getMargin();
            if (i == 0) {
                height2 = constraintWidget3.getWidth();
            } else {
                height2 = constraintWidget3.getHeight();
            }
            margin3 = margin3 + margin4 + height2 + constraintWidget3.mListAnchors[i5].getMargin();
            i7++;
