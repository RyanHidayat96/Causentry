...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    public String toString() {
        ...
        sb.append(this.mWidget.getDebugName());
        return sb.toString();
    }
        ...
        if (!this.mDimension.resolved) {
            ...
            if (this.mDimensionBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                if (this.mDimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_PARENT && (parent2 = this.mWidget.getParent()) != null && (parent2.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.FIXED || parent2.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_PARENT)) {
                    ...
                    int margin = this.mWidget.mLeft.getMargin();
                    int margin2 = this.mWidget.mRight.getMargin();
                    ...
                    this.mDimension.resolve((width - margin) - margin2);
                    return;
                }
                    ...
                    if (z && z2 && z3 && z4) {
                        ...
                        if (dependencyNode.resolved && dependencyNode2.resolved) {
                            if (this.start.readyToSolve && this.end.readyToSolve) {
                                computeInsetRatio(sTempDimensions, this.start.mMargin + this.start.mTargets.get(0).value, this.end.mTargets.get(0).value - this.end.mMargin, dependencyNode.value + dependencyNode.mMargin, dependencyNode2.value - dependencyNode2.mMargin, dimensionRatio3, dimensionRatioSide);
                        ...
                        if (this.start.resolved && this.end.resolved) {
                            ...
                            computeInsetRatio(sTempDimensions, this.start.mMargin + this.start.value, this.end.value - this.end.mMargin, dependencyNode.mTargets.get(0).value + dependencyNode.mMargin, dependencyNode2.mTargets.get(0).value - dependencyNode2.mMargin, dimensionRatio3, dimensionRatioSide);
                            this.mDimension.resolve(sTempDimensions[0]);
                            this.mWidget.mVerticalRun.mDimension.resolve(sTempDimensions[1]);
                        }
                        ...
                        computeInsetRatio(sTempDimensions, this.start.mMargin + this.start.mTargets.get(0).value, this.end.mTargets.get(0).value - this.end.mMargin, dependencyNode.mTargets.get(0).value + dependencyNode.mMargin, dependencyNode2.mTargets.get(0).value - dependencyNode2.mMargin, dimensionRatio3, dimensionRatioSide);
                        this.mDimension.resolve(sTempDimensions[0]);
                        this.mWidget.mVerticalRun.mDimension.resolve(sTempDimensions[1]);
                    } else if (z && z3) {
                        if (!this.start.readyToSolve || !this.end.readyToSolve) {
