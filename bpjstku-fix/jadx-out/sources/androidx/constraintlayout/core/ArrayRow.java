...
public class ArrayRow implements LinearSystem.Row {
    ...
    String toReadableString() {
        ...
        if (this.mConstantValue != 0.0f) {
            ...
            sb3.append(string2);
            sb3.append(this.mConstantValue);
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variable != null) {
                ...
                if (variableValue != 0.0f) {
                    String string3 = variable.toString();
                    if (z) {
                        if (variableValue > 0.0f) {
    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variableValue < 0.0f) {
                SolverVariable variable = this.variables.getVariable(i);
                if ((zArr == null || !zArr[variable.f319id]) && variable != solverVariable && ((variable.mType == SolverVariable.Type.SLACK || variable.mType == SolverVariable.Type.ERROR) && variableValue < f)) {
                    f = variableValue;
                    solverVariable2 = variable;
                }
            }
