...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f319id != -1 && solverVariable.f319id <= this.mVariablesID && this.mCache.mIndexedVariables[solverVariable.f319id] != null) {
                return solverVariable;
            }
            if (solverVariable.f319id != -1) {
                solverVariable.reset();
            }
            int i = this.mVariablesID + 1;
            this.mVariablesID = i;
            this.mNumColumns++;
            solverVariable.f319id = i;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f319id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f319id = i2;
    ...
    private int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f319id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f319id]) {
                    break;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f319id] = true;
            }
            if (pivotCandidate != null) {
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        StringBuilder sb = new StringBuilder(" num vars ");
        ...
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.mIsSynonym) {
                SolverVariable solverVariable3 = this.mCache.mIndexedVariables[solverVariable2.mSynonym];
                ...
                sb4.append(" + ");
                sb4.append(solverVariable2.mSynonymDelta);
                sb4.append("\n");
        ...
        for (int i3 = 0; i3 < this.mNumRows; i3++) {
            ...
            sb6.append(string3);
            sb6.append(this.mRows[i3].toReadableString());
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        ...
        if (USE_BASIC_SYNONYMS && solverVariable.mDefinitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.mIsSynonym && solverVariable2.mSynonym == solverVariable.f319id) {
