...
public class ConstraintSet {
    ...
    public static class Constraint {
        ...
        private ConstraintAttribute get(String str, ConstraintAttribute.AttributeType attributeType) {
            if (this.mCustomConstraints.containsKey(str)) {
                ...
                StringBuilder sb = new StringBuilder("ConstraintAttribute is already a ");
        ...
        public void fillFrom(int i, ConstraintLayout.LayoutParams layoutParams) {
            ...
            this.layout.mWidth = ((ViewGroup.LayoutParams) layoutParams).width;
            this.layout.mHeight = ((ViewGroup.LayoutParams) layoutParams).height;
            this.layout.leftMargin = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
            this.layout.rightMargin = ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
            this.layout.topMargin = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
            this.layout.bottomMargin = ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
        ...
        public void applyTo(ConstraintLayout.LayoutParams layoutParams) {
            ...
            ((ViewGroup.LayoutParams) layoutParams).width = this.layout.mWidth;
            ((ViewGroup.LayoutParams) layoutParams).height = this.layout.mHeight;
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m7200clone());
            }
        }
    }
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < strArrSplitString.length; i++) {
            ...
            String str2 = strArrSplitString[i];
    ...
    class WriteXmlEngine {
        ...
        private void writeBaseDimension(String str, int i, int i2) throws IOException {
            if (i != i2) {
                ...
                StringBuilder sb3 = new StringBuilder(SPACE);
                sb3.append(str);
                sb3.append("=\"");
                sb3.append(i);
                sb3.append("dp\"");
        ...
        String getName(int i) {
            if (this.mIdMap.containsKey(Integer.valueOf(i))) {
                ...
                sb.append(this.mIdMap.get(Integer.valueOf(i)));
                return sb.toString();
            }
            if (i == 0) {
            ...
            return "@+id/".concat(String.valueOf(strLookup));
        }
        ...
        void writeXmlConstraint(String str, int i) throws IOException {
            ...
            this.mWriter.write(SPACE.concat(String.valueOf(str)));
            Writer writer = this.mWriter;
            StringBuilder sb = new StringBuilder("=\"");
            sb.append(getName(i));
            sb.append("\"");
        ...
        void writeConstraint(String str, int i, String str2, int i2, int i3) throws IOException {
            ...
            if (i2 != 0) {
                this.mWriter.write(" , ".concat(String.valueOf(i2)));
            }
            this.mWriter.write("],\n");
        }
        ...
        void writeCircle(int i, float f, int i2) throws IOException {
            ...
            this.mWriter.write(":[");
            this.mWriter.write(getName(i));
            this.mWriter.write(", ".concat(String.valueOf(f)));
            Writer writer = this.mWriter;
            StringBuilder sb = new StringBuilder();
            sb.append(i2);
            sb.append("]");
        ...
        void writeVariable(String str, String str2) throws IOException {
            ...
            this.mWriter.write(":");
            this.mWriter.write(", ".concat(String.valueOf(str2)));
            this.mWriter.write("\n");
        }
    }
    ...
    class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i, int i2, float f, int i3, int i4, boolean z) throws IOException {
            ...
            if (i4 == -1 && i3 == -1) {
                if (i2 == 1) {
                    ...
                    StringBuilder sb4 = new StringBuilder(SPACE);
                    sb4.append(str);
                    sb4.append(": '???????????',\n");
                ...
                if (i2 == 2) {
                    ...
                    StringBuilder sb5 = new StringBuilder(SPACE);
                    sb5.append(str);
                    sb5.append(": '");
                    sb5.append(f);
                    sb5.append("%',\n");
            ...
            if (i2 == 0) {
                ...
                StringBuilder sb6 = new StringBuilder(SPACE);
                sb6.append(str);
                sb6.append(": {'spread' ,");
                sb6.append(i3);
                sb6.append(", ");
            ...
            if (i2 == 1) {
                ...
                StringBuilder sb7 = new StringBuilder(SPACE);
                sb7.append(str);
                sb7.append(": {'wrap' ,");
                sb7.append(i3);
                sb7.append(", ");
            ...
            StringBuilder sb8 = new StringBuilder(SPACE);
            sb8.append(str);
            sb8.append(": {'");
            sb8.append(f);
            sb8.append("'% ,");
        ...
        void writeVariable(String str, int i) throws IOException {
            ...
            this.mWriter.write(SPACE.concat(String.valueOf(str)));
            this.mWriter.write(":");
            this.mWriter.write(", ".concat(String.valueOf(i)));
            this.mWriter.write("\n");
        }
        ...
        void writeVariable(String str, boolean z) throws IOException {
            if (z) {
                this.mWriter.write(SPACE.concat(String.valueOf(str)));
                this.mWriter.write(": ".concat(String.valueOf(z)));
                this.mWriter.write(",\n");
            }
        }
