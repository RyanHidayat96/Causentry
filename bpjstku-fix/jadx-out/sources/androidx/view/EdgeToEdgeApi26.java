...
class EdgeToEdgeApi26 extends EdgeToEdgeBase {
    ...
    public void setUp(SystemBarStyle p0, SystemBarStyle p1, Window p2, View p3, boolean p4, boolean p5) {
        ...
        p2.setNavigationBarColor(p1.getScrim$activity(p5));
