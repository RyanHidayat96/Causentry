...
final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<onEncodePaused<? super Rect>, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            final View.OnLayoutChangeListener onLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda0
                ...
                public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.invokeSuspend$lambda$0(onencodepaused, view, i2, i3, i4, i5, i6, i7, i8, i9);
                }
            };
            ...
            final ViewTreeObserver.OnScrollChangedListener onScrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda1
                ...
                public final void onScrollChanged() {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.invokeSuspend$lambda$1(onencodepaused, view);
                }
            };
            ...
            final ?? r4 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public final void onViewAttachedToWindow(View p0) {
                    ...
                    onencodepaused.TuitionPaymentFragmentspecialinlinedviewModeldefault3(Activity.trackPipAnimationHintView$positionInWindow(view2));
            ...
            if (this.$view.isAttachedToWindow()) {
                onencodepaused.TuitionPaymentFragmentspecialinlinedviewModeldefault3(Activity.trackPipAnimationHintView$positionInWindow(this.$view));
            ...
            this.label = 1;
            if (setEncoderCallback.TuitionPaymentFragmentspecialinlinedviewModeldefault2(onencodepaused, new Function0() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return PipHintTrackerKt$trackPipAnimationHintView$flow$1.invokeSuspend$lambda$2(view3, onScrollChangedListener, onLayoutChangeListener, r4);
                }
    ...
    public static final void invokeSuspend$lambda$0(onEncodePaused onencodepaused, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        if (i == i5 && i3 == i7 && i2 == i6 && i4 == i8) {
            return;
        }
        Intrinsics.checkNotNull(view);
        onencodepaused.TuitionPaymentFragmentspecialinlinedviewModeldefault3(Activity.trackPipAnimationHintView$positionInWindow(view));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invokeSuspend$lambda$1(onEncodePaused onencodepaused, View view) {
        onencodepaused.TuitionPaymentFragmentspecialinlinedviewModeldefault3(Activity.trackPipAnimationHintView$positionInWindow(view));
    }
    ...
    public final Object invoke(onEncodePaused<? super Rect> onencodepaused, Continuation<? super Unit> continuation) {
        return ((PipHintTrackerKt$trackPipAnimationHintView$flow$1) create(onencodepaused, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
