...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("VersionedParcelable encountered IOException writing serializable object (name = ");
            sb.append(name);
            sb.append(")");
            throw new RuntimeException(sb.toString(), e2);
        }
    ...
    private Exception createException(int i, String str) {
        switch (i) {
            ...
            case -8:
            default:
                StringBuilder sb = new StringBuilder("Unknown exception code: ");
                sb.append(i);
                sb.append(" msg ");
                sb.append(str);
    ...
    protected Serializable readSerializable() {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("VersionedParcelable encountered IOException reading a Serializable object (name = ");
            sb.append(string);
            sb.append(")");
            throw new RuntimeException(sb.toString(), e2);
        } catch (ClassNotFoundException e3) {
            StringBuilder sb2 = new StringBuilder("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ");
            sb2.append(string);
            sb2.append(")");
