...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    public final void onScrolled(RecyclerView recyclerView, int i, int i2) {
        ...
        int i5 = this.mTarget;
        if ((i4 == i5 || i5 == -1) && this.mScrollValues.mOffsetPx == 0 && this.mScrollState != 1) {
            dispatchStateChanged(0);
            resetState();
        }
    }
    ...
    final void notifyDataSetChangeHappened() {
        this.mDataSetChangeHappened = true;
    }

    final void notifyProgrammaticScroll(int i, boolean z) {
    ...
    final void notifyBeginFakeDrag() {
        this.mAdapterState = 4;
        startDrag(true);
    }

    final void notifyEndFakeDrag() {
    ...
    final void setOnPageChangeCallback(ViewPager2.OnPageChangeCallback onPageChangeCallback) {
    ...
    final double getRelativeScrollPosition() {
        updateScrollEventValues();
