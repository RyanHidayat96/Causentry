...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder sb = new StringBuilder("Invalid hexString ");
        sb.append(str);
    ...
    public static final class Output extends OutputStream {
        ...
        public final ByteString toByteString() {
            ...
            synchronized (this) {
                flushLastBuffer();
                byteStringCopyFrom = ByteString.copyFrom(this.flushedBuffers);
            }
    ...
    static final class NioByteString extends LeafByteString {
