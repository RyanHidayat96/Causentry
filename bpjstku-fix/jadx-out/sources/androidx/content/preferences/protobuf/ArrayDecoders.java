...
final class ArrayDecoders {
    ...
    static int decodeVarint32(int i, byte[] bArr, int i2, Registers registers) {
        ...
        while (true) {
            int i11 = i10 + 1;
            if (bArr[i10] >= 0) {
                registers.int1 = i9 | ((b4 & ByteCompanionObject.MAX_VALUE) << 28);
                return i11;
            }
            i10 = i11;
        }
    ...
    static int decodeVarint64(long j, byte[] bArr, int i, Registers registers) {
        ...
        while (b < 0) {
            b = bArr[i2];
            i3 += 7;
            j2 |= ((long) (b & ByteCompanionObject.MAX_VALUE)) << i3;
            i2++;
        }
        registers.long1 = j2;
        return i2;
    ...
    static int decodeExtension(int i, byte[] bArr, int i2, int i3, GeneratedMessageLite.ExtendableMessage<?, ?> extendableMessage, GeneratedMessageLite.GeneratedExtension<?, ?> generatedExtension, UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> unknownFieldSchema, Registers registers) throws IOException {
        ...
        if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                case 1:
                    ...
                    objValueOf3 = objValueOf;
                    i2 += 8;
                    break;
                case 2:
                    objValueOf2 = Float.valueOf(decodeFloat(bArr, i2));
                    objValueOf3 = objValueOf2;
                    i2 += 4;
                    break;
                case 3:
                case 4:
                ...
                case 9:
                case 10:
                    objValueOf2 = Integer.valueOf(decodeFixed32(bArr, i2));
                    objValueOf3 = objValueOf2;
                    i2 += 4;
                    break;
                case 11:
                ...
                case 12:
                    i2 = decodeVarint32(bArr, i2, registers);
                    objValueOf3 = Integer.valueOf(CodedInputStream.decodeZigZag32(registers.int1));
                    break;
                case 13:
                    i2 = decodeVarint64(bArr, i2, registers);
                    objValueOf3 = Long.valueOf(CodedInputStream.decodeZigZag64(registers.long1));
                    break;
                case 14:
        ...
        if (generatedExtension.isRepeated()) {
            fieldSet.addRepeatedField(generatedExtension.descriptor, objValueOf3);
            return i2;
        }
        fieldSet.setField(generatedExtension.descriptor, objValueOf3);
        return i2;
    }
