...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public final void write(byte b) throws IOException {
            ...
            long j2 = this.limit;
            if (j >= j2) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(j), Long.valueOf(j2), 1));
            }
            this.position = 1 + j;
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            ...
            while (true) {
                ...
                long j4 = this.limit;
                if (j3 >= j4) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(j3), Long.valueOf(j4), 1));
                }
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j & (-128)) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.putByte(j2, (byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
            ...
            while (true) {
                ...
                long j5 = this.limit;
                if (j4 >= j5) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(j4), Long.valueOf(j5), 1));
                }
                if ((j & (-128)) == 0) {
                    this.position = 1 + j4;
