...
public abstract class CodedInputStream {
    ...
    static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:31:0x0087, code lost:
            ...
            if (androidx.content.preferences.protobuf.UnsafeUtil.getByte(r3) < 0) goto L37;
         */
        @Override // androidx.content.preferences.protobuf.CodedInputStream
        /*
        ...
        */
        public final int readRawVarint32() throws java.io.IOException {
            /*
                ...
                r2 = 1
                long r2 = r2 + r0
                byte r4 = androidx.content.preferences.protobuf.UnsafeUtil.getByte(r0)
                if (r4 < 0) goto L14
                r9.pos = r2
                return r4
            L14:
                ...
                r5 = 2
                long r5 = r5 + r0
                byte r2 = androidx.content.preferences.protobuf.UnsafeUtil.getByte(r2)
                int r2 = r2 << 7
                r2 = r2 ^ r4
                if (r2 >= 0) goto L2c
            ...
            L2c:
                r3 = 3
                long r3 = r3 + r0
                byte r5 = androidx.content.preferences.protobuf.UnsafeUtil.getByte(r5)
                int r5 = r5 << 14
                r2 = r2 ^ r5
                if (r2 < 0) goto L3c
            ...
            L3c:
                r5 = 4
                long r5 = r5 + r0
                byte r3 = androidx.content.preferences.protobuf.UnsafeUtil.getByte(r3)
                int r3 = r3 << 21
                r2 = r2 ^ r3
                if (r2 >= 0) goto L4d
            ...
            L4d:
                ...
                r5 = 10
                long r5 = r5 + r0
                byte r0 = androidx.content.preferences.protobuf.UnsafeUtil.getByte(r3)
                if (r0 >= 0) goto L8a
                goto L91
            L8a:
                r0 = r2
        ...
        public final long readRawVarint64() throws IOException {
            ...
            if (this.limit != j5) {
                ...
                if (this.limit - j6 >= 9) {
                    long j7 = 2 + j5;
                    int i2 = (UnsafeUtil.getByte(j6) << 7) ^ b;
                    if (i2 >= 0) {
                        j = 3 + j5;
                        ...
                        if (i3 >= 0) {
                            ...
                            if (i4 < 0) {
                                ...
                                long j8 = 5 + j5;
                                long j9 = ((long) i4) ^ (((long) UnsafeUtil.getByte(j7)) << 28);
                                if (j9 >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j10 = 6 + j5;
    ...
    static final class StreamDecoder extends CodedInputStream {
        ...
        class SkippedDataSink implements RefillCallback {
            ...
            ByteBuffer getSkippedData() throws IOException {
    ...
    static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public final int readRawVarint32() throws IOException {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j2 = 2 + j;
                    int i2 = b ^ (UnsafeUtil.getByte(1 + j) << 7);
                    if (i2 < 0) {
                        i = i2 ^ WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                    } else {
                        long j3 = 3 + j;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j2) << 14);
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            j2 = 4 + j;
        ...
        public final long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j3) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j4 = 2 + j3;
                    int i2 = b ^ (UnsafeUtil.getByte(1 + j3) << 7);
                    if (i2 >= 0) {
                        long j5 = 3 + j3;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j4) << 14);
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                            j4 = j5;
                        } else {
                            j4 = 4 + j3;
                            int i4 = i3 ^ (UnsafeUtil.getByte(j5) << 21);
                            if (i4 < 0) {
                                i = (-2080896) ^ i4;
                            } else {
                                long j6 = 5 + j3;
                                long j7 = ((long) i4) ^ (((long) UnsafeUtil.getByte(j4)) << 28);
                                if (j7 >= 0) {
                                    j2 = 266354560;
                                } else {
                                    long j8 = 6 + j3;
                                    j7 ^= ((long) UnsafeUtil.getByte(j6)) << 35;
                                    if (j7 < 0) {
                                        j2 = -34093383808L;
                                    } else {
                                        j6 = 7 + j3;
                                        j7 ^= ((long) UnsafeUtil.getByte(j8)) << 42;
                                        if (j7 >= 0) {
                                            j2 = 4363953127296L;
                                        } else {
                                            j8 = 8 + j3;
                                            j7 ^= ((long) UnsafeUtil.getByte(j6)) << 49;
                                            if (j7 < 0) {
                                                j2 = -558586000294016L;
                                            } else {
                                                long j9 = 9 + j3;
                                                long j10 = (j7 ^ (((long) UnsafeUtil.getByte(j8)) << 56)) ^ 71499008037633920L;
                                                if (j10 >= 0) {
                                                    j = j10;
                                                    j4 = j9;
                                                } else if (UnsafeUtil.getByte(j9) >= 0) {
                                                    j4 = j3 + 10;
                                                    j = j10;
                                                }
                                            }
        ...
        public final int readRawLittleEndian32() throws IOException {
            ...
            if (currentRemaining() >= 4) {
                ...
                rawByte = (UnsafeUtil.getByte(j + 3) & UByte.MAX_VALUE) << 24;
                rawByte2 = (b & UByte.MAX_VALUE) | ((b2 & UByte.MAX_VALUE) << 8) | ((b3 & UByte.MAX_VALUE) << 16);
            } else {
                rawByte = (readRawByte() & UByte.MAX_VALUE) | ((readRawByte() & UByte.MAX_VALUE) << 8) | ((readRawByte() & UByte.MAX_VALUE) << 16);
                rawByte2 = (readRawByte() & UByte.MAX_VALUE) << 24;
            }
            return rawByte | rawByte2;
        }
        ...
        public final long readRawLittleEndian64() throws IOException {
            ...
            if (currentRemaining() >= 8) {
                ...
                long j6 = (((long) UnsafeUtil.getByte(j + 4)) & 255) << 32;
                rawByte = ((((long) UnsafeUtil.getByte(j + 5)) & 255) << 40) | j6 | ((j4 & 255) << 16) | (j2 & 255) | ((j3 & 255) << 8) | ((j5 & 255) << 24) | ((((long) UnsafeUtil.getByte(6 + j)) & 255) << 48);
            ...
            return rawByte | ((((long) rawByte2) & 255) << 56);
        }
