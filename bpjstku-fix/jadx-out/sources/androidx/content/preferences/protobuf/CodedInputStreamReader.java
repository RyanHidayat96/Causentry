...
final class CodedInputStreamReader implements Reader {
    ...
    @Override // androidx.content.preferences.protobuf.Reader
    public final <T> void mergeMessageField(T t, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(2);
    ...
    @Override // androidx.content.preferences.protobuf.Reader
    public final <T> void mergeGroupField(T t, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(3);
    ...
    public final void readDoubleList(List<Double> list) throws IOException {
        ...
        if (list instanceof DoubleArrayList) {
            ...
            if (tagWireType == 2) {
                ...
                do {
                    doubleArrayList.addDouble(this.input.readDouble());
                } while (this.input.getTotalBytesRead() < totalBytesRead + uInt32);
                return;
            }
            throw InvalidProtocolBufferException.invalidWireType();
        }
        ...
        if (tagWireType2 == 2) {
            ...
            do {
                list.add(Double.valueOf(this.input.readDouble()));
            } while (this.input.getTotalBytesRead() < totalBytesRead2 + uInt33);
            return;
        }
        throw InvalidProtocolBufferException.invalidWireType();
    }
