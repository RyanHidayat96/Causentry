...
final class UnsafeUtil {
    ...
    public static void putByteBigEndian(Object obj, long j, byte b) {
        ...
        int i = getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        putInt(obj, j2, ((~(255 << i2)) & i) | ((b & UByte.MAX_VALUE) << i2));
    }
    ...
    public static void logMissingMethod(Throwable th) {
        Logger.getLogger(UnsafeUtil.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: ".concat(String.valueOf(th)));
    }
}
