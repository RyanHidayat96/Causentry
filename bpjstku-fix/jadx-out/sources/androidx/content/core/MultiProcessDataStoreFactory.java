...
public final class MultiProcessDataStoreFactory {
    ...
    public final <T> DataStore<T> create(Storage<T> p0, ReplaceFileCorruptionHandler<T> p1, List<? extends DataMigration<T>> p2, CoroutineScope p3) {
        ...
        List listListOf = CollectionsKt.listOf(DataMigrationInitializer.INSTANCE.getInitializer(p2));
        if (p1 == null) {
            p1 = (ReplaceFileCorruptionHandler<T>) new NoOpCorruptionHandler();
        }
        return new DataStoreImpl(p0, listListOf, p1, p3);
    }
    ...
    public final <T> DataStore<T> create(Serializer<T> p0, ReplaceFileCorruptionHandler<T> p1, List<? extends DataMigration<T>> p2, final CoroutineScope p3, Function0<? extends File> p4) {
        Intrinsics.checkNotNullParameter(p0, "");
        Intrinsics.checkNotNullParameter(p2, "");
        Intrinsics.checkNotNullParameter(p3, "");
        Intrinsics.checkNotNullParameter(p4, "");
        FileStorage fileStorage = new FileStorage(p0, new Function1<File, InterProcessCoordinator>() { // from class: androidx.datastore.core.MultiProcessDataStoreFactory.create.1
            @Override // kotlin.jvm.functions.Function1
            public final InterProcessCoordinator invoke(File file) {
                Intrinsics.checkNotNullParameter(file, "");
                return new MultiProcessCoordinator(p3.getCoroutineContext(), file);
            }
        ...
        return new DataStoreImpl(fileStorage, listListOf, p1, p3);
    }
