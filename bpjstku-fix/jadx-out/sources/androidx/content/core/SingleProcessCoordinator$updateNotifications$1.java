...
final class SingleProcessCoordinator$updateNotifications$1 extends SuspendLambda implements Function2<addSignalEosTimeoutIfNeeded<? super Unit>, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(addSignalEosTimeoutIfNeeded<? super Unit> addsignaleostimeoutifneeded, Continuation<? super Unit> continuation) {
        return ((SingleProcessCoordinator$updateNotifications$1) create(addsignaleostimeoutifneeded, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
