...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b'\u0018\u0000*\b\b\u0000\u0010\u0002*\u00020\u00012\b\u0012\u0004\u0012\u00028\u00000\u0003B\u0007¢\u0006\u0004\b\u0004\u0010\u0005J\u001d\u0010\n\u001a\u00020\t2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00028\u0000¢\u0006\u0004\b\n\u0010\u000bJ\u0017\u0010\r\u001a\u00028\u00002\u0006\u0010\u0007\u001a\u00020\fH\u0007¢\u0006\u0004\b\r\u0010\u000eR\u001a\u0010\u0010\u001a\u00020\u000f8\u0007X\u0087\u0004¢\u0006\f\n\u0004\b\u0010\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013"}, d2 = {"Landroidx/savedstate/serialization/serializers/JavaSerializableSerializer;", "Ljava/io/Serializable;", ExifInterface.GPS_DIRECTION_TRUE, "LvideoProfileHdrFormatsToDynamicRangeEncoding;", "<init>", "()V", "LstartListeningToRotationEvents;", "p0", "p1", "", "serialize", "(LstartListeningToRotationEvents;Ljava/io/Serializable;)V", "LstopListeningToRotationEvents;", "deserialize", "(LstopListeningToRotationEvents;)Ljava/io/Serializable;", "LcreateImageAnalysis;", "descriptor", "LcreateImageAnalysis;", "getDescriptor", "()LcreateImageAnalysis;"}, k = 1, mv = {2, 0, 0}, xi = 48)
public abstract class JavaSerializableSerializer<T extends Serializable> implements videoProfileHdrFormatsToDynamicRangeEncoding<T> {
    private final createImageAnalysis descriptor = getViewportAspectRatioStrategy.TuitionPaymentFragmentbindingInflater1("java.io.Serializable", new createImageAnalysis[0], new getViewportAspectRatioInt());
    ...
    public final void serialize(startListeningToRotationEvents p0, T p1) {
        ...
        SavedStateWriter.m7474putJavaSerializableimpl(SavedStateWriter.m7454constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), p1);
    }
    ...
    public final T deserialize(stopListeningToRotationEvents p0) {
        ...
        T t = (T) SavedStateReader.m7406getJavaSerializableimpl(SavedStateReader.m7368constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Serializable.class));
