...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    @Override // androidx.camera.view.PreviewViewImplementation
    final void onSurfaceRequested(final SurfaceRequest surfaceRequest, final PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        this.mSurfaceView.post(new Runnable() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m325x6305943b(surfaceRequest, onSurfaceNotInUseListener);
            }
        });
    }
    ...
    final /* synthetic */ void m325x6305943b(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        this.mSurfaceRequestCallback.setSurfaceRequest(surfaceRequest, onSurfaceNotInUseListener);
    }

    @Override // androidx.camera.view.PreviewViewImplementation
    final void initializePreview() {
    ...
    final Bitmap getPreviewBitmap() {
        ...
        try {
            ...
            Logger.e(TAG, "Interrupted while trying to acquire screenshot.", e2);
            return bitmapCreateBitmap;
        } finally {
    ...
    static /* synthetic */ void lambda$getPreviewBitmap$1(Semaphore semaphore, int i) {
        if (i == 0) {
            ...
            Logger.e(TAG, "PreviewView.SurfaceViewImplementation.getBitmap() failed with error ".concat(String.valueOf(i)));
        }
        semaphore.release();
    }
    ...
    class SurfaceRequestCallback implements SurfaceHolder.Callback {
        ...
        private void cancelPreviousRequest() {
            if (this.mSurfaceRequest != null) {
                ...
                Logger.d(SurfaceViewImplementation.TAG, sb.toString());
        ...
        private void closeSurface() {
            if (this.mSurfaceRequest != null) {
                StringBuilder sb = new StringBuilder("Surface closed ");
                sb.append(this.mSurfaceRequest);
                Logger.d(SurfaceViewImplementation.TAG, sb.toString());
