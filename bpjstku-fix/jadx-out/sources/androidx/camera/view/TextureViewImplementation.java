...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    @Override // androidx.camera.view.PreviewViewImplementation
    final void onSurfaceRequested(final SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        surfaceRequest.addRequestCancellationListener(ContextCompat.getMainExecutor(this.mTextureView.getContext()), new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m326xce057d29(surfaceRequest);
            }
        });
    ...
    final /* synthetic */ void m326xce057d29(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    class AnonymousClass1 implements TextureView.SurfaceTextureListener {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            sb.append("x");
            sb.append(i2);
            Logger.d(TextureViewImplementation.TAG, sb.toString());
            ...
            if (TextureViewImplementation.this.mSurfaceReleaseFuture != null) {
                ...
                StringBuilder sb2 = new StringBuilder("Surface invalidated ");
                sb2.append(TextureViewImplementation.this.mSurfaceRequest);
                Logger.d(TextureViewImplementation.TAG, sb2.toString());
    ...
    final void tryToProvidePreviewSurface() {
        ...
        final ListenableFuture<SurfaceRequest.Result> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda3
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m327xdd0bd278(surface, completer);
            }
        });
        ...
        future.addListener(new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m328x16d67457(surface, future, surfaceRequest);
            }
    ...
    final /* synthetic */ Object m327xdd0bd278(Surface surface, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    final /* synthetic */ void m328x16d67457(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
    ...
    @Override // androidx.camera.view.PreviewViewImplementation
    final ListenableFuture<Void> waitForNextFrame() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m329x86b0fc00(completer);
            }
        });
    }
    ...
    final /* synthetic */ Object m329x86b0fc00(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    @Override // androidx.camera.view.PreviewViewImplementation
    final void setFrameUpdateListener(Executor executor, PreviewView.OnFrameUpdateListener onFrameUpdateListener) {
