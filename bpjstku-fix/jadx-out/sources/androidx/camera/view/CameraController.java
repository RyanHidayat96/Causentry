...
public abstract class CameraController {
    ...
    CameraController(Context context, ListenableFuture<ProcessCameraProviderWrapper> listenableFuture) {
        ...
        this.mInitializationFuture = Futures.transform(listenableFuture, new Function() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda3
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return this.f$0.m309lambda$new$0$androidxcameraviewCameraController((ProcessCameraProviderWrapper) obj);
            }
        ...
        this.mDeviceRotationListener = new RotationProvider.Listener() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda4
            ...
            public final void onRotationChanged(int i) {
                this.f$0.m310lambda$new$1$androidxcameraviewCameraController(i);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-view-CameraController, reason: not valid java name */
    /* synthetic */ Void m309lambda$new$0$androidxcameraviewCameraController(ProcessCameraProviderWrapper processCameraProviderWrapper) {
    ...
    /* synthetic */ void m310lambda$new$1$androidxcameraviewCameraController(int i) {
    ...
    private void setTargetOutputSize(ImageOutputConfig.Builder<?> builder, OutputSize outputSize) {
        ...
        if (outputSize.getResolution() != null) {
            ...
            Logger.e(TAG, "Invalid target surface size. ".concat(String.valueOf(outputSize)));
        }
    }
    ...
    public void updateScreenFlashToImageCapture() {
        ...
        if (screenFlashUiInfoByPriority == null) {
            ...
            StringBuilder sb = new StringBuilder("Set ScreenFlash instance to ImageCapture, provided by ");
    ...
    class AnonymousClass2 implements Consumer<VideoRecordEvent> {
            ...
            if (videoRecordEvent instanceof VideoRecordEvent.Finalize) {
                if (!Threads.isMainThread()) {
                    this.val$mainExecutor.execute(new Runnable() { // from class: androidx.camera.view.CameraController$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m313lambda$accept$0$androidxcameraviewCameraController$2();
                        }
                    });
                } else {
        ...
        /* synthetic */ void m313lambda$accept$0$androidxcameraviewCameraController$2() {
            CameraController.this.deactivateRecordingByListener(this);
        }
    }
    ...
    public void setCameraSelector(CameraSelector cameraSelector) {
        ...
        if (this.mCameraSelector != cameraSelector) {
            ...
            startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m311lambda$setCameraSelector$3$androidxcameraviewCameraController(cameraSelector2);
                }
            });
        }
    }
    ...
    /* synthetic */ void m311lambda$setCameraSelector$3$androidxcameraviewCameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
    ...
    void onPinchToZoom(float f) {
        ...
        Logger.d(TAG, "Pinch to zoom with scale: ".concat(String.valueOf(f)));
    ...
    void onTapToFocus(MeteringPointFactory meteringPointFactory, float f, float f2) {
        ...
        MeteringPoint meteringPointCreatePoint = meteringPointFactory.createPoint(f, f2, AF_SIZE);
        Futures.addCallback(this.mCamera.getCameraControl().startFocusAndMetering(new FocusMeteringAction.Builder(meteringPointCreatePoint, 1).addPoint(meteringPointFactory.createPoint(f, f2, AE_SIZE), 2).build()), new FutureCallback<FocusMeteringResult>() { // from class: androidx.camera.view.CameraController.3
            ...
            public void onSuccess(FocusMeteringResult focusMeteringResult) {
                ...
                sb2.append(focusMeteringResult.isFocusSuccessful());
                Logger.d(CameraController.TAG, sb2.toString());
