...
public final class FileTransformFactory {
    ...
    public final OutputTransform getOutputTransform(ContentResolver contentResolver, Uri uri) throws IOException {
    ...
    public final OutputTransform getOutputTransform(File file) throws IOException {
    ...
    public final OutputTransform getOutputTransform(InputStream inputStream) throws IOException {
