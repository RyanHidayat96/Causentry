...
public final class ScreenFlashView extends View {
    ...
    public ValueAnimator animateToFullOpacity(final Runnable runnable) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.camera.view.ScreenFlashView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m324x7abca040(valueAnimator);
            }
        });
    ...
    final /* synthetic */ void m324x7abca040(ValueAnimator valueAnimator) {
        StringBuilder sb = new StringBuilder("animateToFullOpacity: value = ");
        sb.append(((Float) valueAnimator.getAnimatedValue()).floatValue());
    ...
    public void setBrightness(float f) {
        ...
        StringBuilder sb = new StringBuilder("Brightness set to ");
