    ...
    ListenableFuture<Void> setValue(final T t) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.PendingValue$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m314lambda$setValue$0$androidxcameraviewPendingValue(t, completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setValue$0$androidx-camera-view-PendingValue, reason: not valid java name */
    /* synthetic */ Object m314lambda$setValue$0$androidxcameraviewPendingValue(Object obj, CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        return "PendingValue ".concat(String.valueOf(obj));
    }
