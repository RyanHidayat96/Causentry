...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
        ...
        synchronized (this.mLock) {
            ...
            ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda3
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m105x73bfea20(list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                }
            });
    ...
    /* synthetic */ Object m105x73bfea20(List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) throws Exception {
        String string;
        synchronized (this.mLock) {
            ...
            StringBuilder sb = new StringBuilder("openCaptureSession[session=");
            sb.append(this);
            sb.append("]");
            string = sb.toString();
        }
        ...
        synchronized (this.mLock) {
            ...
            FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda4
                ...
                public final ListenableFuture apply(Object obj) {
                    return this.f$0.m106x2071bdd2(list, (List) obj);
                }
            }, getExecutor());
    ...
    /* synthetic */ ListenableFuture m106x2071bdd2(List list, List list2) throws Exception {
        StringBuilder sb = new StringBuilder("[");
        sb.append(this);
        sb.append("] getSurface done with results: ");
        sb.append(list2);
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSession.Opener
    public boolean stop() {
        boolean zIsCameraCaptureSessionOpen;
        ListenableFuture<List<Surface>> listenableFuture = null;
        try {
            synchronized (this.mLock) {
                if (!this.mOpenerDisabled) {
                    ListenableFuture<List<Surface>> listenableFuture2 = this.mStartingSurface;
                    listenableFuture = listenableFuture2 != null ? listenableFuture2 : null;
                    this.mOpenerDisabled = true;
                }
                zIsCameraCaptureSessionOpen = isCameraCaptureSessionOpen();
            }
            if (listenableFuture != null) {
                listenableFuture.cancel(true);
            }
            return true ^ zIsCameraCaptureSessionOpen;
        } catch (Throwable th) {
            if (listenableFuture != null) {
                listenableFuture.cancel(true);
            }
    ...
    public void onClosed(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m103x46877ef4(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    /* synthetic */ void m103x46877ef4(SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (this.mCameraCaptureSessionCompat != null) {
            ...
            StringBuilder sb = new StringBuilder("[");
            sb.append(this);
            sb.append("] Cannot call onClosed() when the CameraCaptureSession is not correctly configured.");
    ...
    void onSessionFinished(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m104x5333f8b9(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    /* synthetic */ void m104x5333f8b9(SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(this.mCaptureSessionStateCallback);
