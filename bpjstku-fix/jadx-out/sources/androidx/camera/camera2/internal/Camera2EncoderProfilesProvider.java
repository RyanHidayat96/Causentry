...
public class Camera2EncoderProfilesProvider implements EncoderProfilesProvider {
    ...
    public Camera2EncoderProfilesProvider(String str, Quirks quirks) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("Camera id is not an integer: ");
            sb.append(str);
            sb.append(", unable to create Camera2EncoderProfilesProvider");
    ...
    private EncoderProfilesProxy createProfilesFromCamcorderProfile(int i) {
        ...
        try {
            ...
            Logger.w(TAG, "Unable to get CamcorderProfile by quality: ".concat(String.valueOf(i)), e2);
