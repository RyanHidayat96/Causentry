...
final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    @Override // androidx.camera.camera2.internal.CaptureSessionInterface
    public final ListenableFuture<Void> open(final SessionConfig sessionConfig, final CameraDevice cameraDevice, final SynchronizedCaptureSession.Opener opener) {
        ...
        return FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(surfaces, false, 5000L, this.mExecutor, this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$$ExternalSyntheticLambda1
            ...
            public final ListenableFuture apply(Object obj) {
                return this.f$0.m99x6ab9d420(sessionConfig, cameraDevice, opener, (List) obj);
            }
            ...
            public final Object apply(Object obj) {
                return this.f$0.m100x7b6fa0e1((Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    final /* synthetic */ ListenableFuture m99x6ab9d420(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSession.Opener opener, List list) throws Exception {
        ...
        try {
            ...
            try {
                SessionConfig sessionConfigInitSession = this.mSessionProcessor.initSession(this.mCamera2CameraInfoImpl, OutputSurfaceConfiguration.create(outputSurfaceCreate3, outputSurfaceCreate2, outputSurfaceCreate4, outputSurfaceCreate));
    ...
    final /* synthetic */ void m98x494e3a9e(DeferrableSurface deferrableSurface) {
        DeferrableSurfaces.decrementAll(this.mOutputSurfaces);
    ...
    final /* synthetic */ Void m100x7b6fa0e1(Void r1) {
    ...
    final void issueTriggerRequest(CaptureConfig captureConfig) {
    ...
    public final void issueCaptureRequests(List<CaptureConfig> list) {
        ...
        StringBuilder sb = new StringBuilder("issueCaptureRequests (id=");
        sb.append(this.mInstanceId);
        sb.append(") + state =");
        sb.append(this.mProcessorState);
        Logger.d(TAG, sb.toString());
        ...
        if (iOrdinal == 3 || iOrdinal == 4) {
            StringBuilder sb2 = new StringBuilder("Run issueCaptureRequests in wrong state, state = ");
    ...
    final void issueStillCaptureRequest(CaptureConfig captureConfig) {
    ...
    static class CaptureCallbackAdapter implements SessionProcessor.CaptureCallback {
    ...
    final /* synthetic */ void m101x14d78e45() {
    ...
    final void onConfigured(CaptureSession captureSession) {
        if (this.mProcessorState == ProcessorState.SESSION_INITIALIZED) {
            ...
            StringBuilder sb = new StringBuilder("== onCaptureSessinStarted (id = ");
            sb.append(this.mInstanceId);
            sb.append(")");
            Logger.d(TAG, sb.toString());
    ...
    public final void close() {
        ...
        if (this.mProcessorState == ProcessorState.ON_CAPTURE_SESSION_STARTED) {
            StringBuilder sb2 = new StringBuilder("== onCaptureSessionEnd (id = ");
            sb2.append(this.mInstanceId);
            sb2.append(")");
            Logger.d(TAG, sb2.toString());
