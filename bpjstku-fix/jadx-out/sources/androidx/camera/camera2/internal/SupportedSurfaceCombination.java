...
final class SupportedSurfaceCombination {
    ...
    final boolean isRawSupported() {
        return this.mIsRawSupported;
    }

    final boolean isBurstCaptureSupported() {
    ...
    final boolean checkSupported(FeatureSettings featureSettings, List<SurfaceConfig> list) {
        boolean z;
    ...
    final List<SurfaceConfig> getOrderedSupportedStreamUseCaseSurfaceConfigList(FeatureSettings featureSettings, List<SurfaceConfig> list) {
    ...
    final SurfaceConfig transformSurfaceConfig(int i, int i2, Size size) {
    ...
    final Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecifications(int i, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map, boolean z, boolean z2) {
        HashMap map2;
        HashMap map3;
        HashMap map4;
        Range<Integer> range;
        ...
        if (!this.mIsStreamUseCaseSupported || zContainsZslUseCase) {
            ...
            while (true) {
                ...
                list2 = useCasesPriorityOrder;
                str5 = str6;
                orderedSupportedStreamUseCaseSurfaceConfigList = getOrderedSupportedStreamUseCaseSurfaceConfigList(featureSettingsCreateFeatureSettings, (List) getSurfaceConfigListAndFpsCeiling(i, list, it2.next(), arrayList, list6, i8, map16, map15).first);
                map2 = map16;
                map6 = map15;
        ...
        while (true) {
            if (it3.hasNext()) {
                ...
                int i12 = i2;
                boolean z5 = range == null || i12 <= iIntValue || iIntValue >= ((Integer) range.getLower()).intValue();
        ...
        if (list5 != null) {
            Range<Integer> closestSupportedDeviceFrameRate = range != null ? getClosestSupportedDeviceFrameRate(range, i4) : null;
            ...
            while (it4.hasNext()) {
                ...
                StreamSpec.Builder zslDisabled = StreamSpec.builder(list5.get(list10.indexOf(Integer.valueOf(arrayList.indexOf(next2))))).setDynamicRange((DynamicRange) Preconditions.checkNotNull(map17.get(next2))).setImplementationOptions(StreamUseCaseUtil.getStreamSpecImplementationOptions(next2)).setZslDisabled(z2);
            ...
            HashMap map18 = map3;
            if (list3 == null || i4 != i5 || list5.size() != list4.size()) {
                map9 = map4;
                break;
            }
            int i13 = 0;
            while (true) {
                if (i13 < list5.size()) {
                    if (!list5.get(i13).equals(list4.get(i13))) {
                        map9 = map4;
                        break;
                    }
                    i13++;
        ...
        sb3.append(" and Hardware level: ");
        sb3.append(this.mHardwareLevel);
        sb3.append(". May be the specified resolution is too large and not supported. Existing surfaces: ");
        sb3.append(list);
        sb3.append(str4);
    ...
    private boolean isUseCasesCombinationSupported(FeatureSettings featureSettings, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map) {
        ...
        for (UseCaseConfig<?> useCaseConfig : map.keySet()) {
            ...
            StringBuilder sb = new StringBuilder("No available output size is found for ");
    ...
    final List<Size> applyResolutionSelectionOrderRelatedWorkarounds(List<Size> list, int i) {
        Rational rational;
