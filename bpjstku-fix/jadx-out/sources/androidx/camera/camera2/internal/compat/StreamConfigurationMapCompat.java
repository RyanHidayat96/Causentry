...
public class StreamConfigurationMapCompat {
    ...
    public Size[] getOutputSizes(int i) {
        ...
        if (outputSizes == null || outputSizes.length == 0) {
            Logger.w(TAG, "Retrieved output sizes array is null or empty for format ".concat(String.valueOf(i)));
            return outputSizes;
        }
    ...
    public <T> Size[] getOutputSizes(Class<T> cls) {
        ...
        if (outputSizes == null || outputSizes.length == 0) {
            Logger.w(TAG, "Retrieved output sizes array is null or empty for class ".concat(String.valueOf(cls)));
            return outputSizes;
        }
