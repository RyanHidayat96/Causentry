...
public final class Camera2DeviceSurfaceManager implements CameraDeviceSurfaceManager {
    ...
    @Override // androidx.camera.core.impl.CameraDeviceSurfaceManager
    public final Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecs(int i, String str, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map, boolean z, boolean z2) {
