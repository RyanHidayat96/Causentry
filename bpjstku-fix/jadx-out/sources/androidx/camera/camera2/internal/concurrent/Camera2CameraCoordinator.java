...
public class Camera2CameraCoordinator implements CameraCoordinator {
        ...
        while (it.hasNext()) {
            ...
            if (arrayList.size() >= 2) {
                ...
                try {
                    ...
                    StringBuilder sb = new StringBuilder("Concurrent camera id pair: (");
                    sb.append(str);
                    sb.append(", ");
                    sb.append(str2);
                    sb.append(") is not backward compatible");
    ...
    static /* synthetic */ List lambda$createCameraSelectorById$0(String str, List list) {
        ...
        throw new IllegalArgumentException("No camera can be find for id: ".concat(String.valueOf(str)));
    }
}
