...
final class TorchControl {
    ...
    TorchControl(Camera2CameraControlImpl camera2CameraControlImpl, CameraCharacteristicsCompat cameraCharacteristicsCompat, Executor executor) {
        ...
        camera2CameraControlImpl.addCaptureResultListener(new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.TorchControl$$ExternalSyntheticLambda1
            ...
            public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                return this.f$0.m112lambda$new$0$androidxcameracamera2internalTorchControl(totalCaptureResult);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-camera2-internal-TorchControl, reason: not valid java name */
    final /* synthetic */ boolean m112lambda$new$0$androidxcameracamera2internalTorchControl(TotalCaptureResult totalCaptureResult) {
    ...
    final ListenableFuture<Void> enableTorch(final boolean z) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.TorchControl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m111x328afed3(z, completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$enableTorch$2$androidx-camera-camera2-internal-TorchControl, reason: not valid java name */
    final /* synthetic */ Object m111x328afed3(final boolean z, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.TorchControl$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m110xbd10d892(completer, z);
            }
        });
        return "enableTorch: ".concat(String.valueOf(z));
    }

    final LiveData<Integer> getTorchState() {
        return this.mTorchState;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX INFO: renamed from: enableTorchInternal, reason: merged with bridge method [inline-methods] */
    public final void m110xbd10d892(CallbackToFutureAdapter.Completer<Void> completer, boolean z) {
        if (!this.mHasFlashUnit) {
            if (completer != null) {
