...
final class ZslControlImpl implements ZslControl {
    ...
    public final void addZslConfig(SessionConfig.Builder builder) {
        ...
        metadataImageReader.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.camera2.internal.ZslControlImpl$$ExternalSyntheticLambda2
            ...
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                this.f$0.m118xd491ced0(imageReaderProxy);
            }
    ...
    final /* synthetic */ void m118xd491ced0(ImageReaderProxy imageReaderProxy) {
        try {
            ...
            StringBuilder sb = new StringBuilder("Failed to acquire latest image IllegalStateException = ");
    ...
    public final boolean enqueueImageToImageWriter(ImageProxy imageProxy) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("enqueueImageToImageWriter throws IllegalStateException = ");
            sb.append(e2.getMessage());
            Logger.e(TAG, sb.toString());
            return false;
        }
    ...
    private Map<Integer, Size> createReprocessingInputSizeMap(CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("Failed to retrieve StreamConfigurationMap, error = ");
            sb.append(e2.getMessage());
            Logger.e(TAG, sb.toString());
