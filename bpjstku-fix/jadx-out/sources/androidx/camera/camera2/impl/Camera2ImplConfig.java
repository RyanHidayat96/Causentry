...
public final class Camera2ImplConfig extends CaptureRequestOptions {
    ...
    public static Config.Option<Object> createCaptureRequestOption(CaptureRequest.Key<?> key) {
        StringBuilder sb = new StringBuilder(CAPTURE_REQUEST_ID_STEM);
        sb.append(key.getName());
        return Config.Option.create(sb.toString(), Object.class, key);
    }
    ...
    public final long getStreamUseCase(long j) {
    ...
    public final Object getCaptureRequestTag(Object obj) {
    ...
    public static final class Builder implements ExtendableBuilder<Camera2ImplConfig> {
        ...
        public final <ValueT> Builder setCaptureRequestOption(CaptureRequest.Key<ValueT> key, ValueT valuet) {
            this.mMutableOptionsBundle.insertOption(Camera2ImplConfig.createCaptureRequestOption(key), valuet);
            return this;
        }

        /* JADX WARN: Multi-variable type inference failed */
        public final <ValueT> Builder setCaptureRequestOptionWithPriority(CaptureRequest.Key<ValueT> key, ValueT valuet, Config.OptionPriority optionPriority) {
        ...
        public final Builder insertAllOptions(Config config, Config.OptionPriority optionPriority) {
