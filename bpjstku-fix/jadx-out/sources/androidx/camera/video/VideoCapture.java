...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
        ...
        this.mStreamInfoObserver = new Observable.Observer<StreamInfo>() { // from class: androidx.camera.video.VideoCapture.1
            ...
            public void onNewData(StreamInfo streamInfo) {
                ...
                if (VideoCapture.this.mSourceState != VideoOutput.SourceState.INACTIVE) {
                    StringBuilder sb = new StringBuilder("Stream info update: old: ");
                    sb.append(VideoCapture.this.mStreamInfo);
                    sb.append(" new: ");
                    sb.append(streamInfo);
                    Logger.d(VideoCapture.TAG, sb.toString());
    ...
    public final StreamSpec onSuggestedStreamSpecUpdated(StreamSpec streamSpec, StreamSpec streamSpec2) {
        Logger.d(TAG, "onSuggestedStreamSpecUpdated: ".concat(String.valueOf(streamSpec)));
        ...
        if (customOrderedResolutions != null && !customOrderedResolutions.contains(streamSpec.getResolution())) {
            StringBuilder sb = new StringBuilder("suggested resolution ");
            sb.append(streamSpec.getResolution());
            sb.append(" is not in custom ordered resolutions ");
            sb.append(customOrderedResolutions);
    ...
    public final void onStateAttached() {
        ...
        StringBuilder sb = new StringBuilder("VideoCapture#onStateAttached: cameraID = ");
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("VideoCapture:");
        sb.append(getName());
        return sb.toString();
    }
    ...
    private SessionConfig.Builder createPipeline(final VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        StringBuilder sb = new StringBuilder("camera timebase = ");
        sb.append(cameraInternal.getCameraInfoInternal().getTimebase());
        sb.append(", processing timebase = ");
        sb.append(timebaseResolveTimebase);
        Logger.d(TAG, sb.toString());
        ...
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m258lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig, timebaseResolveTimebase);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m259lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m260lambda$createPipeline$3$androidxcameravideoVideoCapture(sessionConfig, sessionError);
            }
        });
    ...
    final /* synthetic */ void m259lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    final /* synthetic */ void m260lambda$createPipeline$3$androidxcameravideoVideoCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: onAppEdgeInvalidated, reason: merged with bridge method [inline-methods] */
    public void m258lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    final SurfaceEdge getCameraEdge() {
    ...
    static class SourceStreamRequirementObserver implements Observable.Observer<Boolean> {
        ...
        public void close() {
            ...
            StringBuilder sb = new StringBuilder("SourceStreamRequirementObserver#close: mIsSourceStreamRequired = ");
            sb.append(this.mIsSourceStreamRequired);
            Logger.d(VideoCapture.TAG, sb.toString());
    ...
    final SurfaceProcessorNode getNode() {
        return this.mNode;
    }
    ...
    private static Rect adjustCropRectToValidSize(final Rect rect, Size size, VideoEncoderInfo videoEncoderInfo) {
        ...
        Logger.d(TAG, "candidatesList = ".concat(String.valueOf(arrayList)));
        ...
        Logger.d(TAG, "sorted candidatesList = ".concat(String.valueOf(arrayList)));
    ...
    private static void addBySupportedSize(Set<Size> set, int i, int i2, Size size, VideoEncoderInfo videoEncoderInfo) {
        ...
        try {
            ...
            Logger.w(TAG, "No supportedHeights for width: ".concat(String.valueOf(i)), e2);
        }
        try {
            set.add(new Size(((Integer) videoEncoderInfo.getSupportedWidthsFor(i2).clamp(Integer.valueOf(i))).intValue(), i2));
        } catch (IllegalArgumentException e3) {
            Logger.w(TAG, "No supportedWidths for height: ".concat(String.valueOf(i2)), e3);
        }
    }

    final boolean isStreamIdChanged(int i, int i2) {
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m261xc7537f7(builder, completer);
            }
        });
    ...
    final /* synthetic */ Object m261xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i, CameraCaptureResult cameraCaptureResult) {
            ...
            if (this.mIsFirstCaptureResult) {
                ...
                StringBuilder sb = new StringBuilder("cameraCaptureResult timestampNs = ");
            ...
            scheduledExecutorServiceMainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m262lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onCaptureCompleted$0$androidx-camera-video-VideoCapture$2, reason: not valid java name */
        /* synthetic */ void m262lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
    ...
    private void updateCustomOrderedResolutionsByQuality(CameraInfoInternal cameraInfoInternal, UseCaseConfig.Builder<?, ?, ?> builder) throws IllegalArgumentException {
        ...
        StringBuilder sb = new StringBuilder("Found selectedQualities ");
        sb.append(prioritizedQualities);
        sb.append(" by ");
        sb.append(qualitySelector);
        Logger.d(TAG, sb.toString());
        ...
        Logger.d(TAG, "Set custom ordered resolutions = ".concat(String.valueOf(listFilterOutEncoderUnsupportedResolutions)));
    ...
    final void setSourceState(VideoOutput.SourceState sourceState) {
    ...
    final SurfaceRequest getSurfaceRequest() {
    ...
    public static final class Builder<T extends VideoOutput> implements UseCaseConfig.Builder<VideoCapture<T>, VideoCaptureConfig<T>, Builder<T>>, ImageOutputConfig.Builder<Builder<T>>, ImageInputConfig.Builder<Builder<T>>, ThreadConfig.Builder<Builder<T>> {
        ...
        public final /* bridge */ /* synthetic */ Object setCustomOrderedResolutions(List list) {
            return setCustomOrderedResolutions((List<Size>) list);
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final /* bridge */ /* synthetic */ Object setSupportedResolutions(List list) {
        ...
        public final VideoCaptureConfig<T> getUseCaseConfig() {
            return new VideoCaptureConfig<>(OptionsBundle.from(this.mMutableConfig));
        }

        public final Builder<T> setVideoOutput(VideoOutput videoOutput) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_VIDEO_OUTPUT, videoOutput);
            return this;
        }

        final Builder<T> setVideoEncoderInfoFinder(Function<VideoEncoderConfig, VideoEncoderInfo> function) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_VIDEO_ENCODER_INFO_FINDER, function);
            return this;
        }

        @Override // androidx.camera.core.ExtendableBuilder
        public final VideoCapture<T> build() {
            return new VideoCapture<>(getUseCaseConfig());
        }

        @Override // androidx.camera.core.internal.TargetConfig.Builder
        public final Builder<T> setTargetClass(Class<VideoCapture<T>> cls) {
        ...
        @Override // androidx.camera.core.internal.TargetConfig.Builder
        public final Builder<T> setTargetName(String str) {
            getMutableConfig().insertOption(TargetConfig.OPTION_TARGET_NAME, str);
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setTargetAspectRatio(int i) {
            throw new UnsupportedOperationException("setTargetAspectRatio is not supported.");
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setTargetRotation(int i) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_TARGET_ROTATION, Integer.valueOf(i));
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setMirrorMode(int i) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_MIRROR_MODE, Integer.valueOf(i));
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setTargetResolution(Size size) {
            throw new UnsupportedOperationException("setTargetResolution is not supported.");
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setDefaultResolution(Size size) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_DEFAULT_RESOLUTION, size);
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setMaxResolution(Size size) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_MAX_RESOLUTION, size);
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setSupportedResolutions(List<Pair<Integer, Size[]>> list) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_SUPPORTED_RESOLUTIONS, list);
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setCustomOrderedResolutions(List<Size> list) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_CUSTOM_ORDERED_RESOLUTIONS, list);
            return this;
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder<T> setResolutionSelector(ResolutionSelector resolutionSelector) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_RESOLUTION_SELECTOR, resolutionSelector);
            return this;
        }

        @Override // androidx.camera.core.impl.ImageInputConfig.Builder
        public final Builder<T> setDynamicRange(DynamicRange dynamicRange) {
            getMutableConfig().insertOption(ImageInputConfig.OPTION_INPUT_DYNAMIC_RANGE, dynamicRange);
            return this;
        }

        @Override // androidx.camera.core.internal.ThreadConfig.Builder
        public final Builder<T> setBackgroundExecutor(Executor executor) {
            getMutableConfig().insertOption(ThreadConfig.OPTION_BACKGROUND_EXECUTOR, executor);
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setDefaultSessionConfig(SessionConfig sessionConfig) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_DEFAULT_SESSION_CONFIG, sessionConfig);
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setDefaultCaptureConfig(CaptureConfig captureConfig) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_DEFAULT_CAPTURE_CONFIG, captureConfig);
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setSessionOptionUnpacker(SessionConfig.OptionUnpacker optionUnpacker) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_SESSION_CONFIG_UNPACKER, optionUnpacker);
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setCaptureOptionUnpacker(CaptureConfig.OptionUnpacker optionUnpacker) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_CAPTURE_CONFIG_UNPACKER, optionUnpacker);
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setSurfaceOccupancyPriority(int i) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_SURFACE_OCCUPANCY_PRIORITY, Integer.valueOf(i));
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setZslDisabled(boolean z) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_ZSL_DISABLED, Boolean.valueOf(z));
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setHighResolutionDisabled(boolean z) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_HIGH_RESOLUTION_DISABLED, Boolean.valueOf(z));
            return this;
        }

        public final Builder<T> setTargetFrameRate(Range<Integer> range) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_TARGET_FRAME_RATE, range);
            return this;
        }

        public final Builder<T> setVideoStabilizationEnabled(boolean z) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_VIDEO_STABILIZATION_MODE, Integer.valueOf(z ? 2 : 1));
            return this;
        }

        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder<T> setCaptureType(UseCaseConfigFactory.CaptureType captureType) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_CAPTURE_TYPE, captureType);
            return this;
        }

        public final Builder<T> setSurfaceProcessingForceEnabled() {
