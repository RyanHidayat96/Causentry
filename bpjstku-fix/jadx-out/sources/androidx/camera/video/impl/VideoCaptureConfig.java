...
public final class VideoCaptureConfig<T extends VideoOutput> implements UseCaseConfig<VideoCapture<T>>, ImageOutputConfig, ThreadConfig {
    ...
    public final Function<VideoEncoderConfig, VideoEncoderInfo> getVideoEncoderInfoFinder() {
    ...
    public final boolean isSurfaceProcessingForceEnabled() {
        return ((Boolean) Objects.requireNonNull((Boolean) retrieveOption(OPTION_FORCE_ENABLE_SURFACE_PROCESSING, Boolean.FALSE))).booleanValue();
    }
