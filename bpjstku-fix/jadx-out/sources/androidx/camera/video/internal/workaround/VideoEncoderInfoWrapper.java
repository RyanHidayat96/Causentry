...
public class VideoEncoderInfoWrapper implements VideoEncoderInfo {
    ...
    public Range<Integer> getSupportedWidthsFor(int i) {
        boolean z = this.mSupportedHeights.contains(Integer.valueOf(i)) && i % this.mVideoEncoderInfo.getHeightAlignment() == 0;
        StringBuilder sb = new StringBuilder("Not supported height: ");
        sb.append(i);
        sb.append(" which is not in ");
        sb.append(this.mSupportedHeights);
        sb.append(" or can not be divided by alignment ");
        sb.append(this.mVideoEncoderInfo.getHeightAlignment());
    ...
    public Range<Integer> getSupportedHeightsFor(int i) {
        boolean z = this.mSupportedWidths.contains(Integer.valueOf(i)) && i % this.mVideoEncoderInfo.getWidthAlignment() == 0;
        StringBuilder sb = new StringBuilder("Not supported width: ");
        sb.append(i);
        sb.append(" which is not in ");
        sb.append(this.mSupportedWidths);
        sb.append(" or can not be divided by alignment ");
        sb.append(this.mVideoEncoderInfo.getWidthAlignment());
        Preconditions.checkArgument(z, sb.toString());
        return this.mSupportedHeights;
    }
