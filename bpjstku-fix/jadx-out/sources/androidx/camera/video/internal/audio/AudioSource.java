...
public final class AudioSource {
    ...
    public final void setBufferProvider(final BufferProvider<? extends InputBuffer> bufferProvider) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m275x885db6e2(bufferProvider);
            }
        });
    }
    ...
    final /* synthetic */ void m275x885db6e2(BufferProvider bufferProvider) {
    ...
    final /* synthetic */ void m276lambda$start$1$androidxcameravideointernalaudioAudioSource() {
        start(this.mMuted);
    }
    ...
    public final void start() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m276lambda$start$1$androidxcameravideointernalaudioAudioSource();
            }
        });
    }
    ...
    public final void start(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m277lambda$start$2$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$start$2$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    final /* synthetic */ void m277lambda$start$2$androidxcameravideointernalaudioAudioSource(boolean z) {
        int iOrdinal = this.mState.ordinal();
        if (iOrdinal != 0) {
            if (iOrdinal == 2) {
                throw new AssertionError("AudioSource is released");
    ...
    public final void stop() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m278lambda$stop$3$androidxcameravideointernalaudioAudioSource();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$stop$3$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    final /* synthetic */ void m278lambda$stop$3$androidxcameravideointernalaudioAudioSource() {
        int iOrdinal = this.mState.ordinal();
        if (iOrdinal == 1) {
    ...
    final /* synthetic */ void m272xb3b7fe6a(CallbackToFutureAdapter.Completer completer) {
        try {
            int iOrdinal = this.mState.ordinal();
            if (iOrdinal == 0 || iOrdinal == 1) {
    ...
    public final void setAudioSourceCallback(final Executor executor, final AudioSourceCallback audioSourceCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m274xcbe526c1(executor, audioSourceCallback);
            }
        });
    }
    ...
    final /* synthetic */ void m274xcbe526c1(Executor executor, AudioSourceCallback audioSourceCallback) {
        int iOrdinal = this.mState.ordinal();
        if (iOrdinal == 0) {
    ...
    public final void mute(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m270lambda$mute$7$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$mute$7$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    final /* synthetic */ void m270lambda$mute$7$androidxcameravideointernalaudioAudioSource(boolean z) {
        int iOrdinal = this.mState.ordinal();
        if (iOrdinal != 0 && iOrdinal != 1) {
            if (iOrdinal == 2) {
                throw new AssertionError("AudioSource is released");
            }
        } else if (this.mMuted != z) {
            this.mMuted = z;
            ...
            this.mStateObserver = new Observable.Observer<BufferProvider.State>() { // from class: androidx.camera.video.internal.audio.AudioSource.1
                ...
                public void onNewData(BufferProvider.State state) {
                    ...
                    if (AudioSource.this.mBufferProvider == bufferProvider) {
                        StringBuilder sb = new StringBuilder("Receive BufferProvider state change: ");
                        sb.append(AudioSource.this.mBufferProviderState);
                        sb.append(" to ");
                        sb.append(state);
                        Logger.d(AudioSource.TAG, sb.toString());
    ...
    final boolean isStartRetryIntervalReached() {
    ...
    final void notifyError(final Throwable th) {
    ...
    final void notifySuspended(final boolean z) {
        Executor executor = this.mCallbackExecutor;
        final AudioSourceCallback audioSourceCallback = this.mAudioSourceCallback;
    ...
    final void overrideBySilence(ByteBuffer byteBuffer, int i) {
    ...
    final void setState(InternalState internalState) {
        StringBuilder sb = new StringBuilder("Transitioning internal state: ");
    ...
    final void postMaxAmplitude(ByteBuffer byteBuffer) {
        Executor executor = this.mCallbackExecutor;
        final AudioSourceCallback audioSourceCallback = this.mAudioSourceCallback;
        if (this.mAudioFormat == 2) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m271xdf9dee1c(audioSourceCallback);
                }
            });
        }
    }
    ...
    final /* synthetic */ void m271xdf9dee1c(AudioSourceCallback audioSourceCallback) {
