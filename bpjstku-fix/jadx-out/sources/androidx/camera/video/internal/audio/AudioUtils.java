...
public final class AudioUtils {
    ...
    public static int getBytesPerFrame(int i, int i2) {
        Preconditions.checkArgument(i2 > 0, "Invalid channel count: ".concat(String.valueOf(i2)));
        if (i == 2) {
            return i2 * 2;
        }
        if (i == 3) {
        ...
        if (i != 4) {
            ...
            if (i != 22) {
                throw new IllegalArgumentException("Invalid audio encoding: ".concat(String.valueOf(i)));
            }
        }
        return i2 * 4;
    }
