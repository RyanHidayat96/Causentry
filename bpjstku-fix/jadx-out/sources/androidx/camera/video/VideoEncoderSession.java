...
final class VideoEncoderSession {
    ...
    final ListenableFuture<Encoder> configure(final SurfaceRequest surfaceRequest, final Timebase timebase, final MediaSpec mediaSpec, final VideoValidatedEncoderProfilesProxy videoValidatedEncoderProfilesProxy) {
        if (this.mVideoEncoderState.ordinal() == 0) {
            this.mVideoEncoderState = VideoEncoderState.INITIALIZING;
            this.mSurfaceRequest = surfaceRequest;
            Logger.d(TAG, "Create VideoEncoderSession: ".concat(String.valueOf(this)));
            this.mReleasedFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoEncoderSession$$ExternalSyntheticLambda2
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m264lambda$configure$0$androidxcameravideoVideoEncoderSession(completer);
                }
            });
            this.mReadyToReleaseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoEncoderSession$$ExternalSyntheticLambda3
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m265lambda$configure$1$androidxcameravideoVideoEncoderSession(completer);
                }
            });
            ListenableFuture future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoEncoderSession$$ExternalSyntheticLambda4
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m266lambda$configure$2$androidxcameravideoVideoEncoderSession(surfaceRequest, timebase, videoValidatedEncoderProfilesProxy, mediaSpec, completer);
                }
            });
        ...
        StringBuilder sb = new StringBuilder("configure() shouldn't be called in ");
        sb.append(this.mVideoEncoderState);
        return Futures.immediateFailedFuture(new IllegalStateException(sb.toString()));
    }

    /* JADX INFO: renamed from: lambda$configure$0$androidx-camera-video-VideoEncoderSession, reason: not valid java name */
    final /* synthetic */ Object m264lambda$configure$0$androidxcameravideoVideoEncoderSession(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mReleasedCompleter = completer;
        return "ReleasedFuture ".concat(String.valueOf(this));
    }

    /* JADX INFO: renamed from: lambda$configure$1$androidx-camera-video-VideoEncoderSession, reason: not valid java name */
    final /* synthetic */ Object m265lambda$configure$1$androidxcameravideoVideoEncoderSession(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mReadyToReleaseCompleter = completer;
        return "ReadyToReleaseFuture ".concat(String.valueOf(this));
    }

    /* JADX INFO: renamed from: lambda$configure$2$androidx-camera-video-VideoEncoderSession, reason: not valid java name */
    final /* synthetic */ Object m266lambda$configure$2$androidxcameravideoVideoEncoderSession(SurfaceRequest surfaceRequest, Timebase timebase, VideoValidatedEncoderProfilesProxy videoValidatedEncoderProfilesProxy, MediaSpec mediaSpec, CallbackToFutureAdapter.Completer completer) throws Exception {
        configureVideoEncoderInternal(surfaceRequest, timebase, videoValidatedEncoderProfilesProxy, mediaSpec, completer);
        return "ConfigureVideoEncoderFuture ".concat(String.valueOf(this));
    }

    final boolean isConfiguredSurfaceRequest(SurfaceRequest surfaceRequest) {
    ...
    final void terminateNow() {
        ...
        if (iOrdinal != 1 && iOrdinal != 2 && iOrdinal != 3) {
            if (iOrdinal == 4) {
                StringBuilder sb = new StringBuilder("terminateNow in ");
                sb.append(this.mVideoEncoderState);
                sb.append(", No-op");
            ...
            sb2.append(this.mVideoEncoderState);
        ...
        if (this.mVideoEncoder != null) {
            StringBuilder sb3 = new StringBuilder("VideoEncoder is releasing: ");
            sb3.append(this.mVideoEncoder);
            ...
            this.mVideoEncoder.getReleasedFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoEncoderSession$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m269lambda$terminateNow$3$androidxcameravideoVideoEncoderSession();
                }
            }, this.mSequentialExecutor);
    ...
    final /* synthetic */ void m269lambda$terminateNow$3$androidxcameravideoVideoEncoderSession() {
        this.mReleasedCompleter.set(null);
    }

    final Surface getActiveSurface() {
    ...
    private void closeInternal() {
        ...
        if (iOrdinal == 2 || iOrdinal == 3) {
            StringBuilder sb = new StringBuilder("closeInternal in ");
            sb.append(this.mVideoEncoderState);
            sb.append(" state");
            Logger.d(TAG, sb.toString());
    ...
    final void setOnSurfaceUpdateListener(Executor executor, Encoder.SurfaceInput.OnSurfaceUpdateListener onSurfaceUpdateListener) {
            ...
            if (!(input instanceof Encoder.SurfaceInput)) {
                ...
                ((Encoder.SurfaceInput) input).setOnSurfaceUpdateListener(this.mSequentialExecutor, new Encoder.SurfaceInput.OnSurfaceUpdateListener() { // from class: androidx.camera.video.VideoEncoderSession$$ExternalSyntheticLambda0
                    ...
                    public final void onSurfaceUpdate(Surface surface) {
                        this.f$0.m268x39f4fe93(completer, surfaceRequest, surface);
                    }
                });
            }
    ...
    final /* synthetic */ void m268x39f4fe93(CallbackToFutureAdapter.Completer completer, SurfaceRequest surfaceRequest, final Surface surface) {
        Executor executor;
        int iOrdinal = this.mVideoEncoderState.ordinal();
        if (iOrdinal != 0) {
            if (iOrdinal == 1) {
                if (surfaceRequest.isServiced()) {
                    StringBuilder sb = new StringBuilder("Not provide surface, ");
                    sb.append(Objects.toString(surfaceRequest, "EMPTY"));
                    sb.append(" is already serviced.");
                    Logger.d(TAG, sb.toString());
                    completer.set(null);
                    closeInternal();
                    return;
                ...
                Logger.d(TAG, "provide surface: ".concat(String.valueOf(surface)));
                ...
                if (iOrdinal == 3) {
                    if (this.mOnSurfaceUpdateListener != null && (executor = this.mOnSurfaceUpdateExecutor) != null) {
                        executor.execute(new Runnable() { // from class: androidx.camera.video.VideoEncoderSession$$ExternalSyntheticLambda6
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.m267x54b38fd2(surface);
                            }
                        });
                    }
                    Logger.w(TAG, "Surface is updated in READY state: ".concat(String.valueOf(surface)));
                    return;
                }
                if (iOrdinal != 4) {
                    StringBuilder sb2 = new StringBuilder("State ");
        ...
        StringBuilder sb3 = new StringBuilder("Not provide surface in ");
        sb3.append(this.mVideoEncoderState);
        Logger.d(TAG, sb3.toString());
        completer.set(null);
    }
    ...
    final /* synthetic */ void m267x54b38fd2(Surface surface) {
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("VideoEncoderSession@");
        sb.append(hashCode());
        sb.append(" for ");
        sb.append(Objects.toString(this.mSurfaceRequest, "SURFACE_REQUEST_NOT_CONFIGURED"));
        return sb.toString();
    }
}
