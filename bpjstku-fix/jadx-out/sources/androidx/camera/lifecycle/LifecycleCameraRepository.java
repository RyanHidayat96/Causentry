...
final class LifecycleCameraRepository {
    ...
    final LifecycleCamera createLifecycleCamera(LifecycleOwner lifecycleOwner, CameraUseCaseAdapter cameraUseCaseAdapter) {
    ...
    final LifecycleCamera getLifecycleCamera(LifecycleOwner lifecycleOwner, CameraUseCaseAdapter.CameraId cameraId) {
    ...
    final Collection<LifecycleCamera> getLifecycleCameras() {
    ...
    final void unregisterLifecycle(LifecycleOwner lifecycleOwner) {
        synchronized (this.mLock) {
            LifecycleCameraRepositoryObserver lifecycleCameraRepositoryObserver = getLifecycleCameraRepositoryObserver(lifecycleOwner);
            if (lifecycleCameraRepositoryObserver == null) {
                return;
    ...
    final void bindToLifecycleCamera(LifecycleCamera lifecycleCamera, ViewPort viewPort, List<CameraEffect> list, Collection<UseCase> collection, CameraCoordinator cameraCoordinator) {
        synchronized (this.mLock) {
    ...
    final void setActive(LifecycleOwner lifecycleOwner) {
        synchronized (this.mLock) {
    ...
    final void setInactive(LifecycleOwner lifecycleOwner) {
        synchronized (this.mLock) {
            this.mActiveLifecycleOwners.remove(lifecycleOwner);
    ...
    static class LifecycleCameraRepositoryObserver implements LifecycleObserver {
