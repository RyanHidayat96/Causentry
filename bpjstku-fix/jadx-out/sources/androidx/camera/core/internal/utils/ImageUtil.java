...
public final class ImageUtil {
    ...
    private static byte[] cropJpegByteArray(byte[] bArr, Rect rect, int i) throws CodecFailedException {
        try {
            ...
            throw new CodecFailedException("Decode byte array failed with illegal argument.".concat(String.valueOf(e2)), CodecFailedException.FailureType.DECODE_FAILED);
        }
    }
