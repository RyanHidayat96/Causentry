...
public class ImageCaptureLatencyEstimate {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("captureLatencyMillis=");
        sb.append(this.mCaptureLatencyMillis);
        sb.append(", processingLatencyMillis=");
        sb.append(this.mProcessingLatencyMillis);
        sb.append(", totalCaptureLatencyMillis=");
        sb.append(this.mTotalCaptureLatencyMillis);
        return sb.toString();
    }
}
