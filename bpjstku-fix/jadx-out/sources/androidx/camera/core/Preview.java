...
public final class Preview extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(PreviewConfig previewConfig, StreamSpec streamSpec) {
        ...
        if (effect != null) {
            ...
            surfaceEdge.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.core.Preview$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m167lambda$createPipeline$0$androidxcameracorePreview(cameraInternal);
                }
            });
    ...
    final /* synthetic */ void m167lambda$createPipeline$0$androidxcameracorePreview(CameraInternal cameraInternal) {
    ...
    private void addCameraSurfaceAndErrorListener(SessionConfig.Builder builder, StreamSpec streamSpec) {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.Preview$$ExternalSyntheticLambda4
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m166xaf51708c(sessionConfig, sessionError);
            }
        });
    ...
    final /* synthetic */ void m166xaf51708c(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        if (getCamera() == null) {
            return;
        }
    ...
    public final SurfaceEdge getCameraEdge() {
    ...
    public static final class Builder implements UseCaseConfig.Builder<Preview, PreviewConfig, Builder>, ImageOutputConfig.Builder<Builder>, ImageInputConfig.Builder<Builder>, ThreadConfig.Builder<Builder> {
        ...
        @Override // androidx.camera.core.internal.TargetConfig.Builder
        public final Builder setTargetClass(Class<Preview> cls) {
        ...
        public final Builder setTargetFrameRate(Range<Integer> range) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_TARGET_FRAME_RATE, range);
            return this;
        }

        public final Builder setPreviewStabilizationEnabled(boolean z) {
