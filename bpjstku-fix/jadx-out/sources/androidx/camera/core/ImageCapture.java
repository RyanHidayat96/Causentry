...
public final class ImageCapture extends UseCase {
    ...
    static /* synthetic */ void lambda$new$0(ImageReaderProxy imageReaderProxy) {
        try {
            ...
            try {
                Objects.toString(imageProxyAcquireLatestImage);
    ...
    protected final UseCaseConfig<?> onMergeConfig(CameraInfoInternal cameraInfoInternal, UseCaseConfig.Builder<?, ?, ?> builder) {
        boolean zContains = cameraInfoInternal.getCameraQuirks().contains(SoftwareJpegEncodingPreferredQuirk.class);
        Boolean bool = Boolean.TRUE;
        if (zContains) {
            if (Boolean.FALSE.equals(builder.getMutableConfig().retrieveOption(ImageCaptureConfig.OPTION_USE_SOFTWARE_JPEG_ENCODER, bool))) {
    ...
    public final void setFlashMode(int i) {
        Logger.d(TAG, "setFlashMode: flashMode = ".concat(String.valueOf(i)));
        if (i != 0 && i != 1 && i != 2) {
            if (i == 3) {
                ...
                throw new IllegalArgumentException("Invalid flash mode: ".concat(String.valueOf(i)));
            }
        }
        synchronized (this.mLockedFlashMode) {
            this.mFlashMode = i;
    ...
    public final void setScreenFlash(ScreenFlash screenFlash) {
        this.mScreenFlashWrapper = ScreenFlashWrapper.from(screenFlash);
        setScreenFlashToCameraControl();
    }

    public final ScreenFlash getScreenFlash() {
    ...
    public final ResolutionInfo getResolutionInfo() {
        return getResolutionInfoInternal();
    }

    @Override // androidx.camera.core.UseCase
    protected final ResolutionInfo getResolutionInfoInternal() {
        CameraInternal camera = getCamera();
    ...
    public final void m162lambda$takePicture$1$androidxcameracoreImageCapture(final Executor executor, final OnImageCapturedCallback onImageCapturedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m162lambda$takePicture$1$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: takePicture, reason: merged with bridge method [inline-methods] */
    public final void m163lambda$takePicture$2$androidxcameracoreImageCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnImageSavedCallback onImageSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m163lambda$takePicture$2$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
                }
            });
        } else {
    ...
    static class ImageCaptureCapabilitiesImpl implements ImageCaptureCapabilities {
    ...
    private int getJpegQualityInternal() {
        ...
        StringBuilder sb = new StringBuilder("CaptureMode ");
    ...
    final boolean enforceSoftwareJpegConstraints(MutableConfig mutableConfig) {
        boolean z;
        Boolean bool = Boolean.TRUE;
        ...
        mutableConfig.insertOption(ImageCaptureConfig.OPTION_USE_SOFTWARE_JPEG_ENCODER, bool2);
        return false;
    }
    ...
    @Override // androidx.camera.core.UseCase
    protected final StreamSpec onSuggestedStreamSpecUpdated(StreamSpec streamSpec, StreamSpec streamSpec2) {
    ...
    /* JADX WARN: Code duplicated, block: B:27:0x00e1 A[PHI: r4
  0x00e1: PHI (r4v2 int) = (r4v1 int), (r4v1 int), (r4v6 int), (r4v6 int) binds: [B:6:0x0042, B:8:0x0048, B:16:0x007d, B:18:0x0083] A[DONT_GENERATE, DONT_INLINE]] */
    private SessionConfig.Builder createPipeline(String str, ImageCaptureConfig imageCaptureConfig, StreamSpec streamSpec) {
        ...
        if (!((Boolean) getCurrentConfig().retrieveOption(ImageCaptureConfig.OPTION_POSTVIEW_ENABLED, Boolean.FALSE)).booleanValue() || (sessionProcessor = getSessionProcessor()) == null) {
            ...
            if (list == null || list.isEmpty()) {
                ...
                if (resolutionSelector != null) {
                    ...
                    size2 = listSortSupportedOutputSizesByResolutionSelector.get(0);
                } else {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda1
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m161lambda$createPipeline$3$androidxcameracoreImageCapture(sessionConfig, sessionError);
            }
        });
    ...
    final /* synthetic */ void m161lambda$createPipeline$3$androidxcameracoreImageCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        if (getCamera() == null) {
            return;
        }
    ...
    private void sendInvalidCameraError(Executor executor, OnImageCapturedCallback onImageCapturedCallback, OnImageSavedCallback onImageSavedCallback) {
        StringBuilder sb = new StringBuilder("Not bound to a valid Camera [");
        sb.append(this);
        sb.append("]");
        ImageCaptureException imageCaptureException = new ImageCaptureException(4, sb.toString(), null);
    ...
    final ListenableFuture<Void> submitStillCaptureRequest(List<CaptureConfig> list) {
        Threads.checkMainThread();
    ...
    final boolean isProcessingPipelineEnabled() {
        return (this.mImagePipeline == null || this.mTakePictureManager == null) ? false : true;
    }

    final ImagePipeline getImagePipeline() {
        return this.mImagePipeline;
    }

    final TakePictureManager getTakePictureManager() {
    ...
    public final ImageCaptureLatencyEstimate getRealtimeCaptureLatencyEstimate() {
        CameraInternal camera = getCamera();
        if (camera == null) {
    ...
    public final ResolutionSelector getPostviewResolutionSelector() {
    ...
    public static final class OutputFileOptions {
        ...
        public final String toString() {
            StringBuilder sb = new StringBuilder("OutputFileOptions{mFile=");
            sb.append(this.mFile);
            sb.append(", mContentResolver=");
            sb.append(this.mContentResolver);
            sb.append(", mSaveCollection=");
            sb.append(this.mSaveCollection);
            sb.append(", mContentValues=");
            sb.append(this.mContentValues);
            sb.append(", mOutputStream=");
            sb.append(this.mOutputStream);
            sb.append(", mMetadata=");
    ...
    public static final class Metadata {
        ...
        public final String toString() {
            StringBuilder sb = new StringBuilder("Metadata{mIsReversedHorizontal=");
            sb.append(this.mIsReversedHorizontal);
            sb.append(", mIsReversedVertical=");
            sb.append(this.mIsReversedVertical);
            sb.append(", mLocation=");
    ...
    public static final class Builder implements UseCaseConfig.Builder<ImageCapture, ImageCaptureConfig, Builder>, ImageOutputConfig.Builder<Builder>, IoConfig.Builder<Builder>, ImageInputConfig.Builder<Builder> {
        ...
        public final /* bridge */ /* synthetic */ Builder setCustomOrderedResolutions(List list) {
            return setCustomOrderedResolutions((List<Size>) list);
        }

        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final /* bridge */ /* synthetic */ Builder setSupportedResolutions(List list) {
        ...
        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder setSupportedResolutions(List<Pair<Integer, Size[]>> list) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        public final Builder setCustomOrderedResolutions(List<Size> list) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_CUSTOM_ORDERED_RESOLUTIONS, list);
            return this;
        }

        @Override // androidx.camera.core.internal.TargetConfig.Builder
        public final Builder setTargetClass(Class<ImageCapture> cls) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // androidx.camera.core.impl.UseCaseConfig.Builder
        public final Builder setCaptureType(UseCaseConfigFactory.CaptureType captureType) {
        ...
        public final Builder setDynamicRange(DynamicRange dynamicRange) {
