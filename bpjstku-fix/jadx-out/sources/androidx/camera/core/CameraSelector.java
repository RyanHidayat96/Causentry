...
public final class CameraSelector {
    ...
    public final List<CameraInfo> filter(List<CameraInfo> list) {
    ...
    public final LinkedHashSet<CameraInternal> filter(LinkedHashSet<CameraInternal> linkedHashSet) {
    ...
    public final LinkedHashSet<CameraFilter> getCameraFilterSet() {
    ...
    public static final class Builder {
        ...
        public final Builder setPhysicalCameraId(String str) {
            this.mPhysicalCameraId = str;
            return this;
        }
