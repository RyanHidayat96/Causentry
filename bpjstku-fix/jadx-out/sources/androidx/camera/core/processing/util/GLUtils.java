...
public final class GLUtils {
    ...
    public static class SamplerShaderProgram extends Program2D {
        ...
        private static ShaderProvider resolveDefaultShaderProvider(DynamicRange dynamicRange, InputFormat inputFormat) {
            ...
            Preconditions.checkArgument(inputFormat != InputFormat.UNKNOWN, "No default sampler shader available for".concat(String.valueOf(inputFormat)));
    ...
    public static int loadShader(int i, String str) {
        ...
        checkGlErrorOrThrow("glCreateShader type=".concat(String.valueOf(i)));
        ...
        Logger.w(TAG, "Could not compile shader: ".concat(String.valueOf(str)));
        GLES20.glDeleteShader(iGlCreateShader);
        StringBuilder sb = new StringBuilder("Could not compile shader type ");
        sb.append(i);
        sb.append(":");
    ...
    public static Map<InputFormat, Program2D> createPrograms(DynamicRange dynamicRange, Map<InputFormat, ShaderProvider> map) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (shaderProvider != null) {
                ...
                Preconditions.checkState(inputFormat == InputFormat.UNKNOWN, "Unhandled input format: ".concat(String.valueOf(inputFormat)));
                if (dynamicRange.is10BitHdr()) {
    ...
    public static int createTexture() {
        ...
        checkGlErrorOrThrow("glBindTexture ".concat(String.valueOf(i)));
    ...
    public static void checkEglErrorOrThrow(String str) {
        ...
        sb.append(Integer.toHexString(iEglGetError));
        throw new IllegalStateException(sb.toString());
    }
    ...
    public static void checkGlErrorOrThrow(String str) {
        ...
        sb.append(Integer.toHexString(iGlGetError));
        throw new IllegalStateException(sb.toString());
    }
