...
public class InternalImageProcessor {
        ...
        try {
            return (ImageProcessor.Response) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.InternalImageProcessor$$ExternalSyntheticLambda1
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m217xe9947096(request, completer);
                }
            }).get();
        } catch (Exception e2) {
            e = e2;
    ...
    /* synthetic */ Object m217xe9947096(final ImageProcessor.Request request, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.InternalImageProcessor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m216xe85e1db7(request, completer);
            }
        });
        StringBuilder sb = new StringBuilder("InternalImageProcessor#process ");
    ...
    /* synthetic */ void m216xe85e1db7(ImageProcessor.Request request, CallbackToFutureAdapter.Completer completer) {
        try {
