...
public abstract class UseCase {
    ...
    public boolean isMirroringRequired(CameraInternal cameraInternal) {
        ...
        throw new AssertionError("Unknown mirrorMode: ".concat(String.valueOf(mirrorModeInternal)));
    }
    ...
    protected String getCameraId() {
        return ((CameraInternal) Preconditions.checkNotNull(getCamera(), "No camera attached to use case: ".concat(String.valueOf(this)))).getCameraInfoInternal().getCameraId();
    }
    ...
    public String getName() {
        ...
        sb.append(hashCode());
        sb.append(">");
        return (String) Objects.requireNonNull(useCaseConfig.getTargetName(sb.toString()));
    }
