...
public final class FocusMeteringAction {
    ...
    public final List<MeteringPoint> getMeteringPointsAf() {
        return this.mMeteringPointsAf;
    }

    public final List<MeteringPoint> getMeteringPointsAe() {
        return this.mMeteringPointsAe;
    }

    public final List<MeteringPoint> getMeteringPointsAwb() {
    ...
    public static class Builder {
        ...
        public Builder addPoint(MeteringPoint meteringPoint, int i) {
            ...
            Preconditions.checkArgument(i > 0 && i <= 7, "Invalid metering mode ".concat(String.valueOf(i)));
            if ((i & 1) != 0) {
