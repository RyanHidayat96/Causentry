...
public class QuirkSettings {
    ...
    public int hashCode() {
        boolean z = this.mEnabledWhenDeviceHasQuirk;
        return Objects.hash(Boolean.valueOf(z), this.mForceEnabledQuirks, this.mForceDisabledQuirks);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("QuirkSettings{enabledWhenDeviceHasQuirk=");
        sb.append(this.mEnabledWhenDeviceHasQuirk);
        sb.append(", forceEnabledQuirks=");
        sb.append(this.mForceEnabledQuirks);
        sb.append(", forceDisabledQuirks=");
        sb.append(this.mForceDisabledQuirks);
        sb.append('}');
        return sb.toString();
    }
