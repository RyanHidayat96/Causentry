...
public abstract class DeferrableSurface {
    ...
    public DeferrableSurface(Size size, int i) {
        ...
        ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m194lambda$new$0$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda1
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m195lambda$new$1$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        if (Logger.isDebugEnabled(TAG)) {
            ...
            future.addListener(new Runnable() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m196lambda$new$2$androidxcameracoreimplDeferrableSurface(stackTraceString);
                }
    ...
    /* synthetic */ Object m194lambda$new$0$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    /* synthetic */ Object m195lambda$new$1$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
            this.mCloseCompleter = completer;
        }
        StringBuilder sb = new StringBuilder("DeferrableSurface-close(");
        sb.append(this);
        sb.append(")");
        return sb.toString();
    }
    ...
    /* synthetic */ void m196lambda$new$2$androidxcameracoreimplDeferrableSurface(String str) {
        try {
