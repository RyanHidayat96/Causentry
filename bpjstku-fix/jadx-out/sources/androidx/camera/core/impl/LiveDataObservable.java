...
public final class LiveDataObservable<T> implements Observable<T> {
    ...
    public final ListenableFuture<T> fetchData() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda3
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m199lambda$fetchData$1$androidxcameracoreimplLiveDataObservable(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$fetchData$1$androidx-camera-core-impl-LiveDataObservable, reason: not valid java name */
    final /* synthetic */ Object m199lambda$fetchData$1$androidxcameracoreimplLiveDataObservable(final CallbackToFutureAdapter.Completer completer) throws Exception {
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m198lambda$fetchData$0$androidxcameracoreimplLiveDataObservable(completer);
            }
        });
    ...
    final /* synthetic */ void m198lambda$fetchData$0$androidxcameracoreimplLiveDataObservable(CallbackToFutureAdapter.Completer completer) {
    ...
    public final void addObserver(Executor executor, Observable.Observer<? super T> observer) {
        synchronized (this.mObservers) {
            ...
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m197xb97b3ef8(liveDataObserverAdapter, liveDataObserverAdapter2);
                }
            });
        }
    }
    ...
    final /* synthetic */ void m197xb97b3ef8(LiveDataObserverAdapter liveDataObserverAdapter, LiveDataObserverAdapter liveDataObserverAdapter2) {
        if (liveDataObserverAdapter != null) {
        ...
        synchronized (this.mObservers) {
            ...
            if (liveDataObserverAdapterRemove != null) {
                ...
                CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m200x74a0ce3a(liveDataObserverAdapterRemove);
                    }
                });
            }
        }
    ...
    final /* synthetic */ void m200x74a0ce3a(LiveDataObserverAdapter liveDataObserverAdapter) {
        this.mLiveData.removeObserver(liveDataObserverAdapter);
    }
    ...
    static final class LiveDataObserverAdapter<T> implements Observer<Result<T>> {
        ...
        public final void onChanged(final Result<T> result) {
        ...
        final /* synthetic */ void m201x31d6cb3b(Result result) {
            if (this.mActive.get()) {
