...
public final class Futures {
    ...
    static /* synthetic */ Object lambda$nonCancellationPropagating$0(ListenableFuture listenableFuture, CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        StringBuilder sb = new StringBuilder("nonCancellationPropagating[");
    ...
    static /* synthetic */ Object lambda$makeTimeoutFuture$3(final ListenableFuture listenableFuture, ScheduledExecutorService scheduledExecutorService, final long j, final CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        StringBuilder sb = new StringBuilder("TimeoutFuture[");
        sb.append(listenableFuture);
        sb.append("]");
        return sb.toString();
    }

    static /* synthetic */ Boolean lambda$makeTimeoutFuture$1(CallbackToFutureAdapter.Completer completer, ListenableFuture listenableFuture, long j) throws Exception {
        StringBuilder sb = new StringBuilder("Future[");
        sb.append(listenableFuture);
        sb.append("] is not done within ");
        sb.append(j);
        sb.append(" ms.");
        return Boolean.valueOf(completer.setException(new TimeoutException(sb.toString())));
    }
    ...
    static /* synthetic */ Object lambda$transformAsyncOnCompletion$8(ListenableFuture listenableFuture, final CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        StringBuilder sb = new StringBuilder("transformVoidFuture [");
        sb.append(listenableFuture);
        sb.append("]");
        return sb.toString();
    }
