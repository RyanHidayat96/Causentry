...
public class TransformUtils {
    ...
    public static Size rotateSize(Size size, int i) {
        Preconditions.checkArgument(i % 90 == 0, "Invalid rotation degrees: ".concat(String.valueOf(i)));
    ...
    public static float calculateSignedAngle(float f, float f2, float f3, float f4) {
        ...
        return (float) Math.toDegrees(Math.atan2(((double) ((f * f4) - (f2 * f3))) / dSqrt, ((double) ((f * f3) + (f2 * f4))) / dSqrt));
    }
    ...
    public static boolean is90or270(int i) {
        ...
        throw new IllegalArgumentException("Invalid rotation degrees: ".concat(String.valueOf(i)));
    }
