...
public final class Exif {
    ...
    public final String toString() {
        ...
        boolean zIsFlippedVertically = isFlippedVertically();
        boolean zIsFlippedHorizontally = isFlippedHorizontally();
        Location location = getLocation();
        long timestamp = getTimestamp();
        return String.format(locale, "Exif{width=%s, height=%s, rotation=%d, isFlippedVertically=%s, isFlippedHorizontally=%s, location=%s, timestamp=%s, description=%s}", Integer.valueOf(width), Integer.valueOf(height), Integer.valueOf(rotation), Boolean.valueOf(zIsFlippedVertically), Boolean.valueOf(zIsFlippedHorizontally), location, Long.valueOf(timestamp), getDescription());
    }
    ...
    public final void rotate(int i) {
        if (i % 90 != 0) {
            ...
            this.mExifInterface.setAttribute(ExifInterface.TAG_ORIENTATION, "0");
            return;
        }
        int i2 = i % 360;
        int orientation = getOrientation();
