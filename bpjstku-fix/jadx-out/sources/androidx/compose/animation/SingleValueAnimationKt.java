...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m435animateColorAsStateeuL9pac(long j, AnimationSpec<Color> animationSpec, String str, Function1<? super Color, Unit> function1, Composer composer, int i, int i2) {
        ...
        boolean zChanged = composer.changed(Color.m4222getColorSpaceimpl(j));
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4222getColorSpaceimpl(j));
            composer.updateRememberedValue(objRememberedValue);
        }
        int i3 = i << 6;
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m4208boximpl(j), (TwoWayConverter) objRememberedValue, animationSpec2, null, str2, function2, composer, (i3 & 458752) | ((i << 3) & 896) | (i & 14) | (57344 & i3), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m434animateColorAsStateKTwxG1Y(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        if ((i2 & 2) != 0) {
        ...
        State<Color> stateM435animateColorAsStateeuL9pac = m435animateColorAsStateeuL9pac(j, animationSpec2, null, function2, composer, (i & 126) | ((i << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public static final Animatable<Color, AnimationVector4D> m433Animatable8_81llA(long j) {
        return new Animatable<>(Color.m4208boximpl(j), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4222getColorSpaceimpl(j)), null, null, 12, null);
    }
}
