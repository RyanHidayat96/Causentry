...
final class InfiniteTransition$run$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code duplicated, block: B:11:0x003f A[PHI: r1 r4
 ...
 binds: [B:10:0x002e, B:14:0x005e, B:16:0x0080, B:6:0x000e] A[DONT_GENERATE, DONT_INLINE]
  0x003f: PHI (r4v3 kotlinx.coroutines.CoroutineScope) = 
  (r4v1 kotlinx.coroutines.CoroutineScope)
  (r4v2 kotlinx.coroutines.CoroutineScope)
  (r4v2 kotlinx.coroutines.CoroutineScope)
  (r4v7 kotlinx.coroutines.CoroutineScope)
 binds: [B:10:0x002e, B:14:0x005e, B:16:0x0080, B:6:0x000e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:13:0x0059 A[PHI: r1 r4
  0x0059: PHI (r1v2 kotlin.jvm.internal.Ref$FloatRef) = (r1v3 kotlin.jvm.internal.Ref$FloatRef), (r1v5 kotlin.jvm.internal.Ref$FloatRef) binds: [B:12:0x0057, B:9:0x0022] A[DONT_GENERATE, DONT_INLINE]
  0x0059: PHI (r4v2 kotlinx.coroutines.CoroutineScope) = (r4v3 kotlinx.coroutines.CoroutineScope), (r4v5 kotlinx.coroutines.CoroutineScope) binds: [B:12:0x0057, B:9:0x0022] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:15:0x0060  */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:14:0x005e -> B:11:0x003f). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x0080 -> B:11:0x003f). Please report as a decompilation issue!!! */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r8) {
        ...
        L3f:
            ...
            r7.L$1 = r1
            r7.label = r3
            java.lang.Object r8 = androidx.compose.animation.core.InfiniteAnimationPolicyKt.withInfiniteAnimationFrameNanos(r8, r5)
            if (r8 == r0) goto L82
        L59:
            float r8 = r1.element
            r5 = 0
            ...
            clampVideoBitrateIfNotSupported r8 = androidx.compose.runtime.SnapshotStateKt.snapshotFlow(r8)
            ...
            r7.L$1 = r1
            r7.label = r2
            java.lang.Object r8 = defpackage.hasEndOfStreamFlag.TuitionPaymentFragmentspecialinlinedviewModeldefault3(r8, r5, r6)
            if (r8 != r0) goto L3f
        L82:
            return r0
        */
    ...
    static final class AnonymousClass3 extends SuspendLambda implements Function2<Float, Continuation<? super Boolean>, Object> {
        ...
        public final /* bridge */ /* synthetic */ Object invoke(Float f, Continuation<? super Boolean> continuation) {
