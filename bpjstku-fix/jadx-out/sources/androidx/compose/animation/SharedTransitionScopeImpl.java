...
public final class SharedTransitionScopeImpl implements SharedTransitionScope, LookaheadScope {
    ...
    private final Function1<SharedTransitionScope, Unit> updateTransitionActiveness = new Function1<SharedTransitionScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeImpl.updateTransitionActiveness.1
        ...
        public final /* bridge */ /* synthetic */ Unit invoke(SharedTransitionScope sharedTransitionScope) {
    ...
    @Override // androidx.compose.animation.SharedTransitionScope
    public final Modifier skipToLookaheadSize(Modifier modifier) {
        return modifier.then(new SkipToLookaheadElement(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    @Override // androidx.compose.animation.SharedTransitionScope
    public final Modifier renderInSharedTransitionScopeOverlay(Modifier modifier, Function0<Boolean> function0, float f, Function2<? super LayoutDirection, ? super Density, ? extends Path> function2) {
        return modifier.then(new RenderInTransitionOverlayNodeElement(this, function0, f, function2));
    }

    @Override // androidx.compose.animation.SharedTransitionScope
    public final Modifier sharedElement(Modifier modifier, SharedTransitionScope.SharedContentState sharedContentState, AnimatedVisibilityScope animatedVisibilityScope, BoundsTransform boundsTransform, SharedTransitionScope.PlaceHolderSize placeHolderSize, boolean z, float f, SharedTransitionScope.OverlayClip overlayClip) {
    ...
    public final Modifier sharedBounds(Modifier modifier, final SharedTransitionScope.SharedContentState sharedContentState, final AnimatedVisibilityScope animatedVisibilityScope, final EnterTransition enterTransition, final ExitTransition exitTransition, BoundsTransform boundsTransform, final SharedTransitionScope.ResizeMode resizeMode, SharedTransitionScope.PlaceHolderSize placeHolderSize, boolean z, float f, SharedTransitionScope.OverlayClip overlayClip) {
        return ComposedModifierKt.composed$default(sharedBoundsImpl(modifier, sharedContentState, animatedVisibilityScope.getTransition(), new Function1<EnterExitState, Boolean>() { // from class: androidx.compose.animation.SharedTransitionScopeImpl.sharedBounds.1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                StringBuilder sb = new StringBuilder("enter/exit for ");
                sb.append(sharedContentState.getKey());
                Modifier modifierCreateModifier = EnterExitTransitionKt.createModifier(transition, enterTransition2, exitTransition2, (Function0) objRememberedValue, sb.toString(), composer, 0, 0);
    ...
    @Override // androidx.compose.animation.SharedTransitionScope
    public final Modifier sharedElementWithCallerManagedVisibility(Modifier modifier, SharedTransitionScope.SharedContentState sharedContentState, final boolean z, BoundsTransform boundsTransform, SharedTransitionScope.PlaceHolderSize placeHolderSize, boolean z2, float f, SharedTransitionScope.OverlayClip overlayClip) {
    ...
    @Override // androidx.compose.animation.SharedTransitionScope
    public final SharedTransitionScope.OverlayClip OverlayClip(Shape clipShape) {
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x0052 A[LOOP:0: B:5:0x001a->B:17:0x0052, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:36:0x00a8 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:37:0x00aa A[LOOP:2: B:26:0x0071->B:37:0x00aa, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:57:0x0055 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:64:0x00af A[EDGE_INSN: B:64:0x00af->B:38:0x00af BREAK  A[LOOP:2: B:26:0x0071->B:37:0x00aa], SYNTHETIC] */
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.animation.SharedTransitionScopeImpl.sharedBoundsImpl.1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                if (transition != 0) {
                    ...
                    boolean zBooleanValue = function2.invoke((T) objRememberedValue2).booleanValue();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    composer.endReplaceGroup();
                    ...
                    boolean zBooleanValue2 = function2.invoke((T) targetState).booleanValue();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    composer.endReplaceGroup();
                    transitionRememberTransition = androidx.compose.animation.core.TransitionKt.createChildTransitionInternal(transition2, Boolean.valueOf(zBooleanValue), Boolean.valueOf(zBooleanValue2), string, composer, 0);
                    composer.endReplaceGroup();
                } else {
                    composer.startReplaceGroup(1735245009);
                    Function1<T, Boolean> function3 = function1;
                    Intrinsics.checkNotNull(function3, "");
                    boolean zBooleanValue3 = ((Boolean) ((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 1)).invoke(Unit.INSTANCE)).booleanValue();
    ...
    /* JADX INFO: renamed from: getNullableLookaheadRoot$animation_release, reason: from getter */
    ...
    public final void onStateRemoved$animation_release(SharedElementInternalState sharedElementState) {
        ...
        if (sharedElement.getStates().isEmpty()) {
            b.TuitionPaymentFragmentbindingInflater1(sharedElement.getScope().coroutineScope, null, null, new SharedTransitionScopeImpl$onStateRemoved$1$1(sharedElement, null), 3, null);
        }
    }
    ...
    static final class ShapeBasedClip implements SharedTransitionScope.OverlayClip {
        ...
        public final Path getClipPath(SharedTransitionScope.SharedContentState p0, Rect p1, LayoutDirection p2, Density p3) {
            this.path.reset();
            OutlineKt.addOutline(this.path, this.clipShape.mo605createOutlinePq9zytI(p1.m4007getSizeNHjbRc(), p2, p3));
            this.path.mo4111translatek4lQ0M(p1.m4009getTopLeftF1C5BW0());
            return this.path;
        }
    }
    ...
    public final long mo430localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        return this.$$delegate_0.mo430localLookaheadPositionOfauaQtc(layoutCoordinates, layoutCoordinates2, j, z);
    }
