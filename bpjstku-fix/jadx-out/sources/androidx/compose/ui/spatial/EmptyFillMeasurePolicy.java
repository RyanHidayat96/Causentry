...
final class EmptyFillMeasurePolicy implements MeasurePolicy {
    ...
    public final MeasureResult mo359measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6888getMaxWidthimpl(j), Constraints.m6887getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.spatial.EmptyFillMeasurePolicy$measure$1
