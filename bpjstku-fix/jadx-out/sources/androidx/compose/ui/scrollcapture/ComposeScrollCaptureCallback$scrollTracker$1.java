...
final class ComposeScrollCaptureCallback$scrollTracker$1 extends SuspendLambda implements Function2<Float, Continuation<? super Float>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (scrollCaptureScrollByAction != null) {
                ...
                Offset offsetM3963boximpl = Offset.m3963boximpl(Offset.m3966constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(f)) & 4294967295L)));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                obj = scrollCaptureScrollByAction.invoke(offsetM3963boximpl, this);
        ...
        long jM3984unboximpl = ((Offset) obj).m3984unboximpl();
        return Boxing.boxFloat(z ? -Float.intBitsToFloat((int) (jM3984unboximpl & 4294967295L)) : Float.intBitsToFloat((int) (jM3984unboximpl & 4294967295L)));
    }
    ...
    public final /* bridge */ /* synthetic */ Object invoke(Float f, Continuation<? super Float> continuation) {
