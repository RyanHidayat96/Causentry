...
final class DrawWithContentElement extends ModifierNodeElement<DrawWithContentModifier> {
    ...
    public final DrawWithContentModifier getNode() {
        return new DrawWithContentModifier(this.onDraw);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public final void update(DrawWithContentModifier p0) {
    ...
    public final boolean equals(Object p0) {
        ...
        return (p0 instanceof DrawWithContentElement) && this.onDraw == ((DrawWithContentElement) p0).onDraw;
    }
