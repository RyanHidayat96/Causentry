...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    public final void update(Shape p0, Function1<? super DropShadowScope, Unit> p1) {
        this.shape = p0;
        setBlock(p1);
    }
    ...
    public final boolean equals(Object p0) {
        ...
        if (p0 != null && (p0 instanceof BlockDropShadowNode)) {
            BlockDropShadowNode blockDropShadowNode = (BlockDropShadowNode) p0;
            return getAlpha() == blockDropShadowNode.getAlpha() && Intrinsics.areEqual(this.shape, blockDropShadowNode.shape) && this.block == blockDropShadowNode.block && getRadius() == blockDropShadowNode.getRadius() && getSpread() == blockDropShadowNode.getSpread() && Offset.m3971equalsimpl0(getOffset(), blockDropShadowNode.getOffset()) && Color.m4219equalsimpl0(getColor(), blockDropShadowNode.getColor()) && Intrinsics.areEqual(getBrush(), blockDropShadowNode.getBrush()) && BlendMode.m4128equalsimpl0(getBlendMode(), blockDropShadowNode.getBlendMode());
        }
        return false;
    }
