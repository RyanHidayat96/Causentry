...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bg\u0018\u0000 \t2\u00020\u0001:\u0001\tJ\u001f\u0010\b\u001a\u00020\u00052\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0002H&¢\u0006\u0004\b\u0006\u0010\u0007ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001À\u0006\u0001"}, d2 = {"Landroidx/compose/ui/layout/ContentScale;", "", "Landroidx/compose/ui/geometry/Size;", "p0", "p1", "Landroidx/compose/ui/layout/ScaleFactor;", "computeScaleFactor-H7hwNQA", "(JJ)J", "computeScaleFactor", "Companion"}, k = 1, mv = {2, 0, 0}, xi = 48)
public interface ContentScale {
    ...
    long mo5630computeScaleFactorH7hwNQA(long p0, long p1);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public final long mo5630computeScaleFactorH7hwNQA(long p0, long p1) {
                float fM5634computeFillMaxDimensioniLBOSCw = ContentScaleKt.m5634computeFillMaxDimensioniLBOSCw(p0, p1);
                return ScaleFactor.m5721constructorimpl((((long) Float.floatToRawIntBits(fM5634computeFillMaxDimensioniLBOSCw)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(fM5634computeFillMaxDimensioniLBOSCw))));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public final long mo5630computeScaleFactorH7hwNQA(long p0, long p1) {
                float fM5635computeFillMinDimensioniLBOSCw = ContentScaleKt.m5635computeFillMinDimensioniLBOSCw(p0, p1);
                return ScaleFactor.m5721constructorimpl((((long) Float.floatToRawIntBits(fM5635computeFillMinDimensioniLBOSCw)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(fM5635computeFillMinDimensioniLBOSCw))));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public final long mo5630computeScaleFactorH7hwNQA(long p0, long p1) {
                float fIntBitsToFloat = Float.intBitsToFloat((int) (p1 & 4294967295L)) / Float.intBitsToFloat((int) (p0 & 4294967295L));
                return ScaleFactor.m5721constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat)) & 4294967295L));
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public final long mo5630computeScaleFactorH7hwNQA(long p0, long p1) {
                if (Float.intBitsToFloat((int) (p0 >> 32)) > Float.intBitsToFloat((int) (p1 >> 32)) || Float.intBitsToFloat((int) (p0 & 4294967295L)) > Float.intBitsToFloat((int) (p1 & 4294967295L))) {
                    float fM5635computeFillMinDimensioniLBOSCw = ContentScaleKt.m5635computeFillMinDimensioniLBOSCw(p0, p1);
                    return ScaleFactor.m5721constructorimpl((((long) Float.floatToRawIntBits(fM5635computeFillMinDimensioniLBOSCw)) << 32) | (((long) Float.floatToRawIntBits(fM5635computeFillMinDimensioniLBOSCw)) & 4294967295L));
                }
                return ScaleFactor.m5721constructorimpl((((long) Float.floatToRawIntBits(1.0f)) << 32) | (((long) Float.floatToRawIntBits(1.0f)) & 4294967295L));
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public final long mo5630computeScaleFactorH7hwNQA(long p0, long p1) {
                float fIntBitsToFloat = Float.intBitsToFloat((int) (p1 >> 32)) / Float.intBitsToFloat((int) (p0 >> 32));
                float fIntBitsToFloat2 = Float.intBitsToFloat((int) (p1 & 4294967295L)) / Float.intBitsToFloat((int) (p0 & 4294967295L));
                return ScaleFactor.m5721constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat2)) & 4294967295L));
            }
        };
