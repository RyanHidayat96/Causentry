...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5782requireCoordinator64DMado(node, NodeKind.m5928constructorimpl(8)));
        }
        return DelegatableNodeKt.m5782requireCoordinator64DMado(node, NodeKind.m5928constructorimpl(8)).touchBoundsInRoot();
    }
}
