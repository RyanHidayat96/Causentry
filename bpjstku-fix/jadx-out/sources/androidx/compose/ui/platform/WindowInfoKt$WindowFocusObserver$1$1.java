...
final class WindowInfoKt$WindowFocusObserver$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            clampVideoBitrateIfNotSupported clampvideobitrateifnotsupportedSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Boolean>() { // from class: androidx.compose.ui.platform.WindowInfoKt$WindowFocusObserver$1$1.1
            ...
            this.label = 1;
            if (clampvideobitrateifnotsupportedSnapshotFlow.collect(new addSignalEosTimeoutIfNeeded() { // from class: androidx.compose.ui.platform.WindowInfoKt$WindowFocusObserver$1$1.2
