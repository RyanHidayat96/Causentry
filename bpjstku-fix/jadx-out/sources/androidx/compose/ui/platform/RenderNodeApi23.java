...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m4309getAutoNrFUSI();
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6117applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.INSTANCE.m4311getOffscreenNrFUSI());
        } else {
            m6117applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }
    ...
    private final void m6117applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        ...
        if (CompositingStrategy.m4305equalsimpl0(i, CompositingStrategy.INSTANCE.m4310getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4305equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4311getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    @Override // androidx.compose.ui.platform.DeviceRenderNode
    public final void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m4189clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\"\u0010\u0005\u001a\u00020\u00048\u0001@\u0001X\u0080\u000e¢\u0006\u0012\n\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u0016\u0010\u000b\u001a\u00020\u00048\u0002@\u0002X\u0083\u000e¢\u0006\u0006\n\u0004\b\u000b\u0010\u0006"}, d2 = {"Landroidx/compose/ui/platform/RenderNodeApi23$Companion;", "", "<init>", "()V", "", "testFailCreateRenderNode", "Z", "getTestFailCreateRenderNode$ui_release", "()Z", "setTestFailCreateRenderNode$ui_release", "(Z)V", "needToValidateAccess"}, k = 1, mv = {2, 0, 0}, xi = 48)
