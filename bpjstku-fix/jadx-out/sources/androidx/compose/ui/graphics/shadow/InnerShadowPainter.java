...
public final class InnerShadowPainter extends Painter {
    ...
    public final void onDraw(DrawScope drawScope) {
        this.renderCreator.mo4925obtainInnerShadowRenderereZhPAX0(this.shape, drawScope.mo4798getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow).m4946drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo4798getSizeNHjbRc(), this.shadow.getColor(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.getBlendMode());
    }
