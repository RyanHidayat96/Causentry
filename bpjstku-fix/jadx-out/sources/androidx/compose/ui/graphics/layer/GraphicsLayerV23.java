...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m7111getZeroYbymL2g();
        ...
        renderNodeCreate.setClipToBounds(false);
        m4913applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4878getAutoke2Ky5w());
    ...
    private final void m4913applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m4874equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4880getOffscreenke2Ky5w())) {
            renderNode.setLayerType(2);
            renderNode.setLayerPaint(this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4874equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4879getModulateAlphake2Ky5w())) {
    ...
    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m4874equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4880getOffscreenke2Ky5w()) && BlendMode.m4128equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4159getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4913applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4880getOffscreenke2Ky5w());
        } else {
            m4913applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public final void mo4906setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m4272toArgb8_81llA(j));
        }
    }
    ...
    public final void mo4912setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m4272toArgb8_81llA(j));
        }
    }
    ...
    public final void mo4911setPositionH0pRuoY(int x, int y, long size) {
        int i = (int) (size >> 32);
        int i2 = (int) (4294967295L & size);
        this.renderNode.setLeftTopRightBottom(x, y, x + i, y + i2);
        if (IntSize.m7104equalsimpl0(this.size, size)) {
            return;
        }
    ...
    public final void mo4909setOutlineO0kMr_c(Outline outline, long outlineSize) {
    ...
    @Override // androidx.compose.ui.graphics.layer.GraphicsLayerImpl
    public final void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
    ...
    public final void draw(androidx.compose.ui.graphics.Canvas canvas) {
        ...
        Intrinsics.checkNotNull(nativeCanvas, "");
    ...
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\"\u0010\u0005\u001a\u00020\u00048\u0001@\u0001X\u0080\u000e¢\u0006\u0012\n\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u0014\u0010\f\u001a\u00020\u000b8\u0002X\u0083\u0004¢\u0006\u0006\n\u0004\b\f\u0010\r"}, d2 = {"Landroidx/compose/ui/graphics/layer/GraphicsLayerV23$Companion;", "", "<init>", "()V", "", "testFailCreateRenderNode", "Z", "getTestFailCreateRenderNode$ui_graphics_release", "()Z", "setTestFailCreateRenderNode$ui_graphics_release", "(Z)V", "Ljava/util/concurrent/atomic/AtomicBoolean;", "needToValidateAccess", "Ljava/util/concurrent/atomic/AtomicBoolean;"}, k = 1, mv = {2, 0, 0}, xi = 48)
