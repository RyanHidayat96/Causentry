...
public final class RippleKt {
    ...
    public static final Indication m1744rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4208boximpl(j), composer, (i >> 6) & 14);
        Dp dpM6933boximpl = Dp.m6933boximpl(f);
        composer.startReplaceableGroup(511388516);
        boolean zChanged = composer.changed(Boolean.valueOf(z));
        boolean zChanged2 = composer.changed(dpM6933boximpl);
