...
public final class EffectsKt {
    ...
    public static final CoroutineScope createCompositionCoroutineScope(CoroutineContext coroutineContext, Composer composer) {
        if (coroutineContext.get(VideoMimeInfoBuilder.b) != null) {
            SizeCannotEncodeVideoQuirk sizeCannotEncodeVideoQuirkTuitionPaymentFragmentspecialinlinedviewModeldefault3 = VideoMimeInfo.TuitionPaymentFragmentspecialinlinedviewModeldefault3((VideoMimeInfoBuilder) null);
            sizeCannotEncodeVideoQuirkTuitionPaymentFragmentspecialinlinedviewModeldefault3.b(new IllegalArgumentException("CoroutineContext supplied to rememberCoroutineScope may not include a parent job"));
            return CoroutineScopeKt.CoroutineScope(sizeCannotEncodeVideoQuirkTuitionPaymentFragmentspecialinlinedviewModeldefault3);
        }
