...
final class SnapshotStateKt__SnapshotFlowKt$collectAsState$1$1<R> extends SuspendLambda implements Function2<ProduceStateScope<R>, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ clampVideoBitrateIfNotSupported<T> $this_collectAsState;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: Code restructure failed: missing block: B:13:0x003e, code lost:
    
        if (r1.collect((defpackage.addSignalEosTimeoutIfNeeded<? super T>) r2, r6) == r0) goto L17;
     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0056, code lost:
    
        if (kotlinx.coroutines.BuildersKt.TuitionPaymentFragmentbindingInflater1(r6.$context, new androidx.compose.runtime.SnapshotStateKt__SnapshotFlowKt$collectAsState$1$1.AnonymousClass2(r6.$this_collectAsState, r7, null), r6) == r0) goto L17;
     */
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r7) {
        ...
        L1b:
            ...
            if (r1 == 0) goto L41
            clampVideoBitrateIfNotSupported<T> r1 = r6.$this_collectAsState
        ...
        L41:
            ...
            clampVideoBitrateIfNotSupported<T> r4 = r6.$this_collectAsState
            r5 = 0
            r3.<init>(r4, r7, r5)
            ...
            kotlin.coroutines.Continuation r7 = (kotlin.coroutines.Continuation) r7
            r6.label = r2
            java.lang.Object r7 = kotlinx.coroutines.BuildersKt.TuitionPaymentFragmentbindingInflater1(r1, r3, r7)
            if (r7 != r0) goto L59
        L58:
            return r0
        L59:
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                clampVideoBitrateIfNotSupported<T> clampvideobitrateifnotsupported = this.$this_collectAsState;
                final ProduceStateScope<R> produceStateScope = this.$$this$produceState;
                addSignalEosTimeoutIfNeeded addsignaleostimeoutifneeded = new addSignalEosTimeoutIfNeeded() { // from class: androidx.compose.runtime.SnapshotStateKt__SnapshotFlowKt.collectAsState.1.1.2.1
        ...
        AnonymousClass2(clampVideoBitrateIfNotSupported<? extends T> clampvideobitrateifnotsupported, ProduceStateScope<R> produceStateScope, Continuation<? super AnonymousClass2> continuation) {
            super(2, continuation);
            this.$this_collectAsState = clampvideobitrateifnotsupported;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    SnapshotStateKt__SnapshotFlowKt$collectAsState$1$1(CoroutineContext coroutineContext, clampVideoBitrateIfNotSupported<? extends T> clampvideobitrateifnotsupported, Continuation<? super SnapshotStateKt__SnapshotFlowKt$collectAsState$1$1> continuation) {
        super(2, continuation);
