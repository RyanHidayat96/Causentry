...
public interface ImmutableList<E> extends List<E>, ImmutableCollection<E>, KMappedMarker {
    ...
    static final class SubList<E> extends AbstractList<E> implements ImmutableList<E> {
        ...
        public final E get(int p0) {
            ListImplementation.checkElementIndex$runtime(p0, this._size);
            return this.source.get(this.fromIndex + p0);
        }
        ...
        public final ImmutableList<E> subList(int p0, int p1) {
            ListImplementation.checkRangeIndexes$runtime(p0, p1, this._size);
            ImmutableList<E> immutableList = this.source;
            int i = this.fromIndex;
            return new SubList(immutableList, p0 + i, i + p1);
        }
    }
}
