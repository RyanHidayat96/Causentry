...
public final class SelectableChipElevation {
    ...
    public final float m2368tonalElevationu2uoSUM$material3_release(boolean enabled) {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1888175651, i, -1, "androidx.compose.material3.SelectableChipElevation.shadowElevation (Chip.kt:2249)");
        }
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(664514136, i, -1, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:2257)");
        }
        composer.startReplaceableGroup(-699454882);
        ...
        composer.endReplaceableGroup();
        composer.startReplaceableGroup(-699454804);
        ...
        composer.endReplaceableGroup();
        composer.startReplaceableGroup(-699454714);
        boolean z2 = true;
        ...
        float f2 = f;
        composer.startReplaceableGroup(-699452729);
        Object objRememberedValue4 = composer.rememberedValue();
        if (objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue4 = new Animatable(Dp.m6933boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
            composer.updateRememberedValue(objRememberedValue4);
        }
        Animatable animatable = (Animatable) objRememberedValue4;
        composer.endReplaceableGroup();
        Dp dpM6933boximpl = Dp.m6933boximpl(f2);
        composer.startReplaceableGroup(-699452645);
        ...
        if ((zChangedInstance | zChanged | z2 | zChangedInstance2) || objRememberedValue5 == Composer.INSTANCE.getEmpty()) {
        ...
        composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect(dpM6933boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue5, composer, 0);
    ...
    public final boolean equals(Object other) {
        ...
        return Dp.m6940equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m6940equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m6940equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m6940equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m6940equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public final int hashCode() {
        int iM6941hashCodeimpl = Dp.m6941hashCodeimpl(this.elevation);
