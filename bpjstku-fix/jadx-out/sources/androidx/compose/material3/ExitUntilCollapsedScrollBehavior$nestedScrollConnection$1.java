...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public final long mo1078onPreScrollOzD1aCk(long p0, int p1) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m3975getYimpl(p0) > 0.0f) {
    ...
    public final long mo804onPostScrollDzOQY0M(long p0, long p1, int p2) {
        ...
        if (Offset.m3975getYimpl(p1) < 0.0f || Offset.m3975getYimpl(p0) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3975getYimpl(p0));
        ...
        if (Offset.m3975getYimpl(p1) > 0.0f) {
            float heightOffset2 = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3975getYimpl(p1));
    ...
    public final Object mo803onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        Object objMo803onPostFlingRZ2iAVY = exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.label;
        if (i == 0) {
            ...
            objMo803onPostFlingRZ2iAVY = super.mo803onPostFlingRZ2iAVY(j, j2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1);
        ...
        objMo803onPostFlingRZ2iAVY = AppBarKt.settleAppBar(state, fM7174getYimpl, flingAnimationSpec, snapAnimationSpec, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1);
        if (objMo803onPostFlingRZ2iAVY != coroutine_suspended) {
            j3 = packedValue;
            return Velocity.m7164boximpl(Velocity.m7177plusAH228Gc(j3, ((Velocity) objMo803onPostFlingRZ2iAVY).getPackedValue()));
        }
