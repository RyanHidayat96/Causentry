...
final /* data */ class FadeInFadeOutAnimationItem<T> {
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("FadeInFadeOutAnimationItem(key=");
        sb.append(this.key);
