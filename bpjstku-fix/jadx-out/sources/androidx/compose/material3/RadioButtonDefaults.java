...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m2300colorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RadioButtonColors radioButtonColorsM2295copyjRlVdoo = getDefaultRadioButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2295copyjRlVdoo(jM4254getUnspecified0d7_KjU, jM4254getUnspecified0d7_KjU2, jM4254getUnspecified0d7_KjU3, jM4254getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return radioButtonColorsM2295copyjRlVdoo;
    }
