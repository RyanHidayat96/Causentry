...
public final class TooltipDefaults {
    ...
    private static final CaretProperties caretProperties = new CaretProperties(Dp.m6935constructorimpl(8.0f), Dp.m6935constructorimpl(16.0f), null);
    ...
    public final RichTooltipColors m2796richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors richTooltipColorsM2303copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2303copyjRlVdoo(jM4254getUnspecified0d7_KjU, jM4254getUnspecified0d7_KjU2, jM4254getUnspecified0d7_KjU3, jM4254getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return richTooltipColorsM2303copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m2794rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        final int iMo688roundToPx0680j_4 = ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).mo688roundToPx0680j_4(f);
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public final long mo666calculatePositionllwVHH4(IntRect p0, long p1, LayoutDirection p2, long p3) {
                    int left = p0.getLeft();
                    int width = (p0.getWidth() - IntSize.m7106getWidthimpl(p3)) / 2;
                    int top = (p0.getTop() - IntSize.m7105getHeightimpl(p3)) - iMo688roundToPx0680j_4;
                    if (top < 0) {
                        top = iMo688roundToPx0680j_4 + p0.getBottom();
                    }
                    return IntOffsetKt.IntOffset(left + width, top);
                }
            };
    ...
    public final PopupPositionProvider m2795rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                /* JADX INFO: renamed from: calculatePosition-llwVHH4 */
                public final long mo666calculatePositionllwVHH4(IntRect p0, long p1, LayoutDirection p2, long p3) {
                    int right = p0.getRight();
                    if (IntSize.m7106getWidthimpl(p3) + right > IntSize.m7106getWidthimpl(p1) && (right = p0.getLeft() - IntSize.m7106getWidthimpl(p3)) < 0) {
                        right = p0.getLeft() + ((p0.getWidth() - IntSize.m7106getWidthimpl(p3)) / 2);
                    }
                    int top = (p0.getTop() - IntSize.m7105getHeightimpl(p3)) - iMo688roundToPx0680j_4;
                    if (top < 0) {
                        top = iMo688roundToPx0680j_4 + p0.getBottom();
