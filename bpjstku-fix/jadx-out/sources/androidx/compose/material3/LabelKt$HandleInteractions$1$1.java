...
final class LabelKt$HandleInteractions$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object objCollect = hasEndOfStreamFlag.TuitionPaymentFragmentspecialinlinedviewModeldefault1(lambdarequestKeyFrame8androidxcameravideointernalencoderEncoderImpl.TuitionPaymentFragmentspecialinlinedviewModeldefault1(interactions, anonymousClass1), 0, BufferOverflow.SUSPEND).collect(createPersistentInputSurface.INSTANCE, this);
