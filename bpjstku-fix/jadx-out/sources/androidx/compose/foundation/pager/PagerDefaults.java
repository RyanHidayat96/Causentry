...
public final class PagerDefaults {
    ...
    public final TargetedFlingBehavior flingBehavior(final PagerState pagerState, PagerSnapDistance pagerSnapDistance, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, float f, Composer composer, int i, int i2) {
        boolean z = true;
        PagerSnapDistance pagerSnapDistanceAtMost = (i2 & 2) != 0 ? PagerSnapDistance.INSTANCE.atMost(1) : pagerSnapDistance;
        DecayAnimationSpec<Float> decayAnimationSpecRememberSplineBasedDecay = (i2 & 4) != 0 ? SplineBasedFloatDecayAnimationSpec_androidKt.rememberSplineBasedDecay(composer, 0) : decayAnimationSpec;
        SpringSpec springSpecSpring$default = (i2 & 8) != 0 ? AnimationSpecKt.spring$default(0.0f, 400.0f, Float.valueOf(VisibilityThresholdsKt.getVisibilityThreshold(IntCompanionObject.INSTANCE)), 1, null) : animationSpec;
        ...
        if (0.0f > f2 || f2 > 1.0f) {
            throw new IllegalArgumentException("snapPositionalThreshold should be a number between 0 and 1. You've specified ".concat(String.valueOf(f2)).toString());
        }
        ...
        boolean zChanged2 = composer.changed(springSpecSpring$default);
        if ((((i & 112) ^ 48) <= 32 || !composer.changed(pagerSnapDistanceAtMost)) && (i & 48) != 32) {
            z = false;
        }
        boolean zChanged3 = composer.changed(obj);
        boolean zChanged4 = composer.changed(layoutDirection);
        Object objRememberedValue = composer.rememberedValue();
        if ((zChanged3 | z | z2 | zChanged | zChanged2 | zChanged4) || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = SnapFlingBehaviorKt.snapFlingBehavior(PagerSnapLayoutInfoProviderKt.SnapLayoutInfoProvider(pagerState, pagerSnapDistanceAtMost, new Function3<Float, Float, Float, Float>() { // from class: androidx.compose.foundation.pager.PagerDefaults$flingBehavior$2$snapLayoutInfoProvider$1
                @Override // kotlin.jvm.functions.Function3
                public final /* bridge */ /* synthetic */ Float invoke(Float f3, Float f4, Float f5) {
            ...
            }), decayAnimationSpecRememberSplineBasedDecay, springSpecSpring$default);
    ...
    public final NestedScrollConnection pageNestedScrollConnection(PagerState pagerState, Orientation orientation, Composer composer, int i) {
        ...
        boolean z = true;
        boolean z2 = (((i & 14) ^ 6) > 4 && composer.changed(pagerState)) || (i & 6) == 4;
        if ((((i & 112) ^ 48) <= 32 || !composer.changed(orientation)) && (i & 48) != 32) {
            z = false;
        }
        Object objRememberedValue = composer.rememberedValue();
