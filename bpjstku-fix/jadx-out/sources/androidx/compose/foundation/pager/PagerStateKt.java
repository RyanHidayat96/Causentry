...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m6935constructorimpl(56.0f);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        boolean z3 = (((i2 & 896) ^ 384) > 256 && composer.changed(function0)) || (i2 & 384) == 256;
        Object objRememberedValue = composer.rememberedValue();
        if ((z | z2 | z3) || objRememberedValue == Composer.INSTANCE.getEmpty()) {
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m3663rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int iM7106getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m7106getWidthimpl(pagerLayoutInfo.mo1241getViewportSizeYbymL2g()) : IntSize.m7105getHeightimpl(pagerLayoutInfo.mo1241getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast((((j * pageSpacing) + beforeContentPadding) + afterContentPadding) - ((long) (iM7106getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(iM7106getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, iM7106getWidthimpl))), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int iM7106getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m7106getWidthimpl(pagerMeasureResult.mo1241getViewportSizeYbymL2g()) : IntSize.m7105getHeightimpl(pagerMeasureResult.mo1241getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(iM7106getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, iM7106getWidthimpl);
    }

    /* JADX INFO: renamed from: androidx.compose.foundation.pager.PagerStateKt$animateScrollToPage$2, reason: invalid class name */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                float fCalculateDistanceTo = this.$this_animateScrollToPage.calculateDistanceTo(this.$targetPage);
                float f = this.$targetPageOffsetToSnappedPosition;
                final Ref.FloatRef floatRef = new Ref.FloatRef();
                this.label = 1;
                if (SuspendAnimationKt.animate$default(0.0f, fCalculateDistanceTo + f, 0.0f, this.$animationSpec, new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.pager.PagerStateKt.animateScrollToPage.2.3
