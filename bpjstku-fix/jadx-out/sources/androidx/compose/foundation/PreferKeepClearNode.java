...
final class PreferKeepClearNode extends RectListNode {
    ...
    public final void updateRects(MutableVector<android.graphics.Rect> p0) {
        getView().setPreferKeepClearRects(p0.asMutableList());
    }
