...
public final class FlowColumnScopeInstance implements ColumnScope, FlowColumnScope {
    ...
    public final Modifier fillMaxColumnWidth(Modifier modifier, float f) {
        double d = f;
        if (d < 0.0d) {
            StringBuilder sb = new StringBuilder("invalid fraction ");
            sb.append(f);
            sb.append("; must be greater than or equal to zero");
            throw new IllegalArgumentException(sb.toString().toString());
        }
        if (d > 1.0d) {
            StringBuilder sb2 = new StringBuilder("invalid fraction ");
            sb2.append(f);
