...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final MeasureResult mo412measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo5637measureBRTryo0 = measurable.mo5637measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m6890getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m6888getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m6889getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m6887getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo5637measureBRTryo0.getWidth(), Constraints.m6890getMinWidthimpl(j), Constraints.m6888getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo5637measureBRTryo0.getHeight(), Constraints.m6889getMinHeightimpl(j), Constraints.m6887getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5702place70tqf50$default(placementScope, placeableMo5637measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m7098boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo5637measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo5637measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).m7072unboximpl(), 0.0f, 2, null);
            }
