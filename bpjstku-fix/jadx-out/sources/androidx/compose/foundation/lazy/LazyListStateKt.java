...
public final class LazyListStateKt {
    private static final float DeltaThresholdForScrollAnimation = Dp.m6935constructorimpl(1.0f);
    ...
    public static final LazyListState rememberLazyListState(final int i, final int i2, Composer composer, int i3, int i4) {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3663rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final LazyListState rememberLazyListState(int i, int i2, LazyListPrefetchStrategy lazyListPrefetchStrategy, Composer composer, int i3, int i4) {
        ...
        boolean z3 = (((i3 & 896) ^ 384) > 256 && composer.changedInstance(lazyListPrefetchStrategy2)) || (i3 & 384) == 256;
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3663rememberSaveable(objArr, (Saver) saverSaver$foundation_release, (String) null, (Function0) objRememberedValue2, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return lazyListState;
