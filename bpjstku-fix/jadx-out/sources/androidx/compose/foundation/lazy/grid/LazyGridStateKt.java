...
public final class LazyGridStateKt {
    ...
    public static final LazyGridState rememberLazyGridState(final int i, final int i2, Composer composer, int i3, int i4) {
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m3663rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    static {
        ...
        EmptyLazyGridLayoutInfo = new LazyGridMeasureResult(null, 0, false, 0.0f, measureResult2, false, CoroutineScopeKt.CoroutineScope(EmptyCoroutineContext.INSTANCE), DensityKt.Density$default(1.0f, 0.0f, 2, null), 0, new Function1<Integer, List<? extends Pair<? extends Integer, ? extends Constraints>>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridStateKt$EmptyLazyGridLayoutInfo$2
            ...
            public final /* bridge */ /* synthetic */ List<? extends Pair<? extends Integer, ? extends Constraints>> invoke(Integer num) {
    ...
    public static final LazyGridState rememberLazyGridState(int i, int i2, LazyGridPrefetchStrategy lazyGridPrefetchStrategy, Composer composer, int i3, int i4) {
        ...
        boolean z = (((i3 & 14) ^ 6) > 4 && composer.changed(i5)) || (i3 & 6) == 4;
        boolean z2 = (((i3 & 112) ^ 48) > 32 && composer.changed(i6)) || (i3 & 48) == 32;
        boolean z3 = (((i3 & 896) ^ 384) > 256 && composer.changedInstance(lazyGridPrefetchStrategy2)) || (i3 & 384) == 256;
        Object objRememberedValue2 = composer.rememberedValue();
        if ((z3 | z | z2) || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m3663rememberSaveable(objArr, (Saver) saverSaver$foundation_release, (String) null, (Function0) objRememberedValue2, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return lazyGridState;
