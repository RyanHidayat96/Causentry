...
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u001f\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0001¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"Landroidx/compose/foundation/lazy/LazyListState;", "p0", "", "p1", "Landroidx/compose/foundation/lazy/layout/LazyLayoutSemanticState;", "LazyLayoutSemanticState", "(Landroidx/compose/foundation/lazy/LazyListState;Z)Landroidx/compose/foundation/lazy/layout/LazyLayoutSemanticState;"}, k = 2, mv = {1, 8, 0}, xi = 48)
        ...
        return new LazyLayoutSemanticState() { // from class: androidx.compose.foundation.lazy.LazyLayoutSemanticStateKt.LazyLayoutSemanticState.1
            ...
            public final int getViewport() {
                if (lazyListState.getLayoutInfo().getOrientation() == Orientation.Vertical) {
                    return IntSize.m7105getHeightimpl(lazyListState.getLayoutInfo().mo1107getViewportSizeYbymL2g());
                }
                return IntSize.m7106getWidthimpl(lazyListState.getLayoutInfo().mo1107getViewportSizeYbymL2g());
            }
