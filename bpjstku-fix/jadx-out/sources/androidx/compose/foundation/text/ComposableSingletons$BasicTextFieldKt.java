...
public final class ComposableSingletons$BasicTextFieldKt {
    ...
    public static Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> f0lambda1 = ComposableLambdaKt.composableLambdaInstance(997835932, false, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.ComposableSingletons$BasicTextFieldKt$lambda-1$1
        ...
        public final /* bridge */ /* synthetic */ Unit invoke(Function2<? super Composer, ? super Integer, ? extends Unit> function2, Composer composer, Integer num) {
    ...
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m1308getLambda1$foundation_release() {
        return f0lambda1;
    }

    /* JADX INFO: renamed from: getLambda-2$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m1309getLambda2$foundation_release() {
        return f1lambda2;
    }

    /* JADX INFO: renamed from: getLambda-3$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m1310getLambda3$foundation_release() {
        return f2lambda3;
    }

    /* JADX INFO: renamed from: getLambda-4$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m1311getLambda4$foundation_release() {
        return f3lambda4;
    }
}
