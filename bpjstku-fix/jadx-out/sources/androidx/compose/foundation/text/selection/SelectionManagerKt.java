...
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\n\u001a\"\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0000ø\u0001\u0000¢\u0006\u0004\b\u0005\u0010\u0006\u001a*\u0010\f\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\bH\u0002ø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000b\u001a1\u0010\u0013\u001a\u00020\u00122\u0018\u0010\u0001\u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u000f\u0012\u0004\u0012\u00020\u00100\u000e0\r2\u0006\u0010\u0003\u001a\u00020\u0011H\u0001¢\u0006\u0004\b\u0013\u0010\u0014\u001a%\u0010\u0015\u001a\u0004\u0018\u00010\u00102\b\u0010\u0001\u001a\u0004\u0018\u00010\u00102\b\u0010\u0003\u001a\u0004\u0018\u00010\u0010H\u0000¢\u0006\u0004\b\u0015\u0010\u0016\u001a\u001e\u0010\u001a\u001a\u00020\u0017*\u00020\u00122\u0006\u0010\u0001\u001a\u00020\u0004H\u0000ø\u0001\u0000¢\u0006\u0004\b\u0018\u0010\u0019\u001a%\u0010\u001c\u001a\b\u0012\u0004\u0012\u00028\u00000\r\"\u0004\b\u0000\u0010\u001b*\b\u0012\u0004\u0012\u00028\u00000\rH\u0002¢\u0006\u0004\b\u001c\u0010\u001d\u001a\u0013\u0010\u001e\u001a\u00020\u0012*\u00020\u0011H\u0001¢\u0006\u0004\b\u001e\u0010\u001f\"\u0014\u0010 \u001a\u00020\u00128\u0002X\u0083\u0004¢\u0006\u0006\n\u0004\b \u0010!\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001"}, d2 = {"Landroidx/compose/foundation/text/selection/SelectionManager;", "p0", "Landroidx/compose/ui/unit/IntSize;", "p1", "Landroidx/compose/ui/geometry/Offset;", "calculateSelectionMagnifierCenterAndroid-O0kMr_c", "(Landroidx/compose/foundation/text/selection/SelectionManager;J)J", "calculateSelectionMagnifierCenterAndroid", "Landroidx/compose/foundation/text/selection/Selection$AnchorInfo;", "p2", "getMagnifierCenter-JVtK1S4", "(Landroidx/compose/foundation/text/selection/SelectionManager;JLandroidx/compose/foundation/text/selection/Selection$AnchorInfo;)J", "getMagnifierCenter", "", "Lkotlin/Pair;", "Landroidx/compose/foundation/text/selection/Selectable;", "Landroidx/compose/foundation/text/selection/Selection;", "Landroidx/compose/ui/layout/LayoutCoordinates;", "Landroidx/compose/ui/geometry/Rect;", "getSelectedRegionRect", "(Ljava/util/List;Landroidx/compose/ui/layout/LayoutCoordinates;)Landroidx/compose/ui/geometry/Rect;", "merge", "(Landroidx/compose/foundation/text/selection/Selection;Landroidx/compose/foundation/text/selection/Selection;)Landroidx/compose/foundation/text/selection/Selection;", "", "containsInclusive-Uv8p0NA", "(Landroidx/compose/ui/geometry/Rect;J)Z", "containsInclusive", ExifInterface.GPS_DIRECTION_TRUE, "firstAndLast", "(Ljava/util/List;)Ljava/util/List;", "visibleBounds", "(Landroidx/compose/ui/layout/LayoutCoordinates;)Landroidx/compose/ui/geometry/Rect;", "invertedInfiniteRect", "Landroidx/compose/ui/geometry/Rect;"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class SelectionManagerKt {
    ...
    public static final Rect getSelectedRegionRect(List<? extends Pair<? extends Selectable, Selection>> list, LayoutCoordinates layoutCoordinates) {
        ...
        for (int size = list.size(); i < size; size = size) {
            ...
            if (offset != offset2 && (layoutCoordinates2 = selectableComponent1.getLayoutCoordinates()) != null) {
                ...
                while (i2 < length) {
                    int i3 = length;
                    Rect boundingBox = selectableComponent1.getBoundingBox(iArr[i2]);
                ...
                long jMo5646localPositionOfR5De75A = layoutCoordinates.mo5646localPositionOfR5De75A(layoutCoordinates2, jOffset);
                long jMo5646localPositionOfR5De75A2 = layoutCoordinates.mo5646localPositionOfR5De75A(layoutCoordinates2, jOffset2);
                left = Math.min(left, Offset.m3974getXimpl(jMo5646localPositionOfR5De75A));
                top = Math.min(top, Offset.m3975getYimpl(jMo5646localPositionOfR5De75A));
                right = Math.max(right, Offset.m3974getXimpl(jMo5646localPositionOfR5De75A2));
                bottom = Math.max(bottom, Offset.m3975getYimpl(jMo5646localPositionOfR5De75A2));
            }
            i++;
        }
    ...
    private static final long m1702getMagnifierCenterJVtK1S4(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null && (offset = anchorInfo.getOffset()) <= anchorSelectable$foundation_release.getLastVisibleOffset()) {
            ...
            float fM3974getXimpl = Offset.m3974getXimpl(layoutCoordinates.mo5646localPositionOfR5De75A(containerLayoutCoordinates, offsetM1689getCurrentDragPosition_m7T9E.m3984unboximpl()));
            ...
            if (TextRange.m6391getCollapsedimpl(jMo1650getRangeOfLineContainingjx7JFs)) {
                fCoerceIn = anchorSelectable$foundation_release.getLineLeft(offset);
            } else {
                float lineLeft = anchorSelectable$foundation_release.getLineLeft(TextRange.m6397getStartimpl(jMo1650getRangeOfLineContainingjx7JFs));
                float lineRight = anchorSelectable$foundation_release.getLineRight(TextRange.m6392getEndimpl(jMo1650getRangeOfLineContainingjx7JFs) - 1);
                fCoerceIn = RangesKt.coerceIn(fM3974getXimpl, Math.min(lineLeft, lineRight), Math.max(lineLeft, lineRight));
            }
            if (fCoerceIn == -1.0f) {
                return Offset.INSTANCE.m3989getUnspecifiedF1C5BW0();
            }
            ...
            return containerLayoutCoordinates.mo5646localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(fCoerceIn, centerYForOffset));
        }
        return Offset.INSTANCE.m3989getUnspecifiedF1C5BW0();
    }
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m4012Rect0a9Yr6o(layoutCoordinates.mo5654windowToLocalMKHz9U(rectBoundsInWindow.m4009getTopLeftF1C5BW0()), layoutCoordinates.mo5654windowToLocalMKHz9U(rectBoundsInWindow.m4003getBottomRightF1C5BW0()));
    }
