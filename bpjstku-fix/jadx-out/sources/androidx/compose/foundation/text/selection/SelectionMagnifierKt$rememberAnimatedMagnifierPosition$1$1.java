...
final class SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            clampVideoBitrateIfNotSupported clampvideobitrateifnotsupportedSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.1
                @Override // kotlin.jvm.functions.Function0
                public final /* synthetic */ Offset invoke() {
                    return Offset.m3963boximpl(m1671invokeF1C5BW0());
                }
            ...
            this.label = 1;
            if (clampvideobitrateifnotsupportedSnapshotFlow.collect(new addSignalEosTimeoutIfNeeded() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.2
                @Override // defpackage.addSignalEosTimeoutIfNeeded
                public final /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m1672emit3MmeM6k(((Offset) obj2).m3984unboximpl(), continuation);
                }
                ...
                public final Object m1672emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if (OffsetKt.m3993isSpecifiedk4lQ0M(animatable.getValue().m3984unboximpl()) && OffsetKt.m3993isSpecifiedk4lQ0M(j) && Offset.m3975getYimpl(animatable.getValue().m3984unboximpl()) != Offset.m3975getYimpl(j)) {
                        b.TuitionPaymentFragmentbindingInflater1(coroutineScope, null, null, new AnonymousClass1(animatable, j, null), 3, null);
                        return Unit.INSTANCE;
                    }
                    Object objSnapTo = animatable.snapTo(Offset.m3963boximpl(j), continuation);
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ResultKt.throwOnFailure(obj);
                            this.label = 1;
                            if (Animatable.animateTo$default(this.$animatable, Offset.m3963boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
