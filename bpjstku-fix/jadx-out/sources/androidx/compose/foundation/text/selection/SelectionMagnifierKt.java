...
public final class SelectionMagnifierKt {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> UnspecifiedSafeOffsetVectorConverter = VectorConvertersKt.TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1
        ...
        public final /* synthetic */ AnimationVector2D invoke(Offset offset) {
            return m1668invokek4lQ0M(offset.m3984unboximpl());
        }

        /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final AnimationVector2D m1668invokek4lQ0M(long j) {
        ...
        public final /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m3963boximpl(m1669invoketuRUvjQ(animationVector2D));
        }

        /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1669invoketuRUvjQ(AnimationVector2D animationVector2D) {
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m3963boximpl(jOffset), 3, null);
    }
    ...
    static final class AnonymousClass1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$animatedSelectionMagnifier$1$1$1
                    ...
                    public final /* synthetic */ Offset invoke() {
                        return Offset.m3963boximpl(m1670invokeF1C5BW0());
                    }

                    /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1670invokeF1C5BW0() {
        ...
        public static final long invoke$lambda$0(State<Offset> state) {
            return state.getValue().m3984unboximpl();
        }
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new Animatable(Offset.m3963boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m3963boximpl(OffsetDisplacementThreshold), null, 8, null);
