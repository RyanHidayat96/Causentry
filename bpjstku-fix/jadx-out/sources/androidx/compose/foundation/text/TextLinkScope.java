...
public final class TextLinkScope {
    ...
    public static final TextRangeLayoutMeasureResult textRange$lambda$3(TextLinkScope textLinkScope, int i, int i2, TextRangeLayoutMeasureScope textRangeLayoutMeasureScope) {
        ...
        if (textLayoutResult == null) {
            return textRangeLayoutMeasureScope.layout(0, 0, new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$layoutResult$1
                ...
                public final /* synthetic */ IntOffset invoke() {
                    return IntOffset.m7054boximpl(m1419invokenOccac());
                }
        ...
        return textRangeLayoutMeasureScope.layout(intRectRoundToIntRect.getWidth(), intRectRoundToIntRect.getHeight(), new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$1
            @Override // kotlin.jvm.functions.Function0
            public final /* synthetic */ IntOffset invoke() {
                return IntOffset.m7054boximpl(m1418invokenOccac());
            }

            /* JADX INFO: renamed from: invoke-nOcc-ac, reason: not valid java name */
            public final long m1418invokenOccac() {
                return intRectRoundToIntRect.m7092getTopLeftnOccac();
            }
    ...
    private final Path pathForRangeInRangeCoordinates(AnnotatedString.Range<LinkAnnotation> range) {
        ...
        if (textLayoutResult != null) {
            ...
            pathForRange.mo4111translatek4lQ0M(Offset.m3983unaryMinusF1C5BW0(OffsetKt.Offset(textLayoutResult.getLineForOffset(range.getStart()) == textLayoutResult.getLineForOffset(range.getEnd()) ? Math.min(textLayoutResult.getBoundingBox(range.getEnd() - 1).getLeft(), boundingBox.getLeft()) : 0.0f, boundingBox.getTop())));
        }
        return pathForRange;
    }
    ...
    public final void LinksComposables(Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            while (i4 < size) {
                ...
                Modifier modifierPointerHoverIcon$default = PointerIconKt.pointerHoverIcon$default(HoverableKt.hoverable$default(textRange(modifierClip, range.getStart(), range.getEnd()), mutableInteractionSource, r12, i3, null), PointerIcon.INSTANCE.getHand(), r12, i3, null);
                boolean zChangedInstance = composerStartRestartGroup.changedInstance(this);
                boolean zChanged = composerStartRestartGroup.changed(range);
                boolean zChangedInstance2 = composerStartRestartGroup.changedInstance(uriHandler);
                Object objRememberedValue2 = composerStartRestartGroup.rememberedValue();
                if ((zChangedInstance | zChanged | zChangedInstance2) || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                BoxKt.Box(ClickableKt.m591combinedClickableXVZzFYc(modifierPointerHoverIcon$default, mutableInteractionSource, null, (252 & 4) != 0, (252 & 8) != 0 ? null : null, (252 & 16) != 0 ? null : null, (252 & 32) != 0 ? null : null, (252 & 64) != 0 ? null : null, (252 & 128) != 0 ? null : null, (Function0) objRememberedValue2), composerStartRestartGroup, r12);
                ...
                boolean zLinksComposables$lambda$13$lambda$9 = LinksComposables$lambda$13$lambda$9(stateCollectIsHoveredAsState);
                boolean zLinksComposables$lambda$13$lambda$10 = LinksComposables$lambda$13$lambda$10(stateCollectIsFocusedAsState);
                boolean zLinksComposables$lambda$13$lambda$11 = LinksComposables$lambda$13$lambda$11(stateCollectIsPressedAsState);
                TextLinkStyles styles = range.getItem().getStyles();
                ...
                Object[] objArr2 = {Boolean.valueOf(zLinksComposables$lambda$13$lambda$9), Boolean.valueOf(zLinksComposables$lambda$13$lambda$10), Boolean.valueOf(zLinksComposables$lambda$13$lambda$11), style, focusedStyle, hoveredStyle, styles4 != null ? styles4.getPressedStyle() : null};
                boolean zChangedInstance3 = composerStartRestartGroup.changedInstance(this);
                boolean zChanged2 = composerStartRestartGroup.changed(range);
                boolean zChanged3 = composerStartRestartGroup.changed(stateCollectIsFocusedAsState);
                boolean zChanged4 = composerStartRestartGroup.changed(stateCollectIsHoveredAsState);
                boolean zChanged5 = composerStartRestartGroup.changed(stateCollectIsPressedAsState);
                Object objRememberedValue3 = composerStartRestartGroup.rememberedValue();
                if (((zChangedInstance3 | zChanged2 | zChanged3 | zChanged4) || zChanged5) || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objArr = objArr2;
                    objRememberedValue3 = (Function1) new Function1<TextAnnotatorScope, Unit>() { // from class: androidx.compose.foundation.text.TextLinkScope$LinksComposables$1$2$1
                        ...
                        public final /* bridge */ /* synthetic */ Unit invoke(TextAnnotatorScope textAnnotatorScope) {
    ...
    public final void StyleAnnotation(final Object[] objArr, final Function1<? super TextAnnotatorScope, Unit> function1, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            boolean z = (i2 & 112) == 32;
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if ((z | zChangedInstance) || objRememberedValue == Composer.INSTANCE.getEmpty()) {
