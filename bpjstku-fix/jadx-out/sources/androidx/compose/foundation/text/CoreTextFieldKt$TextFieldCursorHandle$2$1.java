...
final class CoreTextFieldKt$TextFieldCursorHandle$2$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                b.TuitionPaymentFragmentbindingInflater1(coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00541(this.$$this$pointerInput, this.$observer, null), 1, null);
                b.TuitionPaymentFragmentbindingInflater1(coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(this.$$this$pointerInput, this.$manager, null), 1, null);
                ...
                if (i == 0) {
                    ...
                    if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.CoreTextFieldKt.TextFieldCursorHandle.2.1.1.2.1
                        ...
                        public final /* synthetic */ Unit invoke(Offset offset) {
                            m1314invokek4lQ0M(offset.m3984unboximpl());
                            return Unit.INSTANCE;
                        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            if (CoroutineScopeKt.TuitionPaymentFragmentspecialinlinedviewModeldefault1(new AnonymousClass1((PointerInputScope) this.L$0, this.$observer, this.$manager, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
