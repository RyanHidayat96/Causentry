    ...
    public final MeasureResult mo359measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (listInvoke != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                Pair pair = rect != null ? new Pair(((Measurable) arrayList2.get(i2)).mo5637measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m7054boximpl(IntOffsetKt.IntOffset(Math.round(rect.getLeft()), Math.round(rect.getTop())))) : null;
                if (pair != null) {
                    arrayList4.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measureScope, Constraints.m6888getMaxWidthimpl(j), Constraints.m6887getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (list2 != null) {
                    ...
                    for (int i4 = 0; i4 < size4; i4++) {
                        ...
                        Placeable.PlacementScope.m5702place70tqf50$default(placementScope, pair2.component1(), pair2.component2().m7072unboximpl(), 0.0f, 2, null);
                    }
                }
                ...
                if (list3 != null) {
                    ...
                    for (int i5 = 0; i5 < size5; i5++) {
                        ...
                        Placeable.PlacementScope.m5702place70tqf50$default(placementScope, placeableComponent1, function0Component2 != null ? function0Component2.invoke().m7072unboximpl() : IntOffset.INSTANCE.m7074getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
