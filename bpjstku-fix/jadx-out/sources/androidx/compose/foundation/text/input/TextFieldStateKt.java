...
public final class TextFieldStateKt {
    ...
    public static final TextFieldState m1433rememberTextFieldStateLepunE(final String str, final long j, Composer composer, int i, int i2) {
        if ((i2 & 1) != 0) {
            str = "";
        }
        if ((i2 & 2) != 0) {
        ...
        TextFieldState textFieldState = (TextFieldState) RememberSaveableKt.m3663rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
