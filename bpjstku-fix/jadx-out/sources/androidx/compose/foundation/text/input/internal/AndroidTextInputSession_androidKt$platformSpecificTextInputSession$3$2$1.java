...
final class AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ lambdamatchAcquisitionsAndFreeBufferIndexes15androidxcameravideointernalencoderEncoderImpl<Unit> $it;
    int label;
 ...
 androidx.compose.foundation.text.input.internal.AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$2$1.1.INSTANCE androidx.compose.foundation.text.input.internal.AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$2$1$1
            ...
            if (r5 == r0) goto L4d
        L30:
            lambdamatchAcquisitionsAndFreeBufferIndexes15androidxcameravideointernalencoderEncoderImpl<kotlin.Unit> r5 = r4.$it
    ...
    AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$2$1(lambdamatchAcquisitionsAndFreeBufferIndexes15androidxcameravideointernalencoderEncoderImpl<Unit> lambdamatchacquisitionsandfreebufferindexes15androidxcameravideointernalencoderencoderimpl, ComposeInputMethodManager composeInputMethodManager, Continuation<? super AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$2$1> continuation) {
        super(2, continuation);
        this.$it = lambdamatchacquisitionsandfreebufferindexes15androidxcameravideointernalencoderencoderimpl;
