...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m1288CursorHandleUSBMPiE(final OffsetProvider offsetProvider, final Modifier modifier, final long j, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                j = DpSize.INSTANCE.m7042getUnspecifiedMYxV2XQ();
                i3 &= -897;
            }
            ...
            if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$finalModifier$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, offsetProvider.mo1292provideF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
                    }
                ...
                public final void invoke(Composer composer2, int i5) {
                    if ((i5 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
                            ...
                            Modifier modifierM1043requiredSizeInqDBjuR0$default = SizeKt.m1043requiredSizeInqDBjuR0$default(modifierSemantics$default, DpSize.m7033getWidthD9Ej5fM(j), DpSize.m7031getHeightD9Ej5fM(j), 0.0f, 0.0f, 12, null);
                            ...
                            Modifier modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composer2, modifierM1043requiredSizeInqDBjuR0$default);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    AndroidCursorHandle_androidKt.m1288CursorHandleUSBMPiE(offsetProvider, modifier, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final float fM4043getWidthimpl = Size.m4043getWidthimpl(cacheDrawScope.m3758getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, fM4043getWidthimpl);
                            ...
                            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    try {
                                        ...
                                        transform.mo4725rotateUv8p0NA(45.0f, Offset.INSTANCE.m3990getZeroF1C5BW0());
    ...
    static {
        float fM6935constructorimpl = Dp.m6935constructorimpl(25.0f);
        CursorHandleHeight = fM6935constructorimpl;
        CursorHandleWidth = Dp.m6935constructorimpl(Dp.m6935constructorimpl(fM6935constructorimpl * 2.0f) / 2.4142137f);
    }
}
