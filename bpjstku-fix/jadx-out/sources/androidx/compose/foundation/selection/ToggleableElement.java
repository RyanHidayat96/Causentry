...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public final void update(ToggleableNode p0) {
        p0.m1266updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
    ...
    public final boolean equals(Object p0) {
        ...
        ToggleableElement toggleableElement = (ToggleableElement) p0;
    ...
    public final int hashCode() {
        int iHashCode = Boolean.hashCode(this.value);
        ...
        Role role = this.role;
        return (((((((((iHashCode * 31) + iHashCode2) * 31) + iHashCode3) * 31) + iHashCode4) * 31) + (role != null ? Role.m6141hashCodeimpl(role.getValue()) : 0)) * 31) + this.onValueChange.hashCode();
    }
