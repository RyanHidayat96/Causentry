...
final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m3963boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
            Offset offsetM3963boximpl = Offset.m3963boximpl(this.$offset);
            AnimationSpec<Offset> animationSpec = this.$animationSpec;
            final Ref.LongRef longRef = this.$previous;
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, offsetM3963boximpl, animationSpec, false, new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                @Override // kotlin.jvm.functions.Function1
                public final /* bridge */ /* synthetic */ Unit invoke(AnimationScope<Offset, AnimationVector2D> animationScope) {
                ...
                public final void invoke2(AnimationScope<Offset, AnimationVector2D> animationScope) {
                    TransformScope.m830transformByd4ec7I$default(transformScope, 0.0f, Offset.m3978minusMKHz9U(animationScope.getValue().m3984unboximpl(), longRef.element), 0.0f, 5, null);
                    longRef.element = animationScope.getValue().m3984unboximpl();
                }
