...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public final float scrollBy(float p0) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m819toFloatk4lQ0M(nestedScrollScope.mo776scrollByWithOverscrollOzD1aCk(scrollingLogic4.m817reverseIfNeededMKHz9U(scrollingLogic4.m820toOffsettuRUvjQ(p0)), NestedScrollSource.INSTANCE.m5400getSideEffectWNlRxjI())));
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m812toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m813updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
