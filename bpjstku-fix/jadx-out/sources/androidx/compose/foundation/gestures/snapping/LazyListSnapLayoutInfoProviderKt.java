...
public final class LazyListSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyListState lazyListState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyListSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public final float calculateSnapOffset(float p0) {
                ...
                return SnapFlingBehaviorKt.m848calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem(lazyListState.getDensity$foundation_release(), p0), f, f2);
            }
        };
    }
    ...
    public static final int calculateFinalSnappingItem(Density density, float f) {
        if (Math.abs(f) < density.mo694toPx0680j_4(SnapFlingBehaviorKt.getMinFlingVelocityDp())) {
            return FinalSnappingItem.INSTANCE.m845getClosestItembbeMdSM();
        }
        return f > 0.0f ? FinalSnappingItem.INSTANCE.m846getNextItembbeMdSM() : FinalSnappingItem.INSTANCE.m847getPreviousItembbeMdSM();
    }
}
