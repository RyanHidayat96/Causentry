...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public static class Result<T> {
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sb = new StringBuilder("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                sb.append(this.mDebug);
                throw new IllegalStateException(sb.toString());
            }
        ...
        void onProgressUpdateSent(Bundle bundle) {
            StringBuilder sb = new StringBuilder("It is not supported to send an interim update for ");
            sb.append(this.mDebug);
