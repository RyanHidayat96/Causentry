...
public final class BouncyCastleSocketAdapter implements SocketAdapter {
    ...
    private static final DeferredSocketAdapter.Factory factory = new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.BouncyCastleSocketAdapter$Companion$factory$1
        ...
        public final boolean matchesSocket(SSLSocket p0) {
            ...
            return BouncyCastlePlatform.INSTANCE.isSupported() && (p0 instanceof BCSSLSocket);
        }
    ...
    public final void configureTlsExtensions(SSLSocket p0, String p1, List<? extends Protocol> p2) {
        ...
        if (matchesSocket(p0)) {
            ...
            parameters.setApplicationProtocols((String[]) Platform.INSTANCE.alpnProtocolNames(p2).toArray(new String[0]));
